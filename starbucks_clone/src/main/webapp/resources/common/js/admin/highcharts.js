...
(function (U, K) {
    "object" === typeof module && module.exports
        ...
        : "function" === typeof define && define.amd
            ...
            : (U.Highcharts && U.Highcharts.error(16, !0), U.Highcharts = K(U))
})(
...
function (U) {
        function K(a, C, f, H) {
            a.hasOwnProperty(C) || (
                a[C] = H.apply(null, f),
                "function" === typeof CustomEvent && U.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
                    detail: {
                        path: C,
                        module: a[C]
                    }
        ...
        K(f, "Core/Globals.js", [], function () {
            ...
            (function (a) {
                ...
                a.version = "10.1.0";
                a.win = "undefined" !== typeof U
                    ? U
                    : {};
                a.doc = a.win.document;
                a.svg = a.doc && a.doc.createElementNS && !!a
                    .doc
                    .createElementNS(a.SVG_NS, "svg")
                    .createSVGRect;
                ...
                a.hasBidiBug = a.isFirefox && 4 > parseInt(
                    a.userAgent.split("Firefox/")[1],
                    10
                );
                ...
                a.supportsPassiveEvents = function () {
                    ...
                    if (!a.isMS) {
                        ...
                        a.win.addEventListener && a.win.removeEventListener && (
                            a.win.addEventListener("testPassive", a.noop, C),
                            a.win.removeEventListener("testPassive", a.noop, C)
                        )
                    }
                    return f
                }();
        ...
        K(f, "Core/Utilities.js", [f["Core/Globals.js"]], function (a) {
            function f(d, r, h, l) {
                ...
                var m = n(d),
                    c = m
                        ? v + " #" + d + ": www.highcharts.com/errors/" + d + "/"
                        : d.toString();
            ...
            function B(b, d) {
                var v = {};
                y(b, function (r, h) {
                    if (I(b[h], !0) && !b.nodeType && d[h]) 
                        r = B(b[h], d[h]),
                        Object
                            .keys(r)
                            .length && (v[h] = r);
                    else if (I(b[h]) || b[h] !== d[h] || h in b && !(h in d)) 
                        v[h] = b[h]
                });
                return v
            }
                ...
                var v = w(d) && !k(h),
                    ...
                    l = function (d, h) {
                        k(d)
                            ? b.setAttribute(h, d)
                            : v
                                ? (r = b.getAttribute(h)) || "class" !== h || (r = b.getAttribute(
                                    h + "Name"
                                ))
                                : b.removeAttribute(h)
                    };
            ...
            function q(b, d) {
                return 1E14 < b
                    ? b
                    : parseFloat(b.toPrecision(d || 14))
            }
            function F(d, r, h) {
                var v = a.getStyle || F;
                if ("width" === r) 
                    return r = Math.min(d.offsetWidth, d.scrollWidth),
                    h = d.getBoundingClientRect && d
                        .getBoundingClientRect()
                        .width,
                    h < r && h >= r - 1 && (r = Math.floor(h)),
                    Math.max(
                        0,
                        r - (v(d, "padding-left", !0) || 0) - (v(d, "padding-right", !0) || 0)
                    );
                if ("height" === r) 
                    return Math.max(
                        0,
                        Math.min(d.offsetHeight, d.scrollHeight) - (v(d, "padding-top", !0) || 0) - (v(d, "padding-bottom", !0) || 0)
                    );
                ...
                if (Object.hasOwnProperty.call(l, "hcEvents")) {
                    ...
                    d
                        ? (
                            l = m[d] || [],
                            h
                                ? (m[d] = l.filter(function (b) {
                                    return h !== b.fn
                                }), v(d, h))
                                : (r(m), m[d] = [])
                        )
                        : (r(m), delete l.hcEvents)
                }
            }
            function z(b, d, l, m) {
                l = l || {};
                if (h.createEvent && (b.dispatchEvent || b.fireEvent && b !== a)) {
                    ...
                    v = [];
                    for (var r = b, q = !1; r.hcEvents;) 
                        Object
                            .hasOwnProperty
                            .call(r, "hcEvents") && r
                            .hcEvents[d] && (v.length && (q = !0), v.unshift.apply(v, r.hcEvents[d])),
            ...
            y({
                ...
                a[d] = function (v) {
                    ...
                    return Array
                        .prototype[b]
                        .apply(v, [].slice.call(arguments, 1))
                }
            });
            var d,
                D = function () {
            ...
            b.jQuery && (b.jQuery.fn.highcharts = function () {
                ...
                if (this[0]) 
                    return b[0]
                        ...
                        : m[e(this[0], "data-highcharts-chart")]
                });
            l = {
                ...
                getNestedProperty: function (d, r) {
                    for (d = d.split("."); d.length && k(r);) {
                        ...
                        if ("undefined" === typeof h || "__proto__" === h) 
                            return;
                        r = r[h];
                        if (!k(r) || "function" === typeof r || "number" === typeof r.nodeType || r === b) 
                            return
                    }
                    return r
                },
                ...
                normalizeTickInterval: function (b, d, h, l, m) {
                    ...
                    for (
                        l = 0;
                        l < d.length && !(r = d[l], m && r * h >= b || !m && v <= (d[l] + (d[l + 1] || d[l])) / 2);
                        l++
                    ) 
                    ;
                ...
                pad: function (b, d, h) {
                    return Array((d || 2) + 1 - String(b).replace("-", "").length).join(h || "0") +
                            b
                },
                pick: p,
                pInt: H,
                ...
                f.prototype.tweenTo = function (a, A) {
                    ...
                    return (
                        a
                            ? "rgba("
                            : "rgb("
                    ) + Math.round(n[0] + (u[0] - n[0]) * (1 - A)) + "," + Math.round(
                        n[1] + (u[1] - n[1]) * (1 - A)
                    ) + "," + Math.round(n[2] + (u[2] - n[2]) * (1 - A)) + (
                        a
                            ? "," + (
                                n[3] + (u[3] - n[3]) * (1 - A)
                            )
        ...
        K(f, "Core/Color/Palettes.js", [], function () {
            return {
                colors: (
					// 컬러 변환 color change
                    "#548c70 #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e" +
                    "1"
                ).split(" ")
            }
        });
        K(f, "Core/Time.js", [
            ...
            f = function () {
                ...
                t.prototype.set = function (c, e, g) {
                    if (this.variableTimezone || this.timezoneOffset) {
                        if ("Milliseconds" === c || "Seconds" === c || "Minutes" === c && 0 === this.getTimezoneOffset(e) % 36E5) 
                            return e["setUTC" + c](g);
                    ...
                    return this.useUTC || p && "FullYear" === c
                        ? e["setUTC" + c](g)
                        : e["set" + c](g)
                };
                ...
                t.prototype.makeTime = function (c, e, p, t, z, m) {
                    if (this.useUTC) {
                        ...
                        b !== l
                            ? h += l - b
                            : b - 36E5 !== this.getTimezoneOffset(h - 36E5) || g || (h -= 36E5)
                    } else 
                        h = (new this.Date(c, e, k(p, 1), k(t, 0), k(z, 0), k(m, 0))).getTime();
                    return h
                };
                ...
                t.prototype.getTimeTicks = function (e, g, p, t) {
                    ...
                    if (H(g)) {
                        q.set(
                            ...
                            l >= c.second
                                ? 0
                                : d * Math.floor(q.get("Milliseconds", b) / d)
                        );
                        l >= c.second && q.set(
                            "Seconds",
                            b,
                            l >= c.minute
                                ? 0
                                : d * Math.floor(q.get("Seconds", b) / d)
                        );
                        l >= c.minute && q.set(
                            "Minutes",
                            b,
                            l >= c.hour
                                ? 0
                                : d * Math.floor(q.get("Minutes", b) / d)
                        );
                        l >= c.hour && q.set(
                            "Hours",
                            b,
                        ...
                        l >= c.day && q.set(
                            ...
                            l >= c.month
                                ? 1
                                : Math.max(1, d * Math.floor(q.get("Date", b) / d))
                        );
                        if (l >= c.month) {
                            q.set(
                                "Month",
                        ...
                        var r = q.get("Date", b),
                            y = q.get("Hours", b);
                        g = b.getTime();
                        !q.variableTimezone && q.useUTC || !H(p) || (
                            D = p - g > 4 * c.month || q.getTimezoneOffset(g) !== q.getTimezoneOffset(p)
                        );
                        g = b.getTime();
                        for (b = 1; g < p;) 
                            m.push(g),
                            g = l === c.year
                                ...
                                : l === c.month
                                    ...
                                    : !D || l !== c.day && l !== c.week
                                        ? D && l === c.hour && 1 < d
                                            ? q.makeTime(v, t, r, y + b * d)
                                            : g + l * d
                                        : q.makeTime(v, t, r + b * d * (
                                            l === c.day
                                                ? 1
                                                : 7
                                        )),
                ...
                t.prototype.getDateFormat = function (e, g, p, t) {
                    ...
                    for (b in c) {
                        ...
                        if (m[b] && q.substr(m[b]) !== "01-01 00:00:00.000".substr(m[b])) 
                            break;
                ...
                setOptions: function (n) {
                    ...
                    if (n.time || n.global) 
                        B.time
                            ? B
                                .time
                                .update(C(A.global, A.time, n.global, n.time))
                            : B.time = u;
                    return A
                }
            };
            ...
            return function () {
                ...
                a.prototype.update = function () {
                    ...
                    if (this[n + "Setter"]) 
                        ...
                        a.attr
                            ? a.element && a.attr(n, k, null, !0)
                            : a.style[n] = k + this.unit;
                    e && e.call(a, k, this)
                };
                a.prototype.run = function (u, n, k) {
                    ...
                    u !== n || this.elem["forceAnimate:" + this.prop]
                        ? (
                            ...
                            p.elem = this.elem,
                            p.prop = this.prop,
                            p() && 1 === a.timers.push(p) && g(t)
                        )
                        : (
                            delete c.curAnim[this.prop],
                ...
                a.prototype.step = function (a) {
                    ...
                    if (e.attr && !e.element) 
                        ...
                        this.pos = k.easing((n - this.startTime) / p),
                ...
                a.prototype.initPath = function (a, n, k) {
                    ...
                    function c(c, m) {
                        for (; c.length < x;) 
                            if (
                                m = c[Math.floor(c.length / q) - 1].slice(),
                ...
                a.prototype.strokeSetter = function () {
                    this
                        .elem
                        .attr(this.prop, C(this.start).tweenTo(C(this.end), this.pos), void 0, !0)
                };
                a.timers = [];
                return a
            }()
        });
        K(f, "Core/Animation/AnimationUtilities.js", [
            ...
            return {
                animate: function (c, e, g) {
                    ...
                    g.easing = "function" === typeof g.easing
                        ? g.easing
                    ...
                    k(e, function (t, m) {
                        ...
                        F = void 0;
                        "d" === m && I(e.d)
                            ? (y.paths = y.initPath(c, c.pathArray, e.d), y.toD = e.d, p = 0, F = 1)
                            : c.attr
                                ? p = c.attr(m)
                                : (p = parseFloat(E(c, m)) || 0, "opacity" !== m && (q = "px"));
                        F || (F = t);
        ...
        K(f, "Core/Renderer/HTML/AST.js", [
            ...
            var C = a.SVG_NS,
                ...
                n = f.objectEach,
                k = f.splat,
                e = (f = a.win.trustedTypes) && A(f.createPolicy) && f.createPolicy(
                    "highcharts",
                    {
            ...
            A = function () {
                ...
                g.filterUserAttributes = function (c) {
                    n(c, function (e, p) {
                        ...
                        -1 === g
                            .allowedAttributes
                            .indexOf(p) && (q = !1);
                        -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(p) && (
                            q = u(e) && g.allowedReferences.some(function (c) {
                        ...
                        k(c).forEach(function (c) {
                            var m = c.tagName,
                                h = c.textContent
                                    ? a
                                        .doc
                                        .createTextNode(c.textContent)
                                    : void 0,
                                b = g.bypassHTMLFiltering;
                            if (m) 
                                if ("#text" === m) 
                                    var l = h;
                                else if (-1 !== g.allowedTags.indexOf(m) || b) {
                                    m = a
                                        .doc
                                        .createElementNS(
                                            "svg" === m
                                    ...
                                    var d = c.attributes || {};
                                    n(c, function (b, c) {
                                        "tagName" !== c && "attributes" !== c && "children" !== c && "style" !== c && "textContent" !== c && (
                                            d[c] = b
                                        )
                                    });
                                    H(
                                    ...
                                    I(33, !1, void 0, {"Invalid tagName in config": m});
                        l && p.appendChild(l);
                            q = l
                        });
                        return q
                ...
                g.prototype.parseMarkup = function (c) {
                    ...
                    []
                        .forEach
                        .call(c.body.childNodes, function (c) {
                            return t(c, q)
                        });
                    return q
                };
                g.allowedAttributes = (
                    "aria-controls aria-describedby aria-expanded aria-haspopup aria-hidden aria-la" +
                    "bel aria-labelledby aria-live aria-pressed aria-readonly aria-roledescription " +
                    "aria-selected class clip-path color colspan cx cy d dx dy disabled fill height" +
                    " href id in markerHeight markerWidth offset opacity orient padding paddingLeft" +
                    " paddingRight patternUnits r refX refY role scope slope src startOffset stdDev" +
                    "iation stroke stroke-linecap stroke-width style tableValues result rowspan sum" +
                    "mary target tabindex text-align textAnchor textLength title type valign width " +
                    "x x1 x2 y y1 y2 zIndex"
                ).split(" ");
                g.allowedReferences = "https:// http:// mailto: / ../ ./ #".split(" ");
                g.allowedTags = (
                    "a abbr b br button caption circle clipPath code dd defs div dl dt em feCompone" +
                    "ntTransfer feFuncA feFuncB feFuncG feFuncR feGaussianBlur feOffset feMerge feM" +
                    "ergeNode filter h1 h2 h3 h4 h5 h6 hr i img li linearGradient marker ol p path " +
                    "pattern pre rect small span stop strong style sub sup svg table text thead tbo" +
                    "dy tspan td th tr u ul #text"
                ).split(" ");
                g.emptyHTML = c;
        ...
        K(f, "Core/FormatUtilities.js", [
            ...
            function C(a, k, e, c) {
                ...
                if (-1 === k) 
                    ...
                    var F = k + +t[1];
                    0 <= F
                        ? (t[0] = (+t[0]).toExponential(F).split("e")[0], k = F)
                        : (
                            t[0] = t[0].split(".")[0] || 0,
                            a = 20 > k
                                ? (t[0] * Math.pow(10, t[1])).toFixed(k)
                                : 0,
                            t[1] = 0
                        )
                }
                F = (Math.abs(
                    t[1]
                        ? t[0]
                        : a
                ) + Math.pow(10, -Math.max(k, g) - 1)).toFixed(k);
                g = String(u(F));
                var y = 3 < g.length
                    ? g.length % 3
                    : 0;
                ...
                (function (a) {
                    function C(a, u, n) {
                        ...
                        for (a = a.map(function (c) {
                            ...
                            for (g = a.length; g--;) 
                                e = a[g],
                                c = (Math.min.apply(0, e.targets) + Math.max.apply(0, e.targets)) / 2,
                                e.pos = f(c - e.size * e.align, 0, u - e.size);
                            g = a.length;
                            for (t = !1; g--;) 
                                0 < g && a[g - 1].pos + a[g - 1].size > a[g].pos && (
                                    a[g - 1].size += a[g].size,
                                    a[g - 1].targets = a[g - 1].targets.concat(a[g].targets),
                                    a[g - 1].align = .5,
                                    a[g - 1].pos + a[g - 1].size > u && (a[g - 1].pos = u - a[g - 1].size),
                                    a.splice(g, 1),
                                    t = !0
                                )
                        }
                        ...
                        a.some(function (c) {
                            ...
                            return (c.targets || []).some(function () {
                                k[g].pos = c.pos + e;
                                if ("undefined" !== typeof n && Math.abs(k[g].pos - k[g].target) > n) 
                                    return k
                                        .slice(0, g + 1)
                                        .forEach(function (c) {
                                            return delete c.pos
                                        }),
                                    k.reducedLen = (k.reducedLen || u) - .1 * u,
                                    k.reducedLen > .1 * u && C(k, u, n),
                                    !0;
                                e += k[g].size;
                                g++;
                                return !1
        ...
        K(
            ...
            [
                f["Core/Animation/AnimationUtilities.js"], f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]
            ],
            function (a, f, B, H, w) {
                var C = a.animate,
                    I = a.animObject,
                ...
                a = function () {
                    ...
                    a.prototype.add = function (b) {
                        ...
                        "undefined" !== typeof this.textStr && "text" === this.element.nodeName && d.buildText(
                            this
                        );
                        this.added = !0;
                    ...
                    a.prototype.align = function (b, c, J) {
                        var h = {},
                            ...
                            G;
                        if (b) {
                            if (this.alignOptions = b, this.alignByTranslate = c, !J || d(J)) 
                                this.alignTo = m = J || "renderer",
                                x(e, this),
                                e.push(this),
                                J = void 0
                        } else 
                    ...
                    a.prototype.animate = function (b, d, c) {
                        ...
                        0 !== h.duration
                            ? (c && (h.complete = c), P(function () {
                                J.element && C(J, b, h)
                            }, d))
                            : (this.attr(b, void 0, c || h.complete), v(b, function (b, d) {
                                h.step && h
                                    .step
                                    .call(this, b, {
                                        prop: d,
                    ...
                    a.prototype.applyTextOutline = function (b) {
                        ...
                        if ((J = J[0]) && "none" !== J && H.svg) {
                            ...
                            []
                                .forEach
                                .call(d.childNodes, function (b) {
                                    var d = b.cloneNode(!0);
                                    d.removeAttribute && ["fill", "stroke", "stroke-width", "stroke"].forEach(
                                        function (b) {
                    ...
                    a.prototype.attr = function (b, d, c, h) {
                        ...
                        "string" === typeof b
                            ? L = (this[b + "Getter"] || this._defaultGetter).call(this, b, J)
                            : (v(b, function (d, c) {
                                G = !1;
                                h || A(this, c);
                                this.symbolName && -1 !== l.indexOf(c) && (
                                    r || (this.symbolAttr(b), r = !0),
                                    G = !0
                                );
                                !this.rotation || "x" !== c && "y" !== c || (this.doTransform = !0);
                                G || (
                                    e = this[c + "Setter"] || this._defaultSetter,
                                    e.call(this, d, c, J),
                                    !this.styledMode && this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c) && this.updateShadows(c, d, e)
                                )
                    ...
                    a.prototype.complexColor = function (b, d, c) {
                        ...
                        m(this.renderer, "complexColor", {
                            ...
                            if (r) {
                                ...
                                "radialGradient" === r && k && !y(e.gradientUnits) && (
                                    a = e,
                                    e = D(e, J.getRadialAttr(k, a), {gradientUnits: "userSpaceOnUse"})
                                );
                                v(e, function (b, d) {
                                    "id" !== d && x.push(d, b)
                                });
                                ...
                                if (G[x]) 
                                    ...
                                    g.forEach(function (b) {
                                        0 === b[1].indexOf("rgba")
                                            ? (l = B.parse(b[1]), p = l.get("rgb"), q = l.get("a"))
                                            : (p = b[1], q = 1);
                                        b = J
                                            .createElement("stop")
                                            .attr({offset: b[0], "stop-color": p, "stop-opacity": q})
                                            .add(L);
                                        L
                                            .stops
                                            .push(b)
                    ...
                    a.prototype.css = function (b) {
                        ...
                        if (l) {
                            ...
                            if (null === b.width || "auto" === b.width) 
                                ...
                                var r = this.textWidth = O(b.width);
                            this.styles = b;
                            r && !e && this.renderer.forExport && delete b.width;
                            var m = D(b);
                            h.namespaceURI === this.SVG_NS && ["textOutline", "textOverflow", "width"].forEach(
                                function (b) {
                                    return m && delete m[b]
                                }
                            );
                    ...
                    a.prototype.dashstyleSetter = function (b) {
                        ...
                        if (b = b && b.toLowerCase()) {
                            ...
                            this
                                .element
                                .setAttribute("stroke-dasharray", b)
                        }
                    };
                    a.prototype.destroy = function () {
                        ...
                        if (b.clipPath && h) {
                            ...
                            []
                                .forEach
                                .call(h.querySelectorAll("[clip-path],[CLIP-PATH]"), function (b) {
                                    -1 < b
                                        .getAttribute("clip-path")
                                        .indexOf(r.element.id) && b.removeAttribute("clip-path")
                                });
                    ...
                    a.prototype.destroyTextPath = function (b, d) {
                        ...
                        if (c) {
                            if (
                                c.removeAttribute("dx"),
                                c.removeAttribute("dy"),
                    ...
                    a.prototype.getBBox = function (d, c) {
                        ...
                        if (!D) {
                            if (p || e.forExport) {
                                ...
                                D = this.htmlGetBBox();
                            if (e.isSVG && (e = D.width, d = D.height, p && (
                                D.height = d = {
                                    "11px,17": 14,
                                    "13px,20": 16
                                }[(q || "") + "," + Math.round(d)] || d
                    ...
                    a.prototype.init = function (b, d) {
                        this.element = "span" === d
                            ? q(d)
                            : n.createElementNS(this.SVG_NS, d);
                        this.renderer = b;
                        m(this, "afterInit")
                    };
                    ...
                    a.prototype.removeClass = function (b) {
                        return this.attr("class", ("" + this.attr("class")).replace(
                            d(b)
                                ? new RegExp("(^| )" + b + "( |$)")
                                : b,
                            " "
                    ...
                    a.prototype.setRadialReference = function (b) {
                        var d = this.element.gradient && this
                            .renderer
                            .gradients[this.element.gradient];
                    ...
                    a.prototype.setTextPath = function (b, d) {
                        ...
                        if (b && d && d.enabled) {
                            ...
                            m || (
                                this.textPathWrapper = m = this.renderer.createElement("textPath"),
                                e = !0
                            );
                            var g = m.element;
                            (d = b.element.getAttribute("id")) || b
                                .element
                                .setAttribute("id", d = S());
                            if (a) 
                                for (
                                    h.setAttribute("y", 0),
                                    l(G.dx) && h.setAttribute("x", -G.dx),
                                    b = [].slice.call(h.childNodes),
                                    a = 0;
                                    a < b.length;
                                    a++
                                ) {
                    ...
                    a.prototype.shadow = function (b, d, c) {
                        ...
                        !0 === b
                            ? G = r
                            : "object" === typeof b && (G = z(r, b));
                        G && (
                            G && J && v(G, function (b, d) {
                                b !== J[d] && (e = !0)
                            }),
                            e && this.destroyShadows(),
                            this.oldShadowOptions = G
                        );
                        if (!G) 
                            this.destroyShadows();
                        else if (!this.shadows) {
                            var m = G.opacity / G.width;
                            var a = this.parentInverted
                                ? "translate(" + G.offsetY + ", " + G.offsetX + ")"
                    ...
                    a.prototype.strokeSetter = function (b, d, c) {
                        ...
                        this.stroke && this["stroke-width"]
                            ...
                            : "stroke-width" === d && 0 === b && this.hasStroke
                                ...
                                : this.renderer.styledMode && this["stroke-width"] && (
                                    c.setAttribute("stroke-width", this["stroke-width"]),
                                    this.hasStroke = !0
                                )
                    };
                    ...
                    a.prototype.symbolAttr = function (b) {
                        ...
                        d.attr({
                            d: d
                                .renderer
                                .symbols[d.symbolName](d.x, d.y, d.width, d.height, d)
                        })
                    };
                    ...
                    a.prototype.titleSetter = function (b) {
                        var d = this.element,
                            c = d.getElementsByTagName("title")[0] || n.createElementNS(
                                this.SVG_NS,
                                "title"
                            );
                        d.insertBefore
                    ...
                    a.prototype.updateTransform = function () {
                        ...
                        c
                            ...
                            : h && m.push(
                                "rotate(" + h + " " + r(this.rotationOriginX, e.getAttribute("x"), 0) + " " + r(this.rotationOriginY, e.getAttribute("y") || 0) +
                                ")"
                            );
                    ...
                    a.prototype.zIndexSetter = function (b, d) {
                        ...
                        var G;
                        y(b)
                            ? (r.setAttribute("data-z-index", b), b = +b, this[d] === b && (m = !1))
                            : y(this[d]) && r.removeAttribute("data-z-index");
                        this[d] = b;
                        if (m) {
                            ...
                            for (G = d.length - 1; 0 <= G && !e; G--) {
                                ...
                                if (h !== r) 
                                    if (0 > b && a && !c && !G) 
                                        l.insertBefore(r, d[G]),
                                        e = !0;
                                    else if (O(m) <= b || a && (!y(b) || 0 <= b)) 
                                        l.insertBefore(r, d[G + 1] || null),
                                        e = !0
                            }
                            e || (l.insertBefore(r, d[
                                c
                                    ? 3
                                    : 0
                            ] || null), e = !0)
                ...
                a.prototype.matrixSetter = a.prototype.rotationOriginXSetter = a.prototype.rotationOriginYSetter = a.prototype.rotationSetter = a.prototype.scaleXSetter = a.prototype.scaleYSetter = a.prototype.translateXSetter = a.prototype.translateYSetter = a.prototype.verticalAlignSetter = function (
                    b,
                    d
                ) {
                    this[d] = b;
        ...
        K(f, "Core/Renderer/SVG/SVGLabel.js", [
            ...
            return function (n) {
                function k(e, c, a, g, t, q, F, y, x, z) {
                    ...
                    var h;
                    "string" === typeof t && (
                        (h = /^url\((.*?)\)$/.test(t)) || m.renderer.symbols[t]
                    ) && (m.symbolKey = t);
                    m.bBox = k.emptyBBox;
                    m.padding = 3;
                    m.baselineOffset = 0;
                ...
                k.prototype.alignSetter = function (e) {
                    ...
                    e !== this.alignFactor && (
                        this.alignFactor = e,
                        this.bBox && E(this.xSetting) && this.attr({x: this.xSetting})
                    )
                };
                ...
                k.prototype.paddingSetter = function (e, c) {
                    E(e)
                        ? e !== this[c] && (this[c] = e, this.updateTextPadding())
                        : this[c] = void 0
                };
                ...
                k.prototype.updateBoxSize = function () {
                    var e = this.text.element.style,
                        c = {},
                        a = this.padding,
                        g = this.bBox = E(this.widthSetting) && E(this.heightSetting) && !this.textAlign || !H(
                            this.text.textStr
                        )
                            ? k.emptyBBox
                            : this
                    ...
                    e = this
                        .renderer
                        .fontMetrics(e && e.fontSize, this.text);
                    this.baselineOffset = a + Math.min(
                    ...
                    this.needsBox && (
                        ...
                        this.box.attr(w(c, this.deferredAttr)),
                        this.deferredAttr = {}
                    )
                };
                k.prototype.updateTextPadding = function () {
                    ...
                    if (a !== e.x || c !== e.y) 
                        ...
                        "undefined" !== typeof c && e.attr("y", c);
                    e.x = a;
                    e.y = c
                };
                k.prototype.widthSetter = function (e) {
                    this.widthSetting = E(e)
                        ? e
                        : void 0
                };
                ...
                k.textProps = (
                    "color direction fontFamily fontSize fontStyle fontWeight lineHeight textAlign " +
                    "textDecoration textOutline textOverflow width"
                ).split(" ");
                return k
            }(a)
        });
                    ...
                    a + g >= n
                        ...
                        : 0 >= a + g
                            ...
                            : e && e > k && g > a + p && g < a + n - p
                                ...
                                : e && 0 > e && g > a + p && g < a + n - p && t.splice(1, 1, [
                                    "L", g - 6,
                                    f
                                ], [
                                    "L", g, f - 6
        ...
        K(f, "Core/Renderer/SVG/TextBuilder.js", [
            f["Core/Renderer/HTML/AST.js"], f["Core/Globals.js"], f["Core/Utilities.js"]
        ], function (a, f, B) {
            var C = f.doc,
                w = f.SVG_NS,
                E = f.win,
            ...
            return function () {
                ...
                e.prototype.buildSVG = function () {
                    ...
                    if (x !== c.textCache) {
                        ...
                        for (x = f.length; x--;) 
                            e.removeChild(f[x]);
                        q || this.ellipsis || this.width || -1 !== t.indexOf(" ") && (
                            !this.noWrap || y.test(t)
                        )
                            ? "" !== t && (
                                g && g.appendChild(e),
                                t = new a(t),
                                this.modifyTree(t.nodes),
                                t.addToDOM(c.element),
                                this.modifyDOM(),
                                this.ellipsis && -1 !== (e.textContent || "").indexOf("\u2026") && c.attr("title", this.unescapeEntities(c.textStr || "", ["&lt;", "&gt;"])),
                                g && g.removeChild(e)
                            )
                            : e.appendChild(C.createTextNode(this.unescapeEntities(t)));
                        u(this.textOutline) && c.applyTextOutline && c.applyTextOutline(
                            this.textOutline
                        )
                    }
                };
                ...
                []
                        .forEach
                        .call(a.element.querySelectorAll("tspan.highcharts-br"), function (g, q) {
                            g.nextSibling && g.previousSibling && (
                                0 === q && 1 === g.previousSibling.nodeType && (a.firstLineMetrics = a.renderer.fontMetrics(void 0, g.previousSibling)),
                                I(g, {
                        ...
                        var f = function (g, k) {
                                ...
                                if (c.ellipsis) 
                                    m && c.truncate(
                                        ...
                                        void 0,
                                        0,
                                        Math.max(0, q - parseInt(c.fontSize || 12, 10)),
                                        function (b, d) {
                                    ...
                                    m = [];
                                    for (b = []; k.firstChild && k.firstChild !== g;) 
                                        b.push(k.firstChild),
                                        k.removeChild(k.firstChild);
                                    for (; h.length;) 
                                        h.length && !c.noWrap && 0 < d && (
                                            m.push(g.textContent || ""),
                                            g.textContent = h.join(" ").replace(/- /g, "-")
                                        ),
                                        c.truncate(
                                            g,
                                            void 0,
                                ...
                                []
                                    ...
                                    .forEach(function (e) {
                                        e.nodeType === E.Node.TEXT_NODE
                                            ? f(e, c)
                                            : (
                                                -1 !== e.className.baseVal.indexOf("highcharts-br") && (a.actualWidth = 0),
                                                y(e)
                                            )
                                    })
                            };
                ...
                e.prototype.getLineHeight = function (c) {
                    var a;
                    c = c.nodeType === E.Node.TEXT_NODE
                        ? c.parentElement
                        : c;
                    this.renderer.styledMode || (
                        a = c && /(px|em)$/.test(c.style.fontSize)
                            ? c.style.fontSize
                    ...
                    return this.textLineHeight
                        ...
                        : this
                            .renderer
                            .fontMetrics(a, c || this.svgElement.element)
                            .h
                };
                        ...
                        e = function (g, q) {
                            ...
                            "br" === f
                                ? (
                                    ...
                                    g.textContent = "\u200b",
                                    (q = c[q + 1]) && q.textContent && (q.textContent = q.textContent.replace(/^ +/gm, ""))
                                )
                                : "a" === f && p && p.some(function (c) {
                ...
                e.prototype.truncate = function (c, a, e, k, q, f) {
                    var g = this.svgElement,
                        ...
                        D = function (b, d) {
                            d = d || b;
                            var h = c.parentNode;
                            if (h && "undefined" === typeof m[d]) 
                                if (h.getSubStringLength) 
                                    try {
                                        m[d] = k + h.getSubStringLength(
                                            0,
                                            e
                                                ? d + 1
                                                : d
                                ...
                                p.getSpanWidth && (
                                    c.textContent = f(a || e, b),
                                    m[d] = k + p.getSpanWidth(g, c)
                                );
                            return m[d]
                        };
                    g.rotation = 0;
                    ...
                    if (k + v > q) {
                        ...
                        0 === b
                            ? c.textContent = ""
                            : a && b === a.length - 1 || (c.textContent = d || f(a || e, l))
                    }
                    e && e.splice(0, l);
                    g.actualWidth = v;
                    g.rotation = t
        ...
        K(f, "Core/Renderer/SVG/SVGRenderer.js", [
            ...
            B = function () {
                ...
                J.prototype.init = function (b, d, a, l, r, m, J) {
                    ...
                    -1 === b
                        .innerHTML
                        .indexOf("xmlns") && z(L, "xmlns", this.SVG_NS);
                    this.isSVG = !0;
                    this.box = L;
                    this.boxWrapper = G;
                    this.alignedObjects = [];
                    ...
                    this
                        ...
                        .add()
                        .element
                        .appendChild(e.createTextNode("Created with Highcharts 10.1.0"));
                    this.defs = this
                        .createElement("defs")
                        .add();
                    this.allowHTML = m;
                ...
                J.prototype.rect = function (b, d, c, a, h, e) {
                    ...
                    this.styledMode || (
                        "undefined" !== typeof e && (b["stroke-width"] = e, b = l.crisp(b)),
                        b.fill = "none"
                    );
                    h && (b.r = h);
                ...
                J.prototype.symbol = function (c, a, l, r, J, G) {
                    ...
                    if (k) {
                        "number" === typeof a && (
                            f = k.call(this.symbols, Math.round(a || 0), Math.round(l || 0), r || 0, J || 0, G)
                        );
                        var p = this.path(f);
                        ...
                        ["width", "height"].forEach(function (d) {
                            t[d + "Setter"] = function (d, c) {
                                ...
                                this[c] = d;
                                b(a) && (
                                    G && "within" === G.backgroundSize && this.width && this.height && (a = Math.round(a * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
                                    this.element && this.element.setAttribute(c, a),
                                    this.alignByTranslate || (d = ((this[c] || 0) - a) / 2, this.attr(
                                        "width" === c
                                            ? {
                                                translateX: d
                                            }
                ...
                J.prototype.text = function (d, c, a, h) {
                    ...
                    if (!h || this.forExport && !this.allowHTML) 
                        d.xSetter = function (b, d, c) {
                            for (
                                var a = c.getElementsByTagName("tspan"),
                                h = c.getAttribute(d),
                                l = 0,
                                e;
                                l < a.length;
                                ...
                                e = a[l],
                                e.getAttribute(d) === h && e.setAttribute(d, b);
                            c.setAttribute(d, b)
                        };
                    return d
                };
                J.prototype.fontMetrics = function (b, d) {
                    b = !this.styledMode && /px/.test(b) || !y.getComputedStyle
                        ? b || d && d.style && d.style.fontSize || this.style && this.style.fontSize
                        : d && w
                            .prototype
                            .getStyle
                            .call(d, "font-size");
                ...
                J.prototype.pathToSegments = function (b) {
                    for (var d = [], c = [], a = {
                        ...
                        O(c[0]) && v(b[h]) && c.length === a[c[0].toUpperCase()] && b.splice(
                            h,
                            0,
                            c[0].replace("M", "L").replace("m", "l")
                        ),
                        "string" === typeof b[h] && (c.length && d.push(c.slice(0)), c.length = 0),
                        c.push(b[h]);
                    d.push(c.slice(0));
                    return d
                };
        ...
        K(f, "Core/Renderer/HTML/HTMLElement.js", [
            f["Core/Globals.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]
        ], function (a, f, B) {
            var C = this && this.__extends || function () {
                    var c = function (a, e) {
            ...
            return function (a) {
                ...
                g.prototype.htmlUpdateTransform = function () {
                    if (this.added) {
                        ...
                        !a.styledMode && this.shadows && this
                            .shadows
                            .forEach(function (b) {
                                u(b, {
                                    marginLeft: g + 1,
                        ...
                        if ("SPAN" === e.tagName) {
                            ...
                            D !== this.cTT && (
                                v = a.fontMetrics(e.style.fontSize, e).b,
                                !n(l) || l === (this.oldRotation || 0) && m === this.oldAlign || this.setSpanRotation(l, h, v),
                                this.getSpanCorrection(!n(l) && this.textPxLength || e.offsetWidth, v, h, l, m)
                            );
                            u(e, {
                ...
                g.prototype.setSpanRotation = function (c, a, e) {
                    var g = {},
                        k = E && !/Edge/.test(A.navigator.userAgent)
                            ? "-ms-transform"
                            : I
                                ? "-webkit-transform"
                                : w
                                    ...
                                    : A.opera
                                        ? "-o-transform"
                                        : void 0;
                    k && (g[k] = g.transform = "rotate(" + c + "deg)", g[k + (
                            w
                                ? "Origin"
                                : "-origin"
                        )] = g.transformOrigin = 100 * a + "% " + e + "px", u(this.element, g))
                };
                g.composedClasses = [];
                return g
            }(f)
            ...
            function (a, f, B, H) {
                ...
                return function (n) {
                    ...
                    k.compose = function (a) {
                        -1 === k
                            .composedClasses
                            .indexOf(a) && (k.composedClasses.push(a), a.prototype.html = k.prototype.html);
                        return a
                    };
                    k.prototype.html = function (e, c, k) {
                        ...
                        g
                            .attr({text: e, x: Math.round(c), y: Math.round(k)})
            ...
            (function (a) {
                a.registerEventOptions = function (a, u) {
                    ...
                    H(u.events, function (n, k) {
                        a.eventOptions[k] !== n && (
                            a.eventOptions[k] && (w(a, k, a.eventOptions[k]), delete a.eventOptions[k]),
                            B(n) && (a.eventOptions[k] = n, f(a, k, n))
                        )
                    })
                }
            })(E || (E = {}));
        ...
        K(f, "Core/Axis/Tick.js", [
            ...
            f = function () {
                    ...
                    if (e.dateTime) 
                        if (l) {
                            var P = f
                                .time
                                .resolveDTLFormat(
                                    g.dateTimeLabelFormats[!g.grid && l.higherRanks[h] || l.unitName]
                                );
                            var S = P.main
                        } else 
                            k(x) && (S = e.dateTime.getXDateFormat(x, g.dateTimeLabelFormats || {}));
                c.isFirst = d;
                    c.isLast = D;
                    var N = {
                        axis: e,
                    ...
                    var C = function (d) {
                        return b.formatter
                            ? b
                                ...
                                .call(d, d)
                            : b.format
                                ? (d.text = e.defaultLabelFormatter.call(d), a.format(b.format, d, f))
                                : e
                    ...
                    c.shortenLabel = X
                        ? function () {
                            for (O = 0; O < X.length; O++) 
                                if (u(N, {dateTimeLabelFormat: X[O]}), r.attr({
                                    text: C.call(N, N)
                                }), r.getBBox().width < e.getSlotWidth(c) - 2 * b.padding) 
                                    return;
                        r.attr({text: ""})
                        }
                        : void 0;
                    ...
                    I(r) || c.movedLabel
                        ? r && r.textStr !== g && !v && (
                            !r.textWidth || b.style.width || r.styles.width || r.css({width: null}),
                            r.attr({text: g}),
                            r.textPxLength = r.getBBox().width
                        )
                        : (c.label = r = c.createLabel({
                            x: 0,
                            y: 0
                        }, g, b), c.rotation = 0)
                };
                g.prototype.createLabel = function (c, a, g) {
                    ...
                    if (
                        c = I(a) && g.enabled
                            ? f.renderer.text(a, c.x, c.y, g.useHTML).add(k.labelGroup)
                            : null
                    ) 
                        f.styledMode || c.css(e(g.style)),
                        c.textPxLength = c
                            .getBBox()
                            .width;
                    return c
                ...
                g.prototype.getPosition = function (c, a, e, g) {
                    ...
                    c = {
                        x: c
                            ? E(k.translate(a + e, null, null, g) + k.transB)
                            : k.left + k.offset + (
                                k.opposite
                        ...
                        y: c
                            ...
                            : E(m - k.translate(a + e, null, null, g) - k.transB)
                    };
                    c.y = w(c.y, -1E5, 1E5);
                ...
                g.prototype.getLabelPosition = function (c, a, e, g, k, f, m, h) {
                    ...
                    I(q) || (
                        q = 0 === b.side
                            ...
                            : 2 === b.side
                                ? v.y + 8
                                : Math.cos(e.rotation * C) * (v.y - e.getBBox(!1, 0).height / 2)
                    );
                    c = c + k.x + r + v.x - (
                        f && g
                            ? f * l * (
                ...
                g.prototype.handleOverflow = function (c) {
                    ...
                    var h = this.label,
                        ...
                        n = 1,
                        t;
                    if (b || "justify" !== e.overflow) 
                        0 > b && g - l * d < m
                            ? t = Math.round(g / Math.cos(b * C) - m)
                            : 0 < b && g + l * d > f && (t = Math.round((k - g) / Math.cos(b * C)));
                    else if (
                        k = g + (1 - l) * d,
                        g - l * d < m
                            ? r = c.x + r * (1 - l) - m
                            : k > f && (r = f - c.x + r * l, n = -1),
                        r = Math.min(D, r),
                        r < D && "center" === a.labelAlign && (
                            c.x += n * (D - r - l * (D - Math.min(d, r)))
                        ),
                        d > r || a.autoRotation && (h.styles || {}).width
                    ) 
                        t = r;
                    t && (
                        this.shortenLabel
                            ? this.shortenLabel()
                            : (
                                v.width = Math.floor(t) + "px",
                                (e.style || {}).textOverflow || (v.textOverflow = "ellipsis"),
                                h.css(v)
                            )
                    )
                };
                g.prototype.moveLabel = function (a, e) {
                    var g = this,
                        ...
                        m = !1;
                    k && k.textStr === a
                        ? (g.movedLabel = k, m = !0, delete g.label)
                        : c(f.ticks, function (b) {
                            m || b.isNew || b === g || !b.label || b.label.textStr !== a || (
                                g.movedLabel = b.label,
                                m = !0,
                                b.labelPos = g.movedLabel.xy,
                                delete b.label
                            )
                        });
                    if (!m && (g.labelPos || k)) {
                ...
                g.prototype.renderGridLine = function (c, a, e) {
                    ...
                    "minor" === this.type && (
                        ...
                        v = k.minorGridLineColor,
                        r = k.minorGridLineDashStyle
                    );
                    d || (
                        g.chart.styledMode || (f.stroke = v, f["stroke-width"] = D || 0, f.dashstyle = r),
                        h || (f.zIndex = 1),
                        c && (a = 0),
                        this.gridLine = d = l.path().attr(f).addClass(
                            "highcharts-" + (
                                h
                                    ? h + "-"
                                    : ""
                ...
                g.prototype.renderMark = function (c, a, e) {
                    ...
                    var d = this.mark,
                        D = !d;
                    h && (g.opposite && (h[0] = -h[0]), d || (this.mark = d = f.path().addClass(
                        "highcharts-" + (
                            m
                                ? m + "-"
                                : ""
                        ) + "tick"
                    ).add(g.axisGroup), g.chart.styledMode || d.attr({stroke: k, "stroke-width": l})), d[
                        D
                            ? "attr"
                            : "animate"
                    ]({
                ...
                g.prototype.renderLabel = function (c, a, e, g) {
                    ...
                    var D = !0;
                    h && k(d) && (
                        h.xy = c = this.getLabelPosition(d, c, h, q, b, f, g, l),
                        this.isFirst && !this.isLast && !m.showFirstLabel || this.isLast && !this.isFirst && !m.showLastLabel
                            ? D = !1
                            : !q || b.step || b.rotation || a || 0 === e || this.handleOverflow(c),
                        l && g % l && (D = !1),
                        D && k(c.y)
                            ? (c.opacity = e, h[
                                this.isNewLabel
                                    ? "attr"
                                    : "animate"
                            ](c).show(!0), this.isNewLabel = !1)
                            : (h.hide(), this.isNewLabel = !0)
                    )
                };
            ...
            var u = a.animObject,
                ...
                C = function (b, d) {
                    return D(
                        ...
                        void 0,
                        void 0,
                        r(b.options.allowDecimals, .5 > d || void 0 !== b.tickAmount),
                        !!b.tickAmount
                    )
                };
            a = function () {
                ...
                a.prototype.init = function (d, c) {
                    var a = c.isX;
                    this.chart = d;
                    this.horiz = d.inverted && !this.isZAxis
                        ? !a
                        : a;
                    this.isXAxis = a;
                    this.coll = this.coll || (
                    ...
                    c = r(e.crosshair, S(d.options.tooltip.crosshairs)[
                        a
                            ? 0
                            : 1
                    ]);
                    ...
                    -1 === d
                        ...
                        .indexOf(this) && (
                            a
                                ? d.axes.splice(d.xAxis.length, 0, this)
                                : d.axes.push(this),
                            d[this.coll].push(this)
                        );
                    this.series = this.series || [];
                    d.inverted && !this.isZAxis && a && "undefined" === typeof this.reversed && (
                        this.reversed = !0
                    );
                    this.labelRotation = b(h.rotation)
                        ? h.rotation
                        : void 0;
                    k(this, e);
                    m(this, "afterInit")
                ...
                a.prototype.setOptions = function (b) {
                    this.options = d(
                        ...
                        [f.defaultTopAxisOptions, f.defaultRightAxisOptions, f.defaultBottomAxisOptions, f.defaultLeftAxisOptions][this.side],
                        d(n[this.coll], b)
                    );
                    m(this, "afterSetOptions", {userOptions: b})
                };
                a.prototype.defaultLabelFormatter = function (d) {
                    ...
                    if (c.categories) 
                        ...
                        for (; m-- && "undefined" === typeof J;) 
                            c = Math.pow(l, m + 1),
                            r >= c && 0 === 10 * a % c && null !== g[m] && 0 !== a && (
                                J = d(a / c, -1) + g[m]
                            );
                "undefined" === typeof J && (
                        J = 1E4 <= Math.abs(a)
                                ...
                                if (e.visible || !c.options.chart.ignoreHiddenSeries) {
                                    ...
                                    if (d.isXAxis) {
                                        if (h = e.xData, h.length) {
                                            h = d.logarithmic
                                                ? h.filter(d.validatePositiveValue)
                                                : h;
                                            a = e.getXExtremes(h);
                                            var g = a.min;
                                            var m = a.max;
                                            b(g) || g instanceof Date || (
                                                h = h.filter(b),
                                                a = e.getXExtremes(h),
                                                g = a.min,
                                                m = a.max
                                            ...
                                            h.length && (
                                                d.dataMin = Math.min(r(d.dataMin, g), g),
                                                d.dataMax = Math.max(r(d.dataMax, m), m)
                                            )
                                        }
                                    } else if (
                                        e = e.applyExtremes(),
                                        b(e.dataMin) && (g = e.dataMin, d.dataMin = Math.min(r(d.dataMin, g), g)),
                                        b(e.dataMax) && (m = e.dataMax, d.dataMax = Math.max(r(d.dataMax, m), m)),
                                        q(l) && (d.threshold = l),
                                        !h.softThreshold || d.positiveValuesOnly
                                    ) 
                                        d.softThreshold = !1
                                }
                            })
                ...
                a.prototype.translate = function (d, c, a, e, h, l) {
                    var g = this.linkedParent || this,
                        ...
                        r = g.minPixelPadding;
                    h = (
                        g.isOrdinal || g.brokenAxis && g.brokenAxis.hasBreaks || g.logarithmic && h
                    ) && g.lin2val;
                    var k = 1,
                        J = 0;
                    e = e && g.old
                ...
                a.prototype.toPixels = function (b, d) {
                    return this.translate(b, !1, !this.horiz, null, !0) + (
                        d
                            ? 0
                            : this.pos
                    )
                ...
                a.prototype.getPlotLinePath = function (d) {
                    ...
                    m(this, "getPlotLinePath", d, function (d) {
                        ...
                        b(q)
                            ? a.horiz
                                ? (z = l, O = v - a.bottom, t = y = c(t, h, h + a.width))
                                : (t = h, y = D - a.right, z = O = c(z, l, l + a.height))
                            : (P = !0, n = !1);
                        d.path = P && !n
                            ? null
                            : e
                ...
                a.prototype.getMinorTickPositions = function () {
                    ...
                    if (h && h / c < this.len / 3) {
                        ...
                        if (g) 
                            this
                                .paddedTicks
                                .forEach(function (b, d, a) {
                                    d && l
                                        .push
                                        .apply(l, g.getLogTickPositions(c, a[d - 1], a[d], !0))
                                });
                        else if (this.dateTime && "auto" === this.getMinorTickInterval()) 
                            l = l.concat(
                                this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(c), e, a, b.startOfWeek)
                            );
                        else 
                            for (b = e + (d[0] - e) % c; b <= a && b !== l[0]; b += c) 
                                l.push(b)
                    }
                ...
                a.prototype.adjustForMinRange = function () {
                    var b = this.options,
                        ...
                        m,
                        k;
                    this.isXAxis && "undefined" === typeof this.minRange && !d && (
                        q(b.min) || q(b.max) || q(b.floor) || q(b.ceiling)
                            ? this.minRange = null
                            : (
                ...
                a.prototype.setAxisTranslation = function () {
                    ...
                    if (e || a || h) {
                        ...
                        c = b.ordinal && b.ordinal.slope && v
                            ? b.ordinal.slope / v
                            : 1;
                        b.minPointOffset = g *= c;
                        b.pointRangePadding = k *= c;
                        b.pointRange = Math.min(
                            h,
                            b.single && a
                                ? 1
                                : d
                ...
                a.prototype.setTickInterval = function (d) {
                    var c = this.chart,
                        ...
                        v = e.maxPadding,
                        D = e.minPadding,
                        J = b(e.tickInterval) && 0 <= e.tickInterval
                            ? e.tickInterval
                            : void 0,
                        p = b(this.threshold)
                            ? this.threshold
                    ...
                    a && (
                        this.positiveValuesOnly && !d && 0 >= Math.min(this.min, r(this.dataMin, this.min)) && x(10, 1, c),
                        this.min = t(a.log2lin(this.min), 16),
                        this.max = t(a.log2lin(this.max), 16)
                    );
                    this.range && q(this.max) && (
                        this.userMin = this.min = n = Math.max(this.dataMin, this.minFromRange()),
                        this.userMax = z = this.max,
                        this.range = null
                    );
                    ...
                    !(
                        k || this.axisPointRange || this.stacking && this.stacking.usePercentage || l
                    ) && q(this.min) && q(this.max) && (c = this.max - this.min) && (
                        !q(n) && D && (this.min -= c * D),
                        !q(z) && v && (this.max += c * v)
                    );
                    b(this.userMin) || (
                        b(e.softMin) && e.softMin < this.min && (this.min = n = e.softMin),
                        b(e.floor) && (this.min = Math.max(this.min, e.floor))
                    );
                    b(this.userMax) || (
                        b(e.softMax) && e.softMax > this.max && (this.max = z = e.softMax),
                        b(e.ceiling) && (this.max = Math.min(this.max, e.ceiling))
                    );
                    f && q(this.dataMin) && (
                        p = p || 0,
                        !q(n) && this.min < p && this.dataMin >= p
                            ? this.min = this.options.minRange
                                ? Math.min(p, this.max - this.minRange)
                                : p
                            : !q(z) && this.max > p && this.dataMax <= p && (
                                this.max = this.options.minRange
                                    ? Math.max(p, this.min + this.minRange)
                                    : p
                            )
                    );
                    b(this.min) && b(this.max) && !this.chart.polar && this.min > this.max && (
                        q(this.options.min)
                            ? this.max = this.min
                            : q(this.options.max) && (this.min = this.max)
                    );
                    this.tickInterval = this.min === this.max || "undefined" === typeof this.min || "undefined" === typeof this.max
                        ? 1
                        : l && this.linkedParent && !J && g === this.linkedParent.options.tickPixelInterval
                            ? J = this.linkedParent.tickInterval
                            : r(
                                J,
                                this.tickAmount
                                ...
                                k
                                    ? 1
                                    : (this.max - this.min) * g / Math.max(this.len, g)
                            );
                    if (h && !d) {
                        var P = this.min !== (this.old && this.old.min) || this.max !== (
                            this.old && this.old.max
                        );
                        this
                            .series
                            .forEach(function (b) {
                        ...
                        m(this, "postProcessData", {hasExtemesChanged: P})
                    }
                    ...
                    d = r(
                        e.minTickInterval,
                        this.dateTime && !this.series.some(function (b) {
                    ...
                    this.dateTime || this.logarithmic || J || (
                        this.tickInterval = C(this, this.tickInterval)
                    );
                ...
                a.prototype.setTickPositions = function () {
                    ...
                    a = (e || !a) && b.endOnTick;
                    e = b.tickPositioner;
                    this.tickmarkOffset = this.categories && "between" === b.tickmarkPlacement && 1 === this.tickInterval
                        ? .5
                        : 0;
                    this.minorTickInterval = "auto" === c && this.tickInterval
                        ? this.tickInterval / 5
                        : c;
                    this.single = this.min === this.max && q(this.min) && !this.tickAmount && (
                    ...
                    if (!c) {
                        if (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))) 
                            if (this.dateTime) 
                                c = this.getTimeTicks(
                                    this.dateTime.normalizeTimeTickInterval(this.tickInterval, b.units),
                                    this.min,
                                    this.max,
                                    b.startOfWeek,
                                ...
                                c = this
                                    .logarithmic
                                    .getLogTickPositions(this.tickInterval, this.min, this.max);
                            else 
                                for (var l = b = this.tickInterval; l <= 2 * b;) 
                                    if (
                                        c = this.getLinearTickPositions(this.tickInterval, this.min, this.max),
                                        this.tickAmount && c.length > this.tickAmount
                                    ) 
                                        this.tickInterval = C(this, l *= 1.1);
                                    else 
                                        break;
                    else 
                            c = [
                    ...
                    this.isLinked || (
                        this.single && 2 > c.length && !this.categories && !this.series.some(function (b) {
                ...
                a.prototype.getThresholdAlignment = function (d) {
                    ...
                    if (b(this.threshold)) 
                        return d = g(
                            (this.threshold - (this.dataMin || 0)) / ((this.dataMax || 0) - (this.dataMin || 0)),
                            0,
                            1
                        ),
                        this.options.reversed && (d = 1 - d),
                        d
                };
                a.prototype.getTickAmount = function () {
                    var b = this.options,
                        ...
                        c = b.tickAmount;
                    !q(b.tickInterval) && !c && this.len < d && !this.isRadial && !this.logarithmic && b.startOnTick && b.endOnTick && (
                        c = 2
                    );
                ...
                a.prototype.adjustTickAmount = function () {
                    ...
                    if (d.hasData() && b(e) && b(a)) {
                        m = function () {
                            ...
                            d.max = h.endOnTick
                                ? l[l.length - 1]
                                : Math.max(a, l[l.length - 1])
                        };
                        if (b(D) && b(d.threshold)) {
                            for (; l[D] !== f || l.length !== g || l[0] > e || l[l.length - 1] < a;) {
                                l.length = 0;
                                for (l.push(d.threshold); l.length < g;) 
                                    void 0 === l[D] || l[D] > d.threshold
                                        ? l.unshift(t(l[0] - v))
                                        : l.push(t(l[l.length - 1] + v));
                                if (v > 8 * d.tickInterval) 
                                    break;
                                v *= 2
                            }
                            m()
                        ...
                        if (q(c)) {
                            for (v = f = l.length; v--;) 
                                (3 === c && 1 === v % 2 || 2 >= c && 0 < v && v < f - 1) && l.splice(v, 1);
                ...
                a.prototype.setScale = function () {
                    ...
                    c || b || d || this.isLinked || this.forceRedraw || this.userMin !== (
                        this.old && this.old.userMin
                    ) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers()
                        ? (
                            this.stacking && this.stacking.resetStacks(),
                            this.forceRedraw = !1,
                            this.getSeriesExtremes(),
                            this.setTickInterval(),
                            this.isDirty || (this.isDirty = c || this.min !== (this.old && this.old.min) || this.max !== (this.old && this.old.max))
                        )
                        : this.stacking && this
                            .stacking
                            .cleanStacks();
                ...
                a.prototype.zoom = function (b, d) {
                    ...
                    m(this, "zoom", b, function (b) {
                        ...
                        if (d !== c.min || h !== c.max) 
                            ...
                            c.displayBtn = "undefined" !== typeof d || "undefined" !== typeof h,
                            c.setExtremes(d, h, !1, void 0, {trigger: "zoom"});
                        b.zoomed = !0
                    });
                    return b.zoomed
                };
                a.prototype.setAxisSize = function () {
                    var b = this.chart,
                        ...
                        e = this.width = Math.round(
                            O(r(d.width, b.plotWidth - c[3] + c[1]), b.plotWidth)
                        ),
                        h = this.height = Math.round(
                            O(r(d.height, b.plotHeight - c[0] + c[2]), b.plotHeight)
                        ),
                        l = this.top = Math.round(
                            O(r(d.top, b.plotTop + c[0]), b.plotHeight, b.plotTop)
                        );
                    d = this.left = Math.round(
                        O(r(d.left, b.plotLeft + c[3]), b.plotWidth, b.plotLeft)
                    );
                ...
                a.prototype.getExtremes = function () {
                    ...
                    return {
                        min: b
                            ? t(b.lin2log(this.min))
                            : this.min,
                        max: b
                            ? t(b.lin2log(this.max))
                            : this.max,
                    ...
                    if (c) {
                        if (!d.staggerLines && !d.step) 
                            if (b(l)) 
                                ...
                                h < d.autoRotationLimit && (q = d.autoRotation);
                ...
                a.prototype.getSlotWidth = function (d) {
                    var c = this.chart,
                        ...
                        h = Math.max(this.tickPositions.length - (
                            this.categories
                                ? 0
                                : 1
                        ), 1),
                    ...
                    if (a && 2 > e.step) 
                        return e.rotation
                            ? 0
                            : (this.staggerLines || 1) * this.len / h;
                    if (!a) {
                        d = e.style.width;
                        if (void 0 !== d) 
                            return parseInt(String(d), 10);
                        if (l) 
                            return l - c.spacing[3]
                    }
                ...
                a.prototype.renderUnsquish = function () {
                        ...
                        if (!f) {
                            ...
                            for (r = c.length; !g && r--;) {
                                ...
                                if (n = a[n].label) 
                                    ...
                                    n
                                        .getBBox()
                                        .height > this.len / c.length - (v.h - v.f) && (
                    ...
                    c.forEach(function (b) {
                        ...
                        d && (
                            ...
                            b.shortenLabel
                                ? b.shortenLabel()
                                : p && !c && "nowrap" !== h.whiteSpace && (
                                    p < d.textPxLength || "SPAN" === d.element.tagName
                                )
                                    ? (
                                        e.width = p + "px",
                                        f || (e.textOverflow = d.specificTextOverflow || q),
                                        d.css(e)
                                    )
                                    : d.styles && d.styles.width && !e.width && !c && d.css({width: null}),
                            delete d.specificTextOverflow,
                            b.rotation = k.rotation
                        )
                    }, this);
                ...
                a.prototype.addTitle = function (b) {
                    ...
                    this.axisTitle || (
                        ...
                        this.axisTitle = c.text(h.text || "", 0, 0, h.useHTML).attr({zIndex: 7, rotation: h.rotation, align: g}).addClass("highcharts-axis-title"),
                        l || this.axisTitle.css(d(h.style)),
                        this.axisTitle.add(this.axisGroup),
                        this.axisTitle.isNew = !0
                    );
                    l || h.style.width || this.isRadial || this
                        .axisTitle
                        .css({
                            width: this.len + "px"
                        });
                ...
                a.prototype.getOffset = function () {
                    ...
                    if (!d.axisGroup) {
                        var N = function (d, c, a) {
                            return D
                                .g(d)
                                .attr({zIndex: a})
                                .addClass("highcharts-" + k.toLowerCase() + c + " " + (
                                    b.isRadial
                    ...
                    n || d.isLinked
                        ? (
                            ...
                            d.staggerLines && (ca *= d.staggerLines),
                            d.labelOffset = ca * (
                                d.opposite
                                    ? -1
                                    : 1
                    ...
                    ca && (n = n - t + O * (
                        a
                            ? r(z.y, d.tickRotCorr.y + 8 * O)
                            : z.x
                    ));
                    d.axisTitleMargin = r(u, n);
                    d.getMaxLabelDimensions && (
                        d.maxLabelDimensions = d.getMaxLabelDimensions(l, g)
                    );
                    "colorAxis" !== k && (
                        a = this.tickSize("tick"),
                        y[h] = Math.max(
                            y[h],
                            (d.axisTitleMargin || 0) + F + O * d.offset,
                            n,
                            g && g.length && a
                                ? a[0] + O * d.offset
                                : 0
                        ),
                        e = !d.axisLine || e.offset
                            ? 0
                ...
                a.prototype.getLinePath = function (b) {
                    ...
                    return d
                        ...
                        .crispLine([
                            ...
                            [
                                "L", e
                                    ? d.chartWidth - this.right
                                    : h,
                                e
                                    ? a
                                    : d.chartHeight - this.bottom
                            ]
                        ], b)
                };
                ...
                a.prototype.getTitlePosition = function () {
                    var b = this.horiz,
                        ...
                        f = this
                            .chart
                            .renderer
                            .fontMetrics(e.style.fontSize, v);
                    v = v
                        ? Math.max(v.getBBox(!1, 0).height - f.h - 1, 0)
                        : 0;
                    a = {
                        low: h + (
                            b
                    ...
                    m(this, "afterGetTitlePosition", {titlePosition: b});
                    return b
                };
                ...
                a.prototype.render = function () {
                    ...
                    if (d.hasData() || h) {
                        ...
                        d.minorTickInterval && !d.categories && d
                        ...
                        p && l.forEach(function (b, e) {
                            O = "undefined" !== typeof l[e + 1]
                                ? l[e + 1] + q
                                : d.max - q;
                            0 === e % 2 && b < d.max && O <= d.max + (
                                c.polar
                                    ? -q
                                    : q
                            ) && (f[b] || (f[b] = new E.PlotLineOrBand(d)), y = b + q, f[b].options = {
                                from: a
                                    ? a.lin2log(y)
                                    : y,
                                to: a
                        ...
                        d._addedPlotLB || (
                            d._addedPlotLB = !0,
                            (e.plotLines || []).concat(e.plotBands || []).forEach(function (b) {
                        ...
                        N(
                            function () {
                                for (var c = d.length; c--;) 
                                    b[d[c]] && !b[d[c]].isActive && (b[d[c]].destroy(), delete b[d[c]])
                            },
                            b !== f && c.hasRendered && a
                                ? a
                                : 0
                    ...
                    g && t && (e = d.getTitlePosition(), g[
                        g.isNew
                            ? "attr"
                            : "animate"
                    ](e), g.isNew = !1);
                    D && D.enabled && d.stacking && d
                        .stacking
                        .renderStackTotals();
                    d.old = {
                        len: d.len,
                ...
                "axisLine axisTitle axisGroup gridGroup labelGroup cross scrollbar"
                    ...
                    for (var e in d.plotLinesAndBandsGroups) 
                        d.plotLinesAndBandsGroups[e] = d
                            .plotLinesAndBandsGroups[e]
                            .destroy();
                    v(d, function (b, c) {
                        -1 === d
                            .getKeepProps()
                            .indexOf(c) && delete d[c]
                    });
                    this.eventOptions = a
                };
                a.prototype.drawCrosshair = function (b, d) {
                    ...
                    if (c && !1 !== (q(d) || !a)) {
                        ...
                        l || (this.cross = l = e.renderer.path().addClass(
                            ...
                            l.attr({
                                stroke: c.color || (
                                    a
                                        ? B.parse("#ccd6eb").setOpacity(.25).get()
                                        : "#cccccc"
                                ),
                                "stroke-width": r(c.width, 1)
                            }).css({"pointer-events": "none"}),
                            c.dashStyle && l.attr({dashstyle: c.dashStyle})
                        ));
                        l
                            .show()
                            .attr({d: g});
                        a && !c.width && l.attr({"stroke-width": this.transA});
                        this.cross.e = b
                    } else 
                        this.hideCrosshair();
                ...
                a.prototype.remove = function (b) {
                    for (var d = this.chart, c = this.coll, a = this.series, e = a.length; e--;) 
                        a[e] && a[e].remove(!1);
                    y(d.axes, this);
                    y(d[c], this);
            ...
            (function (a) {
                function A() {
                    return this
                        ...
                        .time
                        .getTimeTicks
                        .apply(this.chart.time, arguments)
                }
                function u(a) {
                ...
                var k = function () {
                    ...
                    a.prototype.normalizeTimeTickInterval = function (c, a) {
                        ...
                        for (p = 0; p < e.length && !(
                            ...
                            k = w[a[0]],
                            f = a[1],
                            e[p + 1] && c <= (k * f[f.length - 1] + w[e[p + 1][0]]) / 2
                        ); p++) 
                        ;
                        ...
                        return {unitRange: k, count: c, unitName: a[0]}
                    };
                    a.prototype.getXDateFormat = function (c, a) {
                        ...
                        return e.closestPointRange
                            ? e
                                .chart
                                .time
                                .getDateFormat(e.closestPointRange, c, e.options.startOfWeek, a) || a.year
                            : a.day
                    };
                    return a
                }();
            ...
            (function (a) {
                ...
                var n = function () {
                    ...
                    a.prototype.getLogTickPositions = function (a, c, k, g) {
                        ...
                        if (.5 <= a) 
                            a = Math.round(a),
                            n = e.getLinearTickPositions(a, c, k);
                        else if (.08 <= a) {
                            var x = Math.floor(c),
                                z,
                                m = p = void 0;
                            ...
                            a = H(
                                ...
                                p.tickPixelInterval / (
                                    ...
                                    g
                                        ? f / e.tickPositions.length
                                        : f
                                ) || 1)
                            ),
                            a = B(a),
                            n = e
                                .getLinearTickPositions(a, c, k)
                                .map(this.log2lin),
                    ...
                    var u = function () {
                            ...
                            if (a && k) {
                                ...
                                for (e = 0; e < a.length; e += 2) {
                                    var n = a[e],
                                        ...
                                        x = k[e],
                                        z = k[e + 1];
                                    "M" !== n[0] && "L" !== n[0] || "M" !== y[0] && "L" !== y[0] || "M" !== x[0] && "L" !== x[0] || "M" !== z[0] && "L" !== z[0] || (
                                        f && x[1] === n[1]
                                            ? (x[1] += c, z[1] += c)
                                            : f || x[2] !== n[2] || (x[2] += c, z[2] += c),
                                        g.push([
                                            "M", n[1], n[2]
                                        ], [
                                            "L", y[1], y[2]
                        ...
                        a.prototype.addPlotBandOrLine = function (a, e) {
                            ...
                            if (g) {
                                this._addedPlotLB || (
                                    this._addedPlotLB = !0,
                                    (k.plotLines || []).concat(k.plotBands || []).forEach(function (a) {
        ...
        K(f, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [
            ...
            f = function () {
                ...
                e.prototype.render = function () {
                    ...
                    a.chart.styledMode || (
                        r
                            ? (
                                S.stroke = F || "#999999",
                                S["stroke-width"] = k(q.width, 1),
                                q.dashStyle && (S.dashstyle = q.dashStyle)
                            )
                            : O && (
                                S.fill = F || "#e6ebf5",
                                q.borderWidth && (S.stroke = q.borderColor, S["stroke-width"] = q.borderWidth)
                            )
                    );
                    z.zIndex = y;
                    N += "-" + y;
                    (f = a.plotLinesAndBandsGroups[N]) || (a.plotLinesAndBandsGroups[N] = f = m.g(
                        "plot-" + N
                    ).attr(z).add());
                    ...
                    (P || !v.d) && r && r.length
                        ...
                        : v && (
                            r
                                ? (v.show(), v.animate({d: r}))
                                : v.d && (v.hide(), b && (c.label = b = b.destroy()))
                        );
                    h && (w(h.text) || w(h.formatter)) && r && r.length && 0 < a.width && 0 < a.height && !r.isFlat
                        ? (h = u({
                            align: e && O && "center",
                            x: e
                                ? !O && 4
                ...
                e.prototype.renderLabel = function (c, a, e, f) {
                    ...
                    p.alignValue && "left" !== p.alignValue || p.css({
                        width: (
                            90 === p.rotation
                                ? g.height - (p.alignAttr.y - g.top)
                                : g.width - (p.alignAttr.x - g.left)
                        ) + "px"
                    });
                    p.show(!0)
                };
                e.prototype.getLabelText = function (a) {
                    return w(a.formatter)
                        ? a
                            .formatter
                            .call(this)
                        : a.text
        ...
        K(
            ...
            "Core/Tooltip.js",
            [
                f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]
            ],
            function (a, f, B, H, w) {
                var C = a.format,
                    I = f.doc,
                ...
                a = function () {
                    ...
                    a.prototype.bodyFormatter = function (b) {
                        return b.map(function (b) {
                            ...
                            return (
                                d[(b.point.formatPrefix || "point") + "Formatter"] || b.point.tooltipFormatter
                            ).call(b.point, d[(b.point.formatPrefix || "point") + "Format"] || "")
                        })
                    };
                    ...
                    a.prototype.getAnchor = function (b, a) {
                        ...
                        this.followPointer && a
                            ? ("undefined" === typeof a.chartX && (a = c.normalize(a)), c = [
                                a.chartX - l,
                                a.chartY - h
                            ])
                            : b[0].tooltipPos
                                ...
                                : (b.forEach(function (b) {
                                    ...
                                    m && g && (
                                        e
                                            ? (f += h + d.plotHeight - m.len - m.pos, k += l + d.plotWidth - g.len - g.pos)
                                            : (f += m.pos - l, k += g.pos - h)
                                    )
                                }), f /= b.length, k /= b.length, c = [
                                    e
                                        ? d.plotWidth - k
                                        : f,
                                    e
                    ...
                    a.prototype.getLabel = function () {
                        var b = this,
                            ...
                            g = d.style.pointerEvents || (
                                !this.followPointer && d.stickOnContact
                                    ? "auto"
                                    : "none"
                            ),
                            m = function () {
                            ...
                            p = function (d) {
                                ...
                                b.inContact = b.shouldStickOnContact() && b
                                    .chart
                                    .pointer
                                    .inClass(d.relatedTarget, "highcharts-tooltip");
                                if (!b.inContact && a && a.onMouseOut) 
                                    a.onMouseOut()
                            },
                            n,
                        ...
                        if (!this.label) {
                            ...
                            c
                                ? this.label = q.g(h)
                                : (
                                    this.label = q.label("", 0, 0, d.shape, void 0, void 0, d.useHTML, void 0, h).attr({padding: d.padding, r: d.borderRadius}),
                                    a || this.label.attr({fill: d.backgroundColor, "stroke-width": d.borderWidth}).css(d.style).css({pointerEvents: g}).shadow(d.shadow)
                                );
                    ...
                    a.prototype.getPosition = function (b, a, d) {
                        var c = this.chart,
                            ...
                            g = this.outside,
                            m = g
                                ? I.documentElement.clientWidth - 2 * e
                                : c.chartWidth,
                            f = g
                                ? Math.max(
                                    I.body.scrollHeight,
                                    ...
                                    g
                                        ? [
                                            l
                                                ...
                                                : a * k.scaleY,
                                            l
                                                ? k.left - e + (d.plotX + c.plotLeft) * k.scaleX
                                                : k.top - e + (d.plotY + c.plotTop) * k.scaleY,
                                            0,
                                            l
                                                ? m
                                                : f
                            ...
                            z;
                        p = !!d.negative;
                        !c.polar && c.hoverSeries && c.hoverSeries.yAxis && c.hoverSeries.yAxis.reversed && (
                            p = !p
                        );
                    ...
                    a.prototype.move = function (b, a, d, c) {
                        var e = this,
                            h = e.now,
                            l = !1 !== e.options.animation && !e.isHidden && (
                                1 < Math.abs(b - h.x) || 1 < Math.abs(a - h.y)
                            ),
                    ...
                    a.prototype.refresh = function (b, a) {
                        ...
                        if (c.enabled && h.series) {
                            ...
                            var n = b[0],
                                q = b[1];
                            f && this.allowShared
                                ? (d.pointer.applyInactiveState(e), e.forEach(function (b) {
                                    b.setState("hover");
                            ...
                            if (!1 === m) 
                                ...
                                if (this.split && this.allowShared) 
                                    this.renderSplit(m, e);
                                else {
                                    var y = n,
                                        F = q;
                                    a && d.pointer.isDirectTouch && (
                                        y = a.chartX - d.plotLeft,
                                        F = a.chartY - d.plotTop
                                    );
                                    if (d.polar || !1 === f.options.clip || e.some(function (b) {
                                        return b
                                            .series
                                            .shouldShowTooltip(y, F)
                                    })) 
                                        a = this.getLabel(),
                                        c.style.width && !k || a.css({
                                        ...
                                        a
                                            ...
                                            .addClass("highcharts-color-" + x(h.colorIndex, f.colorIndex)),
                                        k || a.attr({
                    ...
                    a.prototype.renderSplit = function (b, a) {
                            ...
                            .reduce(function (b, e, h) {
                                if (!1 !== e && "" !== e) {
                                    ...
                                    r || (
                                        ...
                                        w || (r.fill = G.backgroundColor, r["stroke-width"] = G.borderWidth),
                                        r = W.label("", 0, 0, G[
                                            v
                                                ? "headerShape"
                                                : "shape"
                                        ], void 0, void 0, G.useHTML).addClass((
                                            v
                                                ? "highcharts-tooltip-header "
                                                : ""
                                        ) + "highcharts-tooltip-box " + p).attr(r).add(V)
                                    );
                                    r.isActive = !0;
                                    r.attr({text: e});
                                    w || r
                        ...
                        !T && b.some(function (b) {
                            ...
                            return d < M.left && d + b.boxWidth < M.right
                                ? !0
                                : d < R - M.left + b.boxWidth && M.right - d > d
                        }) && (b = b.map(function (b) {
                        ...
                        b.forEach(function (b) {
                            ...
                            b = b.isHeader;
                            b || (
                                c.outside && R + d < H && (H = R + d),
                                !b && c.outside && H + a > ba && (ba = R + d)
                            )
                        });
                        b.forEach(function (b) {
                            var d = b.x,
                            ...
                            if (c.outside && d < a) {
                                var l = R - H;
                                0 < l && (
                                    h || (e.x = d + l, e.anchorX = a + l),
                                    h && (e.x = (ba - H) / 2, e.anchorX = a + l)
                                )
                            }
                            b
                                .tt
                        ...
                        c.outside && b && z && (
                            h = V.getBBox(),
                            z.setSize(h.width + h.x, h.height + h.y, !1),
                            b.style.left = H + "px",
                            b.style.top = e + "px"
                        )
                    };
                    a.prototype.drawTracker = function () {
                        if (this.followPointer || !this.options.stickOnContact) 
                            ...
                            if (a && d) {
                                ...
                                c.y = Math.min(0, d[1]);
                                c.width = 0 > d[0]
                                    ? Math.max(Math.abs(d[0]), e.width - d[0])
                                    : Math.max(Math.abs(d[0]), e.width);
                                c.height = 0 > d[1]
                                    ? Math.max(Math.abs(d[1]), e.height - Math.abs(d[1]))
                                    : Math.max(Math.abs(d[1]), e.height);
                                this.tracker
                                    ? this
                                        .tracker
                                        .attr(c)
                                    : (
                                        this.tracker = a.renderer.rect(c).addClass("highcharts-tracker").add(a),
                    ...
                    a.prototype.tooltipFooterHeaderFormatter = function (b, a) {
                        ...
                        g(this, "headerFormatter", e, function (a) {
                            ...
                            h && l && (b.point && b.point.tooltipDateKeys || ["key"]).forEach(
                                function (b) {
                    ...
                    a.prototype.updatePosition = function (b) {
                        ...
                        if (this.outside) {
                            ...
                            this
                                .renderer
                                .setSize(e.width + d, e.height + d, !1);
        ...
        K(
            ...
            [
                f["Core/Renderer/HTML/AST.js"], f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/FormatUtilities.js"], f["Core/Utilities.js"]
            ],
            function (a, f, B, H, w) {
                var C = f.animObject,
                    I = B.defaultOptions,
                ...
                f = function () {
                    ...
                    l.prototype.applyOptions = function (b, a) {
                        ...
                        this.formatPrefix = (
                            this.isNull = z(this.isValid && !this.isValid(), null === this.x || !q(this.y))
                        )
                            ? "null"
                            : "point";
                        this.selected && (this.state = "select");
                        "name" in this && "undefined" === typeof a && d.xAxis && d.xAxis.hasNames && (
                            this.x = d.xAxis.nameToX(this)
                        );
                        "undefined" === typeof this.x && d
                            ? this.x = "undefined" === typeof a
                                ? d.autoIncrement()
                                : a
                            : q(b.x) && d.options.relativeXValue && (this.x = d.autoIncrement(b.x));
                        return this
                    };
                    l.prototype.destroy = function () {
                        ...
                        if (a === e.hoverPoint) 
                            a.onMouseOut();
                        c && c.enabled
                            ? (this.animateBeforeDestroy(), m(b, g.duration))
                            : b();
                        e.pointCount--
                    };
                    ...
                    l.prototype.getZone = function () {
                        ...
                        this.color = c && c.color && !this.options.color
                            ? c.color
                            : this.nonZonedColor;
                        return c
                    };
                    ...
                    l.prototype.optionsToObject = function (b) {
                        ...
                        if (q(b) || null === b) 
                            ...
                            for (!a && b.length > e && (
                                ...
                                a && "undefined" === typeof b[m] || (
                                    0 < c[f].indexOf(".")
                                        ? l.prototype.setNestedProperty(h, b[m], c[f])
                                        : h[c[f]] = b[m]
                                ),
                                m++,
                                f++;
                    ...
                    l.prototype.update = function (b, a, c, e) {
                        function d() {
                            ...
                            F(b, !0) && (
                                g && g.element && b && b.marker && "undefined" !== typeof b.marker.symbol && (h.graphic = g.destroy()),
                                b && b.dataLabels && h.dataLabel && (h.dataLabel = h.dataLabel.destroy()),
                                h.connector && (h.connector = h.connector.destroy())
                            );
                            k = h.index;
                            l.updateParallelArrays(h, k);
                            f.data[k] = F(f.data[k], !0) || F(b, !0)
                                ? h.options
                                : z(b, f.data[k]);
                    ...
                    l.prototype.remove = function (b, a) {
                        this
                            .series
                            .removePoint(this.series.data.indexOf(this), b, a)
                    };
                        ...
                        d.firePointEvent(
                            ...
                            function () {
                                ...
                                a || e
                                    ...
                                    .forEach(function (b) {
                                        var a = b.series;
                                        b.selected && b !== d && (b.selected = b.options.selected = !1, a.options.data[
                                            a
                                                .data
                                                .indexOf(b)
                                        ] = b.options, b.setState(
                    ...
                    l.prototype.onMouseOver = function (b) {
                        ...
                        b = b
                            ? a.normalize(b)
                            : a.getChartCoordinatesFromPoint(this, d.inverted);
                        a.runPointActions(b, this)
                    };
                    l.prototype.onMouseOut = function () {
                        var b = this.series.chart;
                        this.firePointEvent("mouseOut");
                        this.series.options.inactiveOtherPoints || (b.hoverPoints || []).forEach(
                            function (b) {
                                b.setState()
                            }
                        );
                    ...
                    l.prototype.setState = function (b, h) {
                        ...
                        if (!(b === this.state && !h || this.selected && "select" !== b || !1 === g.enabled || b && (p || f && !1 === k.enabled) || b && n.states && n.states[b] && !1 === n.states[b].enabled)) {
                            ...
                            if (this.graphic && !this.hasDummyGraphic) {
                                l && this
                                    .graphic
                                    .removeClass("highcharts-point-" + l);
                                b && this
                                    .graphic
                                    .addClass("highcharts-point-" + b);
                                if (!D.styledMode) {
                                    var u = d.pointAttribs(this, b);
                                    var G = z(D.options.chart.animation, g.animation);
                                    d.options.inactiveOtherPoints && q(u.opacity) && (
                                ...
                                x && this
                                    .graphic
                                    .animate(x, z(D.options.chart.animation, k.animation, m.animation));
                                F && F.hide()
                            } else {
                                if (b && k) {
                                    l = n.symbol || d.symbol;
                                    ...
                                    if (x) 
                                        if (F) 
                                            ...
                                            l && (
                                                d.stateMarkerGraphic = F = D.renderer.symbol(l, x.x, x.y, x.width, x.height).add(d.markerGroup),
                                                F.currentSymbol = l
                                            );
                                !D.styledMode && F && "inactive" !== this.state && F.attr(
                                        d.pointAttribs(this, b)
                                    )
                                }
                                F && (F[
                                    b && this.isInside
                                        ? "show"
                                        : "hide"
                                ](), F.element.point = this, F.addClass(this.getClassName(), !0))
                            }
                            g = g.halo;
                            x = (F = this.graphic || F) && F.visibility || "inherit";
                            g && g.size && F && "hidden" !== x && !this.isCluster
                                ? (t || (d.halo = t = D.renderer.path().add(F.parentGroup)), t.show()[
                                    h
                                        ? "animate"
                                        : "attr"
                                ]({
                                    ...
                                    "class": "highcharts-halo highcharts-color-" + z(this.colorIndex, d.colorIndex) + (
                                        this.className
                                            ? " " + this.className
                                            : ""
                                    ),
                                ...
                                : t && t.point && t.point.haloPath && t.animate({
                                    d: t
                                        .point
                                        .haloPath(0)
                                }, null, t.hide);
                            c(this, "afterSetState", {state: b})
                        }
                    };
                    l.prototype.haloPath = function (b) {
                        return this
                            ...
                            .renderer
                            .symbols
                            .circle(Math.floor(this.plotX) - b, this.plotY - b, 2 * b, 2 * b)
                    };
                    return l
                }();
                "";
        ...
        K(
            ...
            "Core/Pointer.js",
            [
                f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Tooltip.js"], f["Core/Utilities.js"]
            ],
            function (a, f, B, H) {
                var w = a.parse,
                    C = f.charts,
                ...
                a = function () {
                        ...
                        this
                            ...
                            .forEach(function (b) {
                                -1 === c.indexOf(b)
                                    ...
                                    : b.options.inactiveOtherPoints && b.setAllPointsToState("inactive")
                            })
                    };
                    a.prototype.destroy = function () {
                        var c = this;
                        ...
                        if (!F || !F.touch) 
                            if (
                                ...
                                z < m
                                    ? z = m
                                    : z > m + k && (z = m + k),
                                this.hasDragged = Math.sqrt(Math.pow(p - x, 2) + Math.pow(n - z, 2)),
                                10 < this.hasDragged
                            ) {
                                var u = c.isInsidePlot(p - g, n - m, {
                                    visiblePlotOnly: !0
                                });
                                !c.hasCartesianSeries && !c.mapView || !this.zoomX && !this.zoomY || !u || y || F || (
                                    this.selectionMarker = F = c.renderer.rect(
                                        g,
                                        m,
                                        e
                                            ? 1
                                        ...
                                        d
                                            ...
                                            : k,
                                        0
                                    ).attr({"class": "highcharts-selection-marker", zIndex: 7}).add(),
                                    c.styledMode || F.attr({
                                        fill: b.selectionMarkerFill || w("#335cad")
                                            .setOpacity(.25)
                                            .get()
                                    })
                                );
                    ...
                    a.prototype.drop = function (a) {
                        ...
                        b && g(b.index) && (
                            n(b.container, {cursor: b._cursor}),
                    ...
                    a.prototype.findNearestKDPoint = function (a, c, b) {
                        ...
                        a.forEach(function (d) {
                            ...
                            if ((a = t(d, !0) && d.series) && !(a = !t(h, !0))) {
                                a = h.distX - d.distX;
                                var e = h.dist - d.dist,
                                    l = (d.series.group && d.series.group.zIndex) - (
                    ...
                    a.prototype.getHoverData = function (a, e, b, l, d, g) {
                        ...
                        var f = e && !e.stickyTracking
                            ...
                            : b.filter(function (b) {
                                return m.filter
                                    ? m.filter(b)
                                    : b.visible && !(!d && b.directTouch) && y(b.options.enableMouseTracking, !0) && b.stickyTracking
                            });
                        var k = l || !g
                            ? a
                            : this.findNearestKDPoint(f, d, g);
                        e = k && k.series;
                        k && (
                            d && !e.noSharedTooltip
                                ? (f = b.filter(function (b) {
                                    return m.filter
                                        ? m.filter(b)
                                        : b.visible && !(!d && b.directTouch) && y(b.options.enableMouseTracking, !0) && !b.noSharedTooltip
                        ...
                        return {hoverPoint: m.hoverPoint, hoverSeries: e, hoverPoints: h}
                    };
                    ...
                    a.prototype.onTrackerMouseOut = function (a) {
                        ...
                        if (!(!c || !a || c.stickyTracking || this.inClass(a, "highcharts-tooltip") || this.inClass(a, "highcharts-series-" + c.index) && this.inClass(a, "highcharts-tracker"))) 
                            c.onMouseOut()
                    };
                    ...
                    a.prototype.init = function (a, c) {
                        ...
                        this.lastValidTouch = {};
                        B && (
                            a.tooltip = new B(a, c.tooltip),
                            this.followTouchMove = y(c.tooltip.followTouchMove, !0)
                        );
                        this.setDOMEvents()
                    };
                    a.prototype.normalize = function (a, c) {
                        var b = a.touches,
                            h = b
                                ? b.length
                                    ? b.item(0)
                                    : y(b.changedTouches, a.changedTouches)[0]
                                : a;
                    ...
                    a.prototype.onContainerClick = function (a) {
                        ...
                        c.cancelClick || (
                            b && this.inClass(a.target, "highcharts-tracker")
                                ? (
                                    p(b.series, "click", e(a, {point: b})),
                                    c.hoverPoint && b.firePointEvent("click", a)
                                )
                                : (e(a, this.getCoordinates(a)), c.isInsidePlot(a.chartX - l, a.chartY - d, {
                                    visiblePlotOnly: !0
                                }) && p(c, "click", a))
                        )
                    };
                    ...
                    a.prototype.onContainerMouseLeave = function (c) {
                        ...
                        b && b.shouldStickOnContact() && this.inClass(
                            c.relatedTarget,
                            "highcharts-tooltip-container"
                        ) || (
                            c = this.normalize(c),
                            e && (c.relatedTarget || c.toElement) && (e.pointer.reset(), e.pointer.chartPosition = void 0),
                    ...
                    a.prototype.onContainerMouseMove = function (a) {
                        ...
                        c.openMenu || !this.inClass(a.target, "highcharts-tracker") && !c.isInsidePlot(
                            a.chartX - c.plotLeft,
                            a.chartY - c.plotTop,
                            {
                                visiblePlotOnly: !0
                    ...
                    a.prototype.onDocumentMouseMove = function (a) {
                        ...
                        var e = c.tooltip;
                        !b || e && e.isStickyOnContact() || c.isInsidePlot(
                            a.chartX - c.plotLeft,
                            a.chartY - c.plotTop,
                            {
                                visiblePlotOnly: !0
                    ...
                    a.prototype.pinch = function (a) {
                        var c = this,
                            ...
                            m = {},
                            n = 1 === g && (
                                c.inClass(a.target, "highcharts-tracker") && b.runTrackerClick || c.runChartClick
                            ),
                            q = {},
                            t = c.selectionMarker;
                        1 < g
                            ? c.initiated = !0
                            : 1 === g && this.followTouchMove && (c.initiated = !1);
                        ...
                        "touchstart" === a.type
                            ...
                            : c.followTouchMove && 1 === g
                                ? this.runPointActions(c.normalize(a))
                                : l.length && (p(b, "touchpan", {
                                    originalEvent: a
                                }, function () {
                    ...
                    a.prototype.pinchTranslateDirection = function (a, c, b, e, d, g, f, k) {
                        var h = this.chart,
                            ...
                            y = !D && c[1][r];
                        c = function () {
                            "number" === typeof F && 20 < Math.abs(t - y) && (
                                z = k || Math.abs(M - F) / Math.abs(t - y)
                            );
                            G = (n - M) / z + t;
                            x = h["plot" + (
                                    a
                        ...
                        if (b < v.min) {
                            ...
                            b + x > v.max && (b = v.max - x, u = !0);
                        u
                            ? (
                                M -= .8 * (M - f[l][0]),
                                "number" === typeof F && (F -= .8 * (F - f[l][1])),
                                c()
                            )
                            : f[l] = [M, F];
                        q || (g[l] = G - n, g[p] = x);
                                ...
                                g.shared && h
                                    ? h.forEach(function (b) {
                                        ...
                                        b.series.isCartesian && (
                                            b.series.xAxis.crosshair && b.series.xAxis.drawCrosshair(null, b),
                    ...
                    a.prototype.runPointActions = function (e, h) {
                        var b = this.chart,
                            g = b.tooltip && b.tooltip.options.enabled
                                ? b.tooltip
                                : void 0,
                            d = g
                                ? g.shared
                        ...
                        h = this.getHoverData(
                            ...
                            k,
                            b.series,
                            (!e || "touchmove" !== e.type) && (!!h || k && k.directTouch && this.isDirectTouch),
                            d,
                            e
                        );
                        f = h.hoverPoint;
                        ...
                        if (f && (f !== b.hoverPoint || g && g.isHidden)) {
                            ...
                            h && g && !g.isHidden && (d = g.getAnchor([
                                {}
                            ], e), b.isInsidePlot(d[0], d[1], {
                                visiblePlotOnly: !0
                            }) && g.updatePosition({plotX: d[0], plotY: d[1]}));
                        this.unDocMouseMove || (
                            this.unDocMouseMove = A(b.container.ownerDocument, "mousemove", function (b) {
                                var d = C[a.hoverChartIndex];
                                if (d) 
                                    d
                                        .pointer
                                        .onDocumentMouseMove(b)
                                }),
                    ...
                    a.prototype.scaleGroups = function (a, c) {
                        ...
                        b
                            ...
                            .forEach(function (e) {
                                ...
                                e.group && (e.xAxis && e.xAxis.zoomEnabled || b.mapView) && (
                                    e.group.attr(d),
                                    e.markerGroup && (e.markerGroup.attr(d), e.markerGroup.clip(
                                        c
                                            ? b.clipRect
                                            : null
                                    )),
                    ...
                    a.prototype.setDOMEvents = function () {
                        ...
                        this
                            .eventsToUnbind
                            .push(A(e, "mouseenter", this.onContainerMouseEnter.bind(this)));
                        this
                            .eventsToUnbind
                            .push(A(e, "mouseleave", this.onContainerMouseLeave.bind(this)));
                        a.unbindDocumentMouseUp || (
                            a.unbindDocumentMouseUp = A(b, "mouseup", this.onDocumentMouseUp.bind(this))
                        );
                        for (var g = this.chart.renderTo.parentElement; g && "BODY" !== g.tagName;) 
                            this
                                .eventsToUnbind
                                .push(A(g, "scroll", function () {
                                    delete c.chartPosition
                                })),
                            g = g.parentElement;
                        f.hasTouch && (
                            this.eventsToUnbind.push(A(e, "touchstart", this.onContainerTouchStart.bind(this), {
                                passive: !1
                            })),
                    ...
                    a.prototype.setHoverChartIndex = function () {
                        ...
                        if (e && e !== c) 
                            e
                                .pointer
                                .onContainerMouseLeave({relatedTarget: c.container});
                    ...
                    a.prototype.touch = function (a, c) {
                        ...
                        if (1 === a.touches.length) 
                            if (
                                a = this.normalize(a),
                                (e = b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop, {
                                    visiblePlotOnly: !0
                                })) && !b.openMenu
                            ) {
                                ...
                                if ("touchmove" === a.type) {
                                    ...
                                    var d = c[0]
                                        ? 4 <= Math.sqrt(
                                            Math.pow(c[0].chartX - a.chartX, 2) + Math.pow(c[0].chartY - a.chartY, 2)
                                        )
                                        : !1
                                }
                                y(d, !0) && this.pinch(a)
                    ...
                    a.prototype.touchSelect = function (a) {
                        return !(
                            !this.chart.options.chart.zoomBySingleTouch || !a.touches || 1 !== a.touches.length
                        )
                    };
        ...
        K(f, "Core/MSPointer.js", [
            ...
            function w(a, c, e, g) {
                ...
                "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !k || (
                    k = k.pointer,
                    g(a),
                    k[c]({type: e, target: a.currentTarget, preventDefault: u, touches: C()})
                )
            }
        ...
        K(f, "Core/Legend/Legend.js", [
            ...
            E = function () {
                ...
                a.prototype.setOptions = function (b) {
                    ...
                    this.chart.styledMode || (
                        ...
                        this.itemHiddenStyle = x(this.itemStyle, b.itemHiddenStyle)
                    );
                ...
                a.prototype.colorizeItem = function (b, a) {
                    ...
                    if (!this.chart.styledMode) {
                        ...
                        e && e.attr({stroke: l});
                        h && (
                            f && h.isMarker && (k = b.pointAttribs(), a || (k.stroke = k.fill = g)),
                            h.attr(k)
                        )
                    }
                ...
                a.prototype.positionItem = function (b) {
                    ...
                    f && f.element && (
                        c = {
                            translateX: e
                                ? d
                                : this.legendWidth - d - 2 *c - 4,
                            translateY: h
                        },
                        e = function () {
                            F(a, "afterPositionItem", {item: b})
                        },
                        g(f.translateY)
                            ? f.animate(c, void 0, e)
                            : (f.attr(c), e())
                    );
                    l && (l.x = d, l.y = h)
                };
                            ...
                            .forEach(function (d) {
                                ...
                                if (h) {
                                    ...
                                    p(h, {
                                        ...
                                        top: g + "px",
                                        display: this.proximate || g > e - 6 && g < e + a - 6
                                            ? ""
                                            : "none"
                                    })
                                }
                ...
                a.prototype.renderItem = function (b) {
                    ...
                    G || (b.legendGroup = d.g("legend-item").addClass(
                        "highcharts-" + p.type + "-series highcharts-color-" + b.colorIndex + (
                            y
                                ? " " + y
                                : ""
                        ) + (
                            m
                                ? " highcharts-series-" + b.index
                                : ""
                        )
                    ).attr({zIndex: 1}).add(this.scrollGroup), b.legendItem = G = d.text(
                        "",
                        k
                            ? e + h
                            : -h,
                        ...
                        align: k
                            ...
                            : "right",
                        zIndex: 2
                    }).add(b.legendGroup), this.baseline || (
                        ...
                        c.squareSymbol && (
                            this.symbolWidth = z(c.symbolWidth, Math.max(this.symbolHeight, 16)),
                            n = this.symbolWidth + h + f + (
                                q
                                    ? 20
                                    : 0
                            ),
                            k && G.attr("x", this.symbolWidth + h)
                        )
                    ), p.drawLegendSymbol(this, b), this.setItemEvents && this.setItemEvents(b, G, t));
                    ...
                    this.itemHeight = b.itemHeight = Math.round(b.legendItemHeight || (
                        a.height > 1.5 * d
                            ? a.height
                            : d
                    ))
                ...
                a.prototype.layoutItem = function (b) {
                    ...
                    a = a.alignColumns && this.totalItemWidth > f
                        ? this.maxItemWidth
                        : b.itemWidth;
                    d && this.itemX - c + a > f && (
                        this.itemX = c,
                        this.lastLineHeight && (this.itemY += g + this.lastLineHeight + h),
                    ...
                    d
                        ? this.itemX += a
                        : (this.itemY += g + e + h, this.lastLineHeight = e);
                        ...
                        .forEach(function (a) {
                            ...
                            a && z(
                                ...
                                g(c.linkedTo)
                                    ...
                                    : void 0,
                                !0
                            ) && (b = b.concat(a.legendItems || (
                                "point" === c.legendType
                                    ? a.data
                                    : a
                            )))
                        });
                    F(this, "afterGetAllItems", {allItems: b});
                    return b
                };
                ...
                a.prototype.adjustMargins = function (b, a) {
                    var c = this.chart,
                        d = this.options,
                        e = this.getAlignment();
                    e && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(
                        function (h, f) {
                            h.test(e) && !g(b[f]) && (c[n[f]] = Math.max(c[n[f]], c.legend[
                                (f + 1) % 2
                                    ? "legendHeight"
                                    : "legendWidth"
                            ] + [1, -1, -1, 1][f] * d[
                                f % 2
                                    ? "x"
                                    : "y"
                            ] + z(d.margin, 12) + a[f] + (c.titleOffset[f] || 0)))
                        }
                    )
                };
                    ...
                    this
                        ...
                        .forEach(function (d) {
                            ...
                            if (d.yAxis) {
                                ...
                                h = this.itemMarginTop + d
                                    .legendItem
                                    .getBBox()
                                    .height + this.itemMarginBottom;
                ...
                a.prototype.render = function () {
                    ...
                    f || (
                        this.group = f = a.g("legend").addClass(c.className || "").attr({zIndex: 7}).add(),
                        this.contentGroup = a.g().attr({zIndex: 1}).add(f),
                        this.scrollGroup = a.g().add(this.contentGroup)
                    );
                    this.renderTitle();
                    h(g, function (b, a) {
                        return (b.options && b.options.legendIndex || 0) - (
                    ...
                    p += e;
                    l || (
                        this.box = l = a.rect().addClass("highcharts-legend-box").attr({r: c.borderRadius}).add(f)
                    );
                    b.styledMode || l
                        .attr({
                ...
                a.prototype.align = function (b) {
                    ...
                    /(lth|ct|rth)/.test(this.getAlignment()) && 0 < a.titleOffset[0]
                        ? d += a.titleOffset[0]
                        : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < a.titleOffset[2] && (
                            d -= a.titleOffset[2]
                        );
                    d !== b.y && (b = x(b, {y: d}));
                ...
                a.prototype.handleOverflow = function (b) {
                    ...
                    var M = this.nav,
                        F = this.clipRect;
                    "horizontal" !== e.layout || "middle" === e.verticalAlign || e.floating || (
                        h /= 2
                    );
                    l && (h = Math.min(h, l));
                    n.length = 0;
                    b && 0 < h && b > h && !1 !== k.enabled
                        ? (
                            this.clipHeight = G = Math.max(h - 20 - this.titleHeight - f, 0),
                            ...
                            q.forEach(function (b, a) {
                                var c = b._legendItemPos[1],
                                    ...
                                    e = n.length;
                                if (!e || c - n[e - 1] > G && (x || c) !== n[e - 1]) 
                                    n.push(x || c),
                                    e++;
                                b.pageIx = e - 1;
                                x && (q[a - 1].pageIx = e - 1);
                                a === q.length - 1 && c + d - n[e - 1] > G && d <= G && (
                                    n.push(c),
                                    b.pageIx = e
                                );
                                c !== x && (x = c)
                            }),
                            F || (F = a.clipRect = d.clipRect(0, f, 9999, 0), a.contentGroup.clip(F)),
                            t(G),
                            M || (
                                this.nav = M = d.g().attr({zIndex: 1}).add(this.group),
                                this.up = d.symbol("triangle", 0, 0, p, p).add(M),
                                y("upTracker").on("click", function () {
                                    a.scroll(-1, m)
                                }),
                                this.pager = d.text("", 15, 10).addClass("highcharts-legend-navigation"),
                                !c.styledMode && k.style && this.pager.css(k.style),
                                this.pager.add(M),
                                this.down = d.symbol("triangle-down", 0, 0, p, p).add(M),
                ...
                a.prototype.scroll = function (a, c) {
                    ...
                    0 < p && (
                        ...
                        this.scrollOffset = -h[p - 1] + this.initialItemY,
                        this.scrollGroup.animate({translateY: this.scrollOffset}),
                        this.currentPage = p,
                        this.positionCheckboxes(),
                        a = C(z(c, e.renderer.globalAnimation, !0)),
                        b(function () {
                            F(d, "afterScroll", {currentPage: p})
                        }, a.duration)
                    )
                };
            ...
            (/Trident\/7\.0/.test(B.navigator && B.navigator.userAgent) || a) && w(
                E.prototype,
                "positionItem",
                function (b, a) {
                    var c = this,
        ...
        K(
            ...
            [
                f["Core/Globals.js"], f["Core/DefaultOptions.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]
            ],
            function (a, f, B, H) {
        ...
        K(f, "Core/Chart/Chart.js", [
            ...
            f["Core/Utilities.js"],
            f["Core/Renderer/HTML/AST.js"]
        ], function (a, f, B, H, w, E, I, A, u, n, k, e, c, p, g) {
            var t = a.animate,
                q = a.animObject,
                F = a.setAnimation,
                y = B.numberFormat,
            ...
            a = function () {
                ...
                a.prototype.initSeries = function (b) {
                    ...
                    var c = v[a];
                    c || L(17, !0, this, {missingModuleFor: a});
                    a = new c;
                ...
                a.prototype.isInsidePlot = function (b, a, c) {
                    ...
                    if (!c.ignoreX) {
                        ...
                        f = c.paneCoordinates
                            ? p.pos + f
                            : h + f;
                        f >= Math.max(l + h, p.pos) && f <= Math.min(l + h + e.width, p.pos + p.len) || (
                            b.isInsidePlot = !1
                        )
                    }
                    !c.ignoreY && b.isInsidePlot && (
                        d = m && (
                            d
                                ? m.xAxis
                                : m.yAxis
                        ...
                        c = c.paneCoordinates
                            ? d.pos + a
                            : g + a,
                        c >= Math.max(k + g, d.pos) && c <= Math.min(k + g + e.height, d.pos + d.len) || (
                            b.isInsidePlot = !1
                        )
                    );
                ...
                c.forEach(function (b) {
                        b.isDirty && (
                            "point" === b.options.legendType
                                ? ("function" === typeof b.updateTotals && b.updateTotals(), m = !0)
                ...
                a.prototype.applyDescription = function (b, a) {
                    ...
                    d && !e && (
                        e = this.renderer.text(d.text, 0, 0, d.useHTML).attr({
                            align: d.align,
                            "class": "highcharts-" + b,
                            zIndex: d.zIndex || 4
                        }).add(),
                    ...
                    ["title", "subtitle", "caption"].forEach(function (b) {
                        ...
                        if (e) {
                            ...
                            h.floating || (
                                "top" === g
                                    ? a[0] = Math.ceil(a[0] + l)
                                    : "bottom" === g && (a[2] = Math.ceil(a[2] + l))
                            )
                        }
                    }, this);
                    a[0] && "top" === (this.options.title.verticalAlign || "top") && (
                        a[0] += this.options.title.margin
                    );
                    a[2] && "bottom" === this.options.caption.verticalAlign && (
                        a[2] += this.options.caption.margin
                    );
                    var e = !this.titleOffset || this
                        .titleOffset
                        .join(",") !== a.join(",");
                    this.titleOffset = a;
                ...
                a.prototype.getChartSize = function () {
                    ...
                    this.chartHeight = Math.max(0, aa(b, this.chartWidth) || (
                ...
                a.prototype.temporaryDisplay = function (b) {
                    ...
                    if (b) 
                        for (; a && a.style;) 
                            a.hcOrigStyle && (N(a, a.hcOrigStyle), delete a.hcOrigStyle),
                            a.hcOrigDetached && (m.body.removeChild(a), a.hcOrigDetached = !1),
                            a = a.parentNode;
                else 
                        for (; a && a.style;) {
                            m
                                .body
                                .contains(a) || a.parentNode || (a.hcOrigDetached = !0, m.body.appendChild(a));
                ...
                a.prototype.getMargins = function (b) {
                    ...
                    this.legend && this.legend.display && this
                        .legend
                        .adjustMargins(c, a);
                    Q(this, "getMargins");
                ...
                a.prototype.setReflow = function (b) {
                    ...
                    !1 === b || this.unbindReflow
                        ...
                        : (
                            this.unbindReflow = r(l, "resize", function (b) {
                ...
                a.prototype.drawChartBox = function () {
                    var b = this.options.chart,
                        ...
                        x = "animate";
                    t || (
                        this.chartBackground = t = a.rect().addClass("highcharts-background").add(),
                        x = "attr"
                    );
                    if (e) 
                        var v = z = t.strokeWidth();
                    else {
                        v = b.borderWidth || 0;
                        z = v + (
                            b.shadow
                    ...
                    M || (
                        x = "attr",
                        this.plotBackground = M = a.rect().addClass("highcharts-plot-background").add()
                    );
                    M[x](n);
                    e || (M.attr({
                        fill: f || "none"
                    }).shadow(b.plotShadow), l && (
                        h
                            ? (l !== h.attr("href") && h.attr("href", l), h.animate(n))
                            : this.plotBGImage = a.image(l, k, m, p, G).add()
                    ));
                    q
                        ? q.animate({width: r.width, height: r.height})
                        : this.clipRect = a.clipRect(r);
                    x = "animate";
                    y || (
                        x = "attr",
                        this.plotBorder = y = a.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add()
                    );
                    e || y.attr({
                ...
                a.prototype.propFromSeries = function () {
                    ...
                    ["inverted", "angular", "polar"].forEach(function (g) {
                        ...
                        for (d = c && c.length; !h && d--;) 
                            (e = v[c[d].type]) && e.prototype[g] && (h = !0);
                        b[g] = h
                    })
                };
                ...
                a.prototype.addCredits = function (b) {
                    ...
                    c.enabled && !this.credits && (
                        this.credits = this.renderer.text(c.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function () {
                ...
                a.prototype.destroy = function () {
                    ...
                    b
                        .renderTo
                        .removeAttribute("data-highcharts-chart");
                    ja(b);
                    for (h = a.length; h--;) 
                        a[h] = a[h].destroy();
                    this.scroller && this.scroller.destroy && this
                        .scroller
                        .destroy();
                    for (h = c.length; h--;) 
                        c[h] = c[h].destroy();
                    ...
                    (
                        "title subtitle chartBackground plotBackground plotBGImage plotBorder seriesGro" +
                        "up clipRect credits pointer rangeSelector legend resetZoomButton tooltip rende" +
                        "rer"
                    )
                        .split(" ")
                        .forEach(function (a) {
                ...
                a.prototype.warnIfA11yModuleNotLoaded = function () {
                    ...
                    setTimeout(function () {
                        var a = b && b.options;
                        !a || b.accessibility || a.accessibility && !1 === a.accessibility.enabled || L(
                            'Highcharts warning: Consider including the "accessibility.js" module to make y' +
                                    'our chart more usable for people with disabilities. Set the "accessibility.ena' +
                                    'bled" option to false to remove this warning. See https://www.highcharts.com/d' +
                                    'ocs/accessibility/accessibility-module.',
                            !1,
                            b
                        )
                    }, 100)
                ...
                a.prototype.update = function (b, a, d, e) {
                    ...
                    if (p) {
                        ...
                        !h.styledMode && p.style && h
                            .renderer
                            .setStyle(h.options.chart.style || {})
                    }
                    !h.styledMode && b.colors && (this.options.colors = b.colors);
                    b.time && (
                        this.time === D && (this.time = new c(b.time)),
                        W(!0, h.options.time, b.time)
                    );
                    Z(b, function (a, c) {
                        if (h[c] && "function" === typeof h[c].update) 
                            h[c].update(a, !1);
                        else if ("function" === typeof h[g[c]]) 
                            h[g[c]](a);
                        else 
                            "colors" !== c && -1 === h
                                .collectionsWithUpdate
                                .indexOf(c) && W(!0, h.options[c], b[c]);
                                ...
                                ia(b[a]).forEach(function (b, e) {
                                    ...
                                    !f && h[a] && (f = h[a][
                                        c
                                            ? c[e]
                                            : e
                                    ]) && g && Y(f.options.id) && (f = void 0);
                                    f && f.coll === a && (f.update(b, !1), d && (f.touched = !0));
                                    !f && d && h.collectionsWithInit[a] && (h.collectionsWithInit[a][0].apply(
                                        h,
                                        [b].concat(h.collectionsWithInit[a][1] || []).concat([!1])
                                    ).touched = !0)
                                });
                    ...
                    p = p && (
                        V(p.height)
                            ? aa(p.height, G || h.chartWidth)
                            : p.height
                    );
                    m || T(G) && G !== h.chartWidth || T(p) && p !== h.chartHeight
                        ? h.setSize(G, p, e)
                        : R(a, !0) && h.redraw(e);
                    Q(h, "afterUpdate", {
                        options: b,
                ...
                a.prototype.showResetZoom = function () {
                    ...
                    var a = this,
                        ...
                        h = e.theme,
                        g = "chart" === e.relativeTo || "spacingBox" === e.relativeTo
                            ? null
                            : "scrollablePlotBox";
                    Q(this, "beforeShowResetZoom", null, function () {
                        a.resetZoomButton = a
                            .renderer
                            .button(c.resetZoom, null, null, b, h)
                            .attr({align: e.position.align, title: c.resetZoomTitle})
                            .addClass("highcharts-reset-zoom")
                            .add()
                            .align(e.position, !1, g)
                    });
                            ...
                            .forEach(function (b) {
                                ...
                                c[
                                    k
                                        ? "zoomX"
                                        : "zoomY"
                                ] && m && (h = g.zoom(b.min, b.max), g.displayBtn && (e = !0))
                            });
                    var g = a.resetZoomButton;
                    e && !g
                        ? a.showResetZoom()
                        : !e && M(g) && (a.resetZoomButton = g.destroy());
                    h && a.redraw(
                        ...
                        a.forEach(function (a) {
                            if (a.options.panningEnabled && !a.options.isInternal) {
                                ...
                                var k = c[d],
                                    ...
                                    p = a.reversed && !c.inverted || !a.reversed && c.inverted
                                        ? -1
                                        : 1,
                                    G = a.getExtremes(),
                                    n = a.toValue(k - l, !0) + m * p,
                                    q = a.toValue(k + a.len - l, !0) - (
                                        m * p || a.isXAxis && a.pointRangePadding || 0
                                    ),
                                    r = q < n;
                                ...
                                !p || a.isXAxis || t && !t.isDirty || a
                                    ...
                                    .forEach(function (b) {
                                        ...
                                        T(a.dataMin) && T(a.dataMax) && (
                                            t.startMin = Math.min(R(b.options.threshold, Infinity), a.dataMin, t.startMin),
                                            t.startMax = Math.max(R(b.options.threshold, -Infinity), a.dataMax, t.startMax)
                                        )
                                    });
                                p = Math.min(
                                    R(t && t.startMin, G.dataMin),
                                    m
                                        ? G.min
                                        : a.toValue(a.toPixels(G.min) - a.minPixelPadding)
                                );
                                q = Math.max(
                                    R(t && t.startMax, G.dataMax),
                                    m
                                        ? G.max
                                        : a.toValue(a.toPixels(G.max) + a.minPixelPadding)
                                );
                                a.panningState = t;
                                a.isOrdinal || (
                                    m = p - k,
                                    ...
                                    m = n - q,
                                    0 < m && (n = q, k -= m),
                                    a.series.length && k !== G.min && n !== G.max && k >= p && n <= q && (
                                        a.setExtremes(k, n, !1, !1, {trigger: "pan"}),
                                        c.resetZoomButton || h || k === p || n === q || !g.match("y") || (c.showResetZoom(), a.displayBtn = !1),
                                        f = !0
                                    ),
                                    e[d] = l
                                )
            ...
            K(a.prototype, {
                ...
                propsRequireDirtyBox: (
                    "backgroundColor borderColor borderWidth borderRadius plotBackgroundColor plotB" +
                    "ackgroundImage plotBorderColor plotBorderWidth plotShadow shadow"
                ).split(" "),
                propsRequireReflow: (
                    "margin marginTop marginRight marginBottom marginLeft spacing spacingTop spacin" +
                    "gRight spacingBottom spacingLeft"
                ).split(" "),
                propsRequireUpdateSeries: (
                    "chart.inverted chart.polar chart.ignoreHiddenSeries chart.type colors plotOpti" +
                    "ons time tooltip"
                ).split(" ")
            });
            "";
            ...
            (function (a) {
                a.drawLineMarker = function (a) {
                    ...
                    this.legendLine = k
                        ...
                        .add(e);
                    p && !1 !== p.enabled && A && (
                        w = Math.min(B(p.radius, n), n),
                        0 === this.symbol.indexOf("url") && (p = f(p, {
                            width: u,
                            height: u
                        }), w = 0),
                        this.legendSymbol = A = k.symbol(this.symbol, A / 2 - w, a - w, 2 * w, 2 * w, p).addClass("highcharts-point").add(e),
                        A.isMarker = !0
                    )
                };
        ...
        K(f, "Core/Series/Series.js", [
            ...
            f["Core/Utilities.js"]
                ...
                a = function () {
                    ...
                    a.prototype.init = function (b, a) {
                        ...
                        p(this, a);
                        var e = a.events;
                        if (e && e.click || a.point && a.point.events && a.point.events.click || a.allowPointSelect) 
                            b.runTrackerClick = !0;
                        c.getColor();
                        c.getSymbol();
                        c
                        ...
                        C(this, "bindAxes", null, function () {
                            (b.axisTypes || []).forEach(function (e) {
                                ...
                                c[e].forEach(function (c) {
                                    d = c.options;
                                    if (a[e] === h && !d.isInternal || "undefined" !== typeof a[e] && a[e] === d.id || "undefined" === typeof a[e] && 0 === d.index) 
                                        b.insert(c.series),
                                        b[e] = c,
                                        c.isDirty = !0;
                                    d.isInternal || h++
                        ...
                        var c = b.series,
                            ...
                            e = N(a)
                                ...
                                : function (b) {
                                    Array
                                        .prototype[a]
                                        .apply(c[b + "Data"], Array.prototype.slice.call(d, 2))
                                };
                        c
                            .parallelArrays
                            .forEach(e)
                    ...
                    a.prototype.autoIncrement = function (b) {
                        ...
                        c && (
                            a = new e.Date(h),
                            "day" === c
                                ? e.set("Date", a, e.get("Date", a) + g)
                                : "month" === c
                                    ? e.set("Month", a, e.get("Month", a) + g)
                                    : "year" === c && e.set("FullYear", a, e.get("FullYear", a) + g),
                            g = a.getTime() - h
                        );
                        if (d && N(b)) 
                            return h + g;
                    ...
                    a.prototype.setOptions = function (b) {
                        ...
                        this.tooltipOptions = X(
                            c.tooltip,
                            c.plotOptions.series && c.plotOptions.series.tooltip,
                            c.plotOptions[this.type].tooltip,
                        ...
                        C(this, "afterSetOptions", {options: h});
                        return h
                    };
                    a.prototype.getName = function () {
                        return L(this.options.name, "Series " + (
                            this.index + 1
                        ))
                    };
                    a.prototype.getCyclic = function (b, a, c) {
                        var d = this.chart,
                            ...
                            f = c
                                ? c.length
                                : L(d.options.chart[b + "Count"], d[b + "Count"]);
                        if (!a) {
                            var k = L(e[h], e["_" + h]);
                    ...
                    if (g) {
                        ...
                        -1 !== l && "undefined" !== typeof l && this.cropped && (
                            l = l >= this.cropStart
                                ? l - this.cropStart
                                : l
                        );
                    ...
                    a.prototype.updateData = function (b, a) {
                            ...
                            if (m.id || N(n)) {
                                if (
                                    ...
                                    -1 === m || "undefined" === typeof m
                                        ? h.push(b)
                                        : e[m] && b !== c.data[m]
                                            ? (e[m].update(b, !1, null, !1), e[m].touched = !0, g && (p = m + 1))
                                            : e[m] && (e[m].touched = !0),
                                    !f || a !== m || d && d.enabled || this.hasDerivedData
                                ) 
                                    k = !0
                            } else 
                                h.push(b)
                        ...
                        null === this.xIncrement && this.xData && this.xData.length && (
                    ...
                    a.prototype.setData = function (b, a, c, d) {
                        ...
                        l.options.chart.allowMutatingData && !1 !== d && v && g && !e.cropped && !e.hasGroupedData && e.visible && !e.isSeriesBoosting && (
                            t = this.updateData(b, c)
                        );
                        if (!t) {
                            e.xIncrement = null;
                            e.colorCounter = 0;
                            ...
                            if (p && v > p) 
                                if (x = e.getFirstValidPoint(b), N(x)) 
                                    for (c = 0; c < v; c++) 
                                        n[c] = this.autoIncrement(),
                                        q[c] = b[c];
                            else if (S(x)) 
                                    if (r) 
                                        if (x.length === r) 
                                ...
                                for (c = 0; c < v; c++) 
                                    "undefined" !== typeof b[c] && (
                                        ...
                                        e.pointClass.prototype.applyOptions.apply(d, [b[c]]),
                    ...
                    a.prototype.getProcessedData = function (b) {
                        ...
                        if (h && this.sorted && !e && (!d || p > d || this.forceCrop)) 
                            if (f[p - 1] < n || f[0] > q) 
                                f = [],
                                l = [];
                            else if (this.yData && (f[0] < n || f[p - 1] > q)) {
                        ...
                        for (d = f.length || 1; --d;) 
                            if (
                                a = c
                                    ? b(f[d]) - b(f[d - 1])
                                    : f[d] - f[d - 1],
                                0 < a && ("undefined" === typeof G || a < G)
                            ) 
                                var G = a;
                            else 
                                0 > a && k && !m && (D(15, !1, this.chart), k = !1);
                    return {xData: f, yData: l, cropped: r, cropStart: g, closestPointRange: G}
                    };
                    a.prototype.processData = function (b) {
                        var a = this.xAxis;
                        if (this.isCartesian && !this.isDirty && !a.isDirty && !this.yAxis.isDirty && !b) 
                            return !1;
                    ...
                    a.prototype.generatePoints = function () {
                        var b = this.options,
                            ...
                            l = b.keys,
                            k = [];
                        b = b.dataGrouping && b.dataGrouping.groupAll
                            ? g
                            : 0;
                        var m,
                            p,
                        ...
                        for (p = 0; p < h; p++) {
                            ...
                            if (f) {
                                ...
                                r.dataGroup.options && (
                                    ...
                                    v(r, r.dataGroup.options),
                                    delete r.dataLabels
                                )
                            } else 
                                (r = n[q]) || "undefined" === typeof a[q] || (
                                    n[q] = r = (new e).init(this, a[q], c[p])
                                );
                                r && (
                                    r.index = f
                                        ? b + p
                            ...
                            if (n && (h !== (m = n.length) || f)) 
                                for (p = 0; p < m; p++) 
                                    p !== g || f || (p += h),
                                    n[p] && (n[p].destroyElements(), n[p].plotX = void 0);
                        this.data = n;
                            this.points = k;
                            C(this, "afterGeneratePoints")
                        };
                        a.prototype.getXExtremes = function (b) {
                            return {min: z(b), max: x(b)}
                        };
                        a.prototype.getExtremes = function (b, a) {
                            ...
                            for (f = 0; f < p; f++) {
                                ...
                                q = a || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !c || (
                                    e[f + g] || q
                                ) >= l && (e[f - g] || q) <= k;
                                if (r && q) 
                                    if (r = n.length) 
                            ...
                            C(this, "afterGetExtremes", {dataExtremes: b});
                            return b
                        };
                        ...
                        a.prototype.translate = function () {
                            ...
                            for (y = 0; y < k; y++) {
                                ...
                                if (g.positiveValuesOnly && !g.validatePositiveValue(w) || d.positiveValuesOnly && !d.validatePositiveValue(F)) 
                                    v.isNull = !0;
                                v.plotX = z = b(
                                    m(d.translate(F, 0, 0, 0, 1, p, "flags" === this.type), -1E5, 1E5)
                                );
                                ...
                                S(D) && (
                                    A = D[0],
                                    w = D[1],
                                    A === r && H.key === B[F].base && (A = L(N(q) && q, g.min)),
                                    g.positiveValuesOnly && 0 >= A && (A = null),
                                    v.total = v.stackTotal = u.total,
                                    v.percentage = u.total && v.y / u.total * 100,
                                    v.stackY = w,
                                    this.irregularWidths || u.setOffset(this.pointXOffset || 0, this.barW || 0)
                                );
                                v.yBottom = l(A)
                                    ? m(g.translate(A, 0, 1, 0, 1), -1E5, 1E5)
                                    : null;
                                this.dataModify && (w = this.dataModify.modifyValue(w, y));
                                v.plotY = void 0;
                                N(w) && (
                                    u = g.translate(w, !1, !0, !1, !0),
                                    "undefined" !== typeof u && (v.plotY = m(u, -1E5, 1E5))
                                );
                                v.isInside = this.isPointInside(v);
                                v.clientX = n
                                    ? b(d.translate(F, 0, 0, 0, 1, p))
                                    : z;
                        ...
                        a.prototype.getValidPoints = function (b, a, c) {
                            ...
                            return (b || this.points || []).filter(function (b) {
                                return a && !d.isInsidePlot(b.plotX, b.plotY, {inverted: d.inverted})
                                    ? !1
                        ...
                        a.prototype.getSharedClipKey = function () {
                            return this.sharedClipKey = (this.options.xAxis || 0) + "," + (
                        ...
                        a.prototype.animate = function (b) {
                            ...
                            if (b && c) 
                                ...
                                c.clip(f),
                                d && d.clip(l);
                            else if (f && !f.hasClass("highcharts-animating")) {
                                a = this.getClipBox();
                                var m = h.step;
                        ...
                        a.prototype.afterAnimate = function () {
                            ...
                            J(this.chart.sharedClips, function (a, c, d) {
                                a && !b
                                    .chart
                                    .container
                                    .querySelector('[clip-path="url(#' + a.id + ')"]') && (
                                        a.destroy(),
                                        delete d[c]
                                    )
                            });
                                ...
                                for (g = 0; g < b.length; g++) {
                                    ...
                                    if ((h && "undefined" === typeof m.enabled || m.enabled) && !l.isNull && !1 !== l.visible) {
                                        ...
                                        f
                                            ...
                                            : r && (0 < (q.width || 0) || l.hasImage) && (
                                                l.graphic = f = a.renderer.symbol(
                                                    n,
                                                    q.x,
                                                    q.y,
                                                    q.width,
                                                ...
                                                this.enabledDataSorting && a.hasRendered && (f.attr({x: l.startXPos}), k = "animate")
                                            );
                                        f && "animate" === k && f[
                                            r
                                                ? "show"
                                        ...
                                        if (f && !a.styledMode) 
                                            f[k](this.pointAttribs(l, l.selected && "select"));
                        ...
                        a.prototype.markerAttribs = function (b, a) {
                            ...
                            a && (
                                ...
                                g = L(a && a.radius, d && d.radius, g && g + (d && d.radiusPlus || 0))
                            );
                        ...
                        a.prototype.pointAttribs = function (b, a) {
                            ...
                            return {stroke: g, "stroke-width": b, fill: h, opacity: d}
                        };
                        a.prototype.destroy = function (b) {
                            var a = this,
                                c = a.chart,
                                ...
                                l,
                                k;
                            C(a, "destroy", {keepEventsForUpdate: b});
                            this.removeEvents(b);
                        ...
                        a.prototype.applyZones = function () {
                            ...
                            if (d.length && (h || g) && l && "undefined" !== typeof l.min) {
                                ...
                                b.visible && (h && h.show(), g && g.show())
                        };
                        a.prototype.invertGroups = function (b) {
                            function a() {
                                ["group", "markerGroup"].forEach(function (a) {
                                    c[a] && (
                                        d.renderer.isVML && c[a].attr({width: c.yAxis.len, height: c.xAxis.len}),
                                        c[a].width = c.yAxis.len,
                                        c[a].height = c.xAxis.len,
                                        c[a].invert(
                                            c.isRadialSeries
                                                ? !1
                                                : b
                        ...
                        a.prototype.plotGroup = function (b, a, c, d, e) {
                            ...
                            "undefined" === typeof this.opacity || this.chart.styledMode || "inactive" === this.state || (
                                c.opacity = this.opacity
                            );
                            g && (this[b] = h = this.chart.renderer.g().add(e));
                            h.addClass(
                                "highcharts-" + a + " highcharts-series-" + this.index + " highcharts-" +
                                        this.type + "-series " + (
                                    l(this.colorIndex)
                                        ? "highcharts-color-" + this.colorIndex + " "
                                        : ""
                        ...
                        a.prototype.render = function () {
                            var b = this,
                                ...
                                f = a.seriesGroup,
                                l = a.inverted;
                            a = !b.finishedAnimating && a.renderer.isSVG
                                ? d.duration
                                : 0;
                            C(this, "render");
                            ...
                            m.inverted = L(b.invertible, b.isCartesian)
                                ? l
                                : !1;
                        ...
                        a.prototype.redraw = function () {
                            var b = this.chart,
                                ...
                                e = this.yAxis;
                            c && (
                                b.inverted && c.attr({width: b.plotWidth, height: b.plotHeight}),
                                c.animate({
                        ...
                        a.prototype.isPointInside = function (b) {
                            var a = this.chart,
                                c = this.xAxis,
                                d = this.yAxis;
                            return "undefined" !== typeof b.plotY && "undefined" !== typeof b.plotX && 0 <= b.plotY && b.plotY <= (
                                d
                                    ? d.len
                                    : a.plotHeight
                            ) && 0 <= b.plotX && b.plotX <= (
                        ...
                        a.prototype.drawTracker = function () {
                            ...
                            k
                                ...
                                : b.graph && (b.tracker = f.path(d).attr({
                                    ...
                                    if (b && (
                                        b.addClass("highcharts-tracker").on("mouseover", m).on("mouseout", function (b) {
                        ...
                        a.prototype.addPoint = function (b, a, c, d, e) {
                            ...
                            var q = n.x;
                            var r = m.length;
                            if (this.requireSorting && q < m[r - 1]) 
                                for (p = !0; r && m[r - 1] > q;) 
                                    r--;
                        this.updateParallelArrays(n, "splice", r, 0, 0);
                            ...
                            c && (
                                g[0] && g[0].remove
                                    ? g[0].remove(!1)
                                    : (g.shift(), this.updateParallelArrays(n, "shift"), k.shift())
                            );
                            !1 !== e && C(this, "addPoint", {point: n});
                        ...
                        a.prototype.removePoint = function (b, a, c) {
                            ...
                            a = L(a, !0);
                            g
                                ? g.firePointEvent("remove", null, k)
                                : k()
                        };
                        ...
                        a.prototype.update = function (b, a) {
                            ...
                            r && (
                                ...
                                !1 !== b.visible && n.push("area", "graph"),
                                c.parallelArrays.forEach(function (b) {
                                    n.push(b + "Data")
                                }),
                                b.data && (
                                    b.dataSorting && v(c.options.dataSorting, b.dataSorting),
                                    this.setData(b.data, !1)
                                )
                            );
                            b = X(e, k, {
                                index: "undefined" === typeof e.index
                                    ? c.index
                                    : e.index,
                            ...
                            f = !1;
                            if (F[q]) {
                                if (f = q !== c.type, c.remove(!1, !1, !1, !0), f) 
                                    if (Object.setPrototypeOf) 
                                        Object.setPrototypeOf(c, F[q].prototype);
                                    else {
                                        k = Object
                                            .hasOwnProperty
                                            .call(c, "hcEvents") && c.hcEvents;
                                        for (p in l) 
                                            c[p] = void 0;
                                        v(c, F[q].prototype);
                                        k
                            ...
                            if (r && this.points) {
                                ...
                                !1 === t.visible
                                    ...
                                    : c._hasPointLabels || (
                                        b = t.marker,
                                        l = t.dataLabels,
                                        !b || !1 !== b.enabled && (e.marker && e.marker.symbol) === b.symbol || (m.graphic = 1),
                                        l && !1 === l.enabled && (m.dataLabel = 1)
                                    );
                                this
                                    .points
                                    .forEach(function (b) {
                                        b && b.series && (
                                            ...
                                            !1 === t.showInLegend && b.legendItem && d.legend.destroyItem(b)
                                        )
                                    }, this)
                            }
                            c.initialType = g;
                        ...
                        a.prototype.setState = function (b, a) {
                            ...
                            if (c.state !== b && (
                                ...
                                if (g[b] && !1 === g[b].enabled) 
                                    return;
                                b && (
                                    l = g[b].lineWidth || l + (g[b].lineWidthPlus || 0),
                                    m = L(g[b].opacity, m)
                                );
                                if (e && !e.dashstyle) 
                                    for (d = {
                                        "stroke-width": l
                                    }, e.animate(d, f); c["zone-graph-" + k];) 
                                        c["zone-graph-" + k].animate(d, f),
                                        k += 1;
                            h || [c.group, c.markerGroup, c.dataLabelsGroup, c.labelBySeries].forEach(
                                    function (b) {
                                        b && b.animate({
                                            opacity: m
                                        }, f)
                        ...
                        a.prototype.setVisible = function (b, a) {
                            var c = this,
                                ...
                                g = c.visible,
                                f = (
                                    c.visible = b = c.options.visible = c.userOptions.visible = "undefined" === typeof b
                                        ? !g
                                        : b
                                )
                                    ? "show"
                        ...
                        a.prototype.select = function (b) {
                            this.selected = b = this.options.selected = "undefined" === typeof b
                                ? !this.selected
                                : b;
            ...
            K(f, "Extensions/ScrollablePlotArea.js", [
                f["Core/Animation/AnimationUtilities.js"],
                f["Core/Axis/Axis.js"],
                ...
                A(B, "afterSetChartSize", function (a) {
                    ...
                    if (!this.renderer.forExport) {
                        if (e) {
                            ...
                            c && (this.scrollablePixelsY = e = Math.max(0, c - this.chartHeight)) && (
                                this.scrollablePlotBox = this.renderer.scrollablePlotBox = n(this.plotBox),
                ...
                B.prototype.moveFixedElements = function () {
                    var a = this.container,
                        ...
                        f = (
                            ".highcharts-contextbutton .highcharts-credits .highcharts-legend .highcharts-l" +
                            "egend-checkbox .highcharts-navigator-series .highcharts-navigator-xaxis .highc" +
                            "harts-navigator-yaxis .highcharts-navigator .highcharts-reset-zoom .highcharts" +
                            "-drillup-button .highcharts-scrollbar .highcharts-subtitle .highcharts-title"
                        ).split(" "),
                        g;
                    ...
                    f.forEach(function (e) {
                        []
                            .forEach
                            .call(a.querySelectorAll(e), function (a) {
                                (
                ...
                B.prototype.applyFixed = function () {
                    ...
                    a
                        ? (
                            ...
                            this.fixedRenderer = c = new g(this.fixedDiv, this.chartWidth, this.chartHeight, this.options.chart.style),
                    ...
                    this
                        .chartBackground
                        .attr({width: c, height: g});
                    this.scrollingContainer.style.height = this.chartHeight + "px";
                    a && (
                        f.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * f.scrollPositionX),
                    ...
                    "adjustHeight" !== this.redrawTrigger && this
                        .scrollableMask
                        .attr({d: a})
                };
            ...
            K(
                ...
                [
                    f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B) {
                        ...
                        var g = function () {
                            ...
                            a.prototype.resetStacks = function () {
                                ...
                                a.axis.isXAxis || u(c, function (c) {
                                    u(c, function (e, g) {
                                        A(e.touched) && e.touched < a.stacksTouched
                                            ? (e.destroy(), delete c[g])
                            ...
                            a.prototype.renderStackTotals = function () {
                                ...
                                var f = this.stackTotalGroup = this.stackTotalGroup || e
                                    .g("stack-labels")
            ...
            K(f, "Extensions/Stacking.js", [
                    ...
                    t = function () {
                        ...
                        a.prototype.render = function (a) {
                            ...
                            this.label
                                ? this
                                    .label
                                    .attr({text: f, visibility: "hidden"})
                                : (
                                    this.label = c.renderer.label(f, null, null, e.shape, null, null, e.useHTML, !1, "stack-labels"),
                                    f = {
                                        r: e.borderRadius || 0,
                                        text: f,
                                        rotation: e.rotation,
                        ...
                        a.prototype.setOffset = function (a, e, f, k, m) {
                            ...
                            e && h && (
                                ...
                                h.x -= l,
                                h.y -= f,
                                e.align(this.alignOptions, null, h),
                                b.isInsidePlot(
                                    e.alignAttr.x + l - this.alignOptions.x,
                                    e.alignAttr.y + f - this.alignOptions.y
                                )
                                    ? e.show()
                                    : (e.hide(), a = !1),
                                a && w.prototype.justifyDataLabel.call(
                                    this.axis,
                                    e,
                                    this.alignOptions,
                                    e.alignAttr,
                                ...
                                g(!a && this.options.crop, !0) && (
                                    (b = c(e.x) && c(e.y) && b.isInsidePlot(e.x - k + e.width, e.y) && b.isInsidePlot(
                                        e.x + k,
                                        e.y
                                    )) || e.hide()
                                )
                ...
                f.prototype.getStacks = function () {
                    ...
                    a
                        .yAxis
                        .forEach(function (a) {
                            a.stacking && a.stacking.stacks && a.hasVisibleSeries && (
                ...
                w.prototype.setStackedPoints = function (a) {
                    ...
                    if (c && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                        ...
                        for (C = 0; C < m; C++) {
                            ...
                            r[E][B] || (
                                w[E] && w[E][B]
                                    ? (r[E][B] = w[E][B], r[E][B].total = null)
                                    : r[E][B] = new t(v, v.options.stackLabels, A, B, h)
                            );
                            E = r[E][B];
                            null !== H
                                ? (
                                    E.points[J] = E.points[this.index] = [g(E.cumulative, l)],
                                    n(E.cumulative) || (E.base = J),
                                    E.touched = v.stacking.stacksTouched,
                                    0 < I.index && !1 === this.singleStacks && (E.points[J][0] = E.points[this.index + "," + B + ",0"][0])
                                )
                                : E.points[J] = E.points[this.index] = null;
                            "percent" === c
                                ? (
                                    A = A
                                        ? a
                                    ...
                                    q && r[A] && r[A][B]
                                        ? (
                                            A = r[A][B],
                                            E.total = A.total = Math.max(A.total, E.total) + Math.abs(H) || 0
                                        )
                                        : E.total = u(E.total + (Math.abs(H) || 0))
                                )
                                : "group" === c
                                    ? (e(H) && (H = H[0]), null !== H && (E.total = (E.total || 0) + 1))
                                    : E.total = u(E.total + (H || 0));
                            E.cumulative = "group" === c
                                ? (E.total || 1) - 1
                                : g(E.cumulative, l) + (H || 0);
                            null !== H && (
                                E.points[J].push(E.cumulative),
                                p[C] = E.cumulative,
                                E.hasValidPoints = !0
                            )
                        }
                ...
                w.prototype.modifyStacks = function () {
                    ...
                    a[k + "Stacker"] && [
                        ...
                        for (var b = g.length, h, d; b--;) 
                            if (
                                h = g[b],
                                f = a.getStackIndicator(f, h, a.index, c),
                                d = (h = e[c] && e[c][h]) && h.points[f.key]
                            ) 
                                a[k + "Stacker"](d, h, b)
                    })
                };
            ...
            K(
                ...
                [
                    f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B) {
                    var C = this && this.__extends || function () {
                            var a = function (f, u) {
                    ...
                    B = function (f) {
                        ...
                        A.prototype.drawGraph = function () {
                            ...
                            c.forEach(function (c, g) {
                                ...
                                n
                                    ? (
                                        n.endX = a.preventGraphAnimation
                                            ? null
                                            : k.xMap,
                                        n.animate({d: k})
                                    )
                                    : k.length && (
                                        a[p] = n = a.chart.renderer.path(k).addClass(c[1]).attr({zIndex: 1}).add(a.group)
                                    );
                                n && !e && (
                                    p = {
                                        stroke: c[2],
                                    ...
                                    c[3]
                                        ? p.dashstyle = c[3]
                                        : "square" !== f.linecap && (
                                            p["stroke-linecap"] = p["stroke-linejoin"] = "round"
                                        ),
                                    n[u](p).shadow(2 > g && f.shadow)
                                );
                        ...
                        A.prototype.getZonesGraphs = function (a) {
                            this
                                ...
                                .forEach(function (f, k) {
                                    k = [
                                        "zone-graph-" + k,
                                        "highcharts-graph highcharts-zone-graph-" + k + " " + (
                                            f.className || ""
                                        )
                                    ];
                                    this.chart.styledMode || k.push(
                                        f.color || this.color,
                    ...
                    H = function (a) {
                        ...
                        e.prototype.drawGraph = function () {
                            ...
                            k.forEach(function (a) {
                                ...
                                k
                                    ? (
                                        k.endX = c.preventGraphAnimation
                                            ? null
                                            : e.xMap,
                                        k.animate({d: e})
                                    )
                                    : (
                                        q.zIndex = 0,
                                        k = c[g] = c.chart.renderer.path(e).addClass(a[1]).add(c.group),
                                        k.isArea = !0
                                    );
                                c.chart.styledMode || (
                                    q.fill = n(a[3], C(a[2]).setOpacity(n(f.fillOpacity, .75)).get())
                                );
                                k[p](q);
                                k.startX = e.xMap;
                                k.shiftUnit = f.step
                        ...
                        e.prototype.getGraphPath = function (a) {
                            ...
                            for (u = 0; u < a.length; u++) {
                                f || (
                                    a[u].leftCliff = a[u].rightCliff = a[u].leftNull = a[u].rightNull = void 0
                                );
                                var d = a[u].isNull;
                                ...
                                if (!d || e) 
                                    e || l(u, u - 1, "left"),
                                    d && !f && e || (x.push(a[u]), y.push({x: u, plotX: D, plotY: v})),
                                    e || l(u, u + 1, "right")
                            }
                            u = c.call(this, x, !0, !0);
                            y.reversed = !0;
                        ...
                        e.prototype.getStackPoints = function (a) {
                            ...
                            if (this.options.stacking) {
                                for (var l = 0; l < a.length; l++) 
                                    a[l].leftNull = a[l].rightNull = void 0,
                                    x[a[l].x] = a[l];
                                u(y, function (b, a) {
                        ...
                        e.defaultOptions = A(I.defaultOptions, {threshold: 0});
                        return e
                    }(I);
                    a(H.prototype, {
                        singleStacks: !1,
            ...
            K(f, "Series/Spline/SplineSeries.js", [
                ...
                f = function (a) {
                    ...
                    f.prototype.getPointSpline = function (a, f, k) {
                        ...
                        if (p && !p.isNull && !1 !== p.doCurve && !f.isCliff && k && !k.isNull && !1 !== k.doCurve && !f.isCliff) {
                            ...
                            y += n;
                            u > a && u > c
                                ? (u = Math.max(a, c), y = 2 * c - u)
                                : u < a && u < c && (u = Math.min(a, c), y = 2 * c - u);
                            y > k && y > c
                                ? (y = Math.max(k, c), u = 2 * c - y)
                                : y < k && y < c && (y = Math.min(k, c), u = 2 * c - y);
                            f.rightContX = g;
                            f.rightContY = y
                        }
                        f = [
                            "C",
                            E(p.rightContX, p.plotX, 0),
                            E(p.rightContY, p.plotY, 0),
                            E(q, e, 0),
                            E(u, c, 0),
                            e,
                            c
            ...
            K(
                ...
                [
                    f["Series/Area/AreaSeries.js"], f["Series/Spline/SplineSeries.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B, H, w) {
                    var C = this && this.__extends || function () {
                            var a = function (f, e) {
            ...
            K(f, "Series/Column/ColumnSeries.js", [
                f["Core/Animation/AnimationUtilities.js"],
                f["Core/Color/Color.js"],
                f["Core/Globals.js"],
                f["Core/Legend/LegendSymbol.js"],
                ...
                I = function (a) {
                    ...
                    f.prototype.animate = function (b) {
                        ...
                        if (b) 
                            k.scaleY = .001,
                            b = e(c.toPixels(f.threshold), c.pos, c.pos + c.len),
                            h
                                ? k.translateX = b - c.len
                                : k.translateY = b,
                            a.clipBox && a.setClip(),
                            a
                                .group
                    ...
                    f.prototype.getColumnMetrics = function () {
                        ...
                        var m = Math.min(
                                Math.abs(c.transA) * (c.ordinal && c.ordinal.slope || a.pointRange || c.closestPointRange || c.tickInterval || 1),
                                c.len
                            ),
                            p = m * a.groupPadding,
                            n = (m - 2 * p) / (k || 1);
                        a = Math.min(
                            ...
                            x(a.pointWidth, n * (1 - 2 * a.pointPadding))
                        );
                        b.columnMetrics = {
                            width: a,
                            offset: (n - a) / 2 + (p + ((b.columnIndex || 0) + (
                                f
                                    ? 1
                                    : 0
                            )) * n - m / 2) * (
                    ...
                    f.prototype.crispCol = function (b, a, c, e) {
                        ...
                        e -= a;
                        h && e && (--a, e += 1);
                        return {x: b, y: a, width: c, height: e}
                    };
                    ...
                    f.prototype.translate = function () {
                        ...
                        b
                            ...
                            .forEach(function (d) {
                                ...
                                n && Math.abs(w) < n && (
                                    w = n,
                                    r = !g.reversed && !d.negative || g.reversed && d.negative,
                                    F(k) && F(y) && d.y === k && y <= k && (g.min || 0) < k && (u !== y || (g.max || 0) <= k) && (r = !r),
                                    v = Math.abs(v - m) > n
                                        ? f - n
                                        : m - (
                                            r
                                ...
                                p(d.options.pointWidth) && (
                                    D = B = Math.ceil(d.options.pointWidth),
                                    A -= Math.round((D - t) / 2)
                                );
                                ...
                                d.tooltipPos = a.inverted
                                    ? [
                                        e(
                                            g.len + g.pos - a.plotLeft - l,
                                            g.pos - a.plotLeft,
                                            g.len + g.pos - a.plotLeft
                                        ),
                                        h.len + h.pos - a.plotTop - A - B / 2,
                                        w
                                    ]
                                    : [
                                        h.left - a.plotLeft + A + B / 2,
                                        e(l + g.pos - a.plotTop, g.pos - a.plotTop, g.len + g.pos - a.plotTop),
                                        w
                                    ];
                    ...
                    f.prototype.pointAttribs = function (b, a) {
                        ...
                        a && b && (
                            b = y(c.states[a], b.options.states && b.options.states[a] || {}),
                            a = b.brightness,
                            g = b.color || "undefined" !== typeof a && n(g).brighten(b.brightness).get() || g,
                            l = b[f] || l,
                            k = b[h] || k,
                            e = b.dashStyle || e,
                            m = x(b.opacity, m)
                        ...
                        b
                            ...
                            .forEach(function (d) {
                                ...
                                if (F(d.plotY) && null !== d.y) {
                                    ...
                                    g || (d.graphic = g = e[d.shapeType](h).add(d.group || b.group)) && b.enabledDataSorting && a.hasRendered && a.pointCount < f && (
                                        g.attr({x: d.startXPos}),
                                        l = !0,
                                        k = "animate"
                                    );
                                    if (g && l) 
                                        g[k](y(h));
                                    if (c.borderRadius) 
                                        g[k]({r: c.borderRadius});
                                    a.styledMode || g[k](b.pointAttribs(d, d.selected && "select")).shadow(
                                        !1 !== d.allowShadow && c.shadow,
                                        null,
                    ...
                    f.prototype.drawTracker = function () {
                        ...
                        b._hasTracking || (b.trackerGroups.forEach(function (f) {
                            if (b[f]) {
                                ...
                                !a.styledMode && b.options.cursor && b[f]
                                    .css(c)
                                    .css({cursor: b.options.cursor})
                            }
                        }), b._hasTracking = !0);
                    ...
                    (function (a) {
                        function f(a, b, c, d, f) {
                            var h = this,
                                ...
                                x = this.visible && !1 !== a.visible && (
                                    a.series.forceDL || k && !u || t || e(c.inside, !!this.options.stacking) && d && g.isInsidePlot(
                                        m,
                                        l
                                            ? d.x + 1
                                            : d.y + d.height - 1,
                            ...
                            if (x && E(m) && E(p)) {
                                ...
                                n
                                    ? (u = !1, y = g.renderer.rotCorr(w, n), m = {
                                    ...
                                    : (z(d), b.align(c, void 0, d), m = b.alignAttr);
                                u && 0 <= d.height
                                    ? this.justifyDataLabel(b, c, m, q, d, f)
                                    : e(c.crop, !0) && (
                                        d = m.x,
                                        z = m.y,
                                        d += y[0],
                                        z += y[1],
                                        x = g.isInsidePlot(d, z, {
                                            paneCoordinates: !0,
                                            series: h
                        ...
                        function p() {
                            ...
                            n = x(
                                x(
                                    ...
                                    b.options.plotOptions && b.options.plotOptions[a.type] && b.options.plotOptions[a.type].dataLabels
                                ),
                                n
                            );
                            ...
                            if (u(n) || n.enabled || a._hasPointLabels) {
                                ...
                                !m && (m = a.dataLabelsGroup) && (a.visible && z.show(), m[
                                    f.animation
                                        ? "animate"
                                        : "attr"
                                ]({
                                ...
                                d.forEach(function (d) {
                                    ...
                                    q.forEach(function (c, h) {
                                        ...
                                        if (l) {
                                            ...
                                            t = E(v)
                                                ? w(v, t, b)
                                                : (c[d.formatPrefix + "Formatter"] || c.formatter).call(t, c);
                                            v = c.style;
                                            var u = c.rotation;
                                            b.styledMode || (
                                                v.color = e(c.color, v.color, a.color, "#000000"),
                                                "contrast" === v.color
                                                    ? (
                                                        d.contrastColor = p.getContrast(d.color || a.color),
                                                        v.color = !E(r) && c.inside || 0 > r || f.stacking
                                                            ? d.contrastColor
                                                            : "#000000"
                                                    )
                                                    : delete d.contrastColor,
                                                f.cursor && (v.cursor = f.cursor)
                                            );
                                            var x = {
                                                r: c.borderRadius || 0,
                                                rotation: u,
                                            ...
                                            b.styledMode || (
                                                x.fill = c.backgroundColor,
                                                x.stroke = c.borderColor,
                                                x["stroke-width"] = c.borderWidth
                                            );
                                            k(x, function (b, a) {
                                                "undefined" === typeof b && delete x[a]
                                            })
                                        }
                                        !n || l && E(t) && !!n.div === !!c.useHTML && (
                                            n.rotation && c.rotation || n.rotation === c.rotation
                                        ) || (
                                            q = !0,
                                            ...
                                            d.dataLabels && (
                                                1 === d.dataLabels.length
                                                    ? delete d.dataLabels
                                                    : delete d.dataLabels[h]
                                            ),
                                            h || delete d.dataLabel,
                                            m && (d.connector = d.connector.destroy(), d.connectors && (
                                                1 === d.connectors.length
                                                    ? delete d.connectors
                                                    : delete d.connectors[h]
                                            ))
                                        );
                                        l && E(t)
                                            ? (
                                                n
                                                    ...
                                                    : (
                                                        ...
                                                        n = d.dataLabels[h] = u
                                                            ? p.text(t, 0, 0, c.useHTML).addClass("highcharts-data-label")
                                                            : p.label(t, 0, 0, c.shape, null, null, c.useHTML, null, "data-label"),
                                                        h || (d.dataLabel = n),
                                                        n.addClass(" highcharts-data-label-color-" + d.colorIndex + " " + (
                                                            c.className || ""
                                                        ) + (
                                                            c.useHTML
                                                                ? " highcharts-tracker"
                                                ...
                                                n.options = c,
                                                n.attr(x),
                                                b.styledMode || n.css(v).shadow(c.shadow),
                                                n.added || n.add(z),
                                                c.textPath && !c.useHTML && (
                                                    n.setTextPath(d.getDataLabelPath && d.getDataLabelPath(n) || d.graphic, c.textPath),
                                                    d.dataLabelPath && !c.textPath.enabled && (d.dataLabelPath = d.dataLabelPath.destroy())
                                                ),
                                                a.alignDataLabel(d, n, c, null, q)
                                            )
                                            : n && n.hide()
                                    })
                                })
                        ...
                        function x(a, b) {
                            ...
                            if (u(a) && !u(b)) 
                                ...
                                for (d = Math.max(a.length, b.length); d--;) 
                                    c[d] = n(a[d], b[d]);
                        else 
                                c = n(a, b);
                            return c
                        ...
                        function z(a, b, c, d, e) {
                            ...
                            f.hasRendered && (c && b.attr({x: b.startXPos, y: b.startYPos}), b.placed = !0)
                        }
                        var m = [];
                        a.compose = function (a) {
                            if (-1 === m.indexOf(a)) {
            ...
            K(
                ...
                [
                    f["Core/Series/DataLabel.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B) {
                    var C = f.series,
                        w = B.merge,
                    ...
                    (function (f) {
                        function u(a, e, c, f, g) {
                            ...
                            C
                                ...
                                .alignDataLabel
                                .call(this, a, e, c, f, g);
                            c.inside && a.contrastColor && e.css({color: a.contrastColor})
                        }
                        var n = [];
            ...
            K(
                ...
                [
                    f["Series/Column/ColumnSeries.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B) {
                    var C = this && this.__extends || function () {
                            var a = function (f, u) {
            ...
            K(
                ...
                [
                    f["Series/Column/ColumnSeries.js"], f["Series/Line/LineSeries.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B, H) {
                    var w = this && this.__extends || function () {
                            var a = function (f, k) {
                    ...
                    H = function (a) {
                        ...
                        n.defaultOptions = A(f.defaultOptions, {
                            ...
                            tooltip: {
                                headerFormat: '<span style="color:{point.color}">\u25cf</span> <span style="font-size: 10px">' +
                                        ' {series.name}</span><br/>',
            ...
            K(f, "Series/CenteredUtilities.js", [
            ...
            K(
                ...
                [
                    f["Core/Animation/AnimationUtilities.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B) {
                    var C = this && this.__extends || function () {
                            var a = function (e, c) {
                    ...
                    f = function (a) {
                        ...
                        e.prototype.setVisible = function (a, e) {
                            ...
                            e = u(e, n);
                            a !== this.visible && (
                                this.visible = this.options.visible = a = "undefined" === typeof a
                                    ? !this.visible
                                    : a,
                                f.options.data[
                                    f
                                ...
                                this.legendItem && k.legend.colorizeItem(this, a),
                        ...
                        e.prototype.slice = function (a, e, f) {
                            ...
                            w(f, c.chart);
                            u(e, !0);
                            this.sliced = this.options.sliced = I(a)
                                ? a
                                : !this.sliced;
                            c
                                .options
                            ...
                            this.graphic && this
                                .graphic
                                .animate(this.getTranslate());
                            this.shadowGroup && this
                                .shadowGroup
                                .animate(this.getTranslate())
                        };
                        return e
                ...
                u = function (a) {
                    ...
                    c.prototype.drawEmpty = function () {
                        ...
                        if (0 === this.total && this.center) {
                            ...
                            var b = this.center[1];
                            this.graph || (
                                this.graph = this.chart.renderer.arc(f, b, this.center[1] / 2, 0, a, c).addClass("highcharts-empty-series").add(this.group)
                            );
                            this
                                .graph
                                .attr({
                    ...
                    c.prototype.getX = function (a, c, f) {
                        ...
                        return g[0] + (
                            c
                                ? -1
                                : 1
                        ) * Math.cos(a) * (b + f.labelDistance) + (
                            0 < f.labelDistance
                                ? (
                                    c
                                        ? -1
                                        : 1
                                ) * this.options.dataLabels.padding
                                : 0
                        )
                    };
                        ...
                        a
                            ...
                            .forEach(function (h) {
                                ...
                                if (!h.isNull && l) {
                                    ...
                                    c.styledMode || (
                                        n = h.shadowGroup,
                                        f && !n && (n = h.shadowGroup = e.g("shadow").add(a.shadowGroup)),
                                        n && n.attr(b),
                                        d = a.pointAttribs(h, h.selected && "select")
                                    );
                                    h.delayedRendering
                                        ? (
                                            l.setRadialReference(a.center).attr(k).attr(b),
                                            c.styledMode || l.attr(d).attr({"stroke-linejoin": "round"}).shadow(f, n),
                                            h.delayedRendering = !1
                                        )
                                        : (
                                            l.setRadialReference(a.center),
                                            c.styledMode || g(!0, m, d),
                                            g(!0, m, k, b),
                                            l.animate(m)
                                        );
                                    l.attr({
                    ...
                    c.prototype.translate = function (a) {
                        ...
                        for (r = 0; r < v; r++) {
                            ...
                            w.half = x < -Math.PI / 2 || x > Math.PI / 2
                                ? 1
                                : 0;
                            w.angle = x;
            ...
            K(
                ...
                [
                    f["Core/Series/DataLabel.js"], f["Core/Globals.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]
                ],
                function (a, f, B, H, w) {
                    var C = f.noop,
                        I = B.distribute,
                    ...
                    (function (f) {
                        function g() {
                            var a = this,
                                ...
                                Z,
                                R;
                            a.visible && (g.enabled || a._hasPointLabels) && (
                                f.forEach(function (a) {
                                    ...
                                    a.dataLabel && (
                                        a.visible
                                            ? (
                                                ...
                                                !k(g.style.width) && !k(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > t && (a.dataLabel.css({
                                        ...
                                        if (0 < a.maxLabelDistance) {
                                            ...
                                            e.forEach(function (a) {
                                                0 < a.labelDistance && a.dataLabel && (
                                                    a.top = Math.max(0, x - z - a.labelDistance),
                                                    a.bottom = Math.min(
                                                        x + z + a.labelDistance,
                                                        b.plotHeight
                                                    ),
                                                    m = a.dataLabel.getBBox().height || 21,
                                                    a.distributeBox = {
                                        ...
                                        for (Z = 0; Z < h; Z++) {
                                            ...
                                            l && k(F.distributeBox) && (
                                                "undefined" === typeof F.distributeBox.pos
                                                    ? W = "hidden"
                                                    : (T = F.distributeBox.size, V = B.radialDistributionY(F))
                                            );
                                            ...
                                            c(g.crop, !0) && (
                                                ...
                                                r = null,
                                                M - U < d && 1 === f
                                                    ? (r = Math.round(U - M + d), C[3] = Math.max(r, C[3]))
                                                    : M + U > n - d && 0 === f && (
                                                        r = Math.round(M + U - n + d),
                                                        C[1] = Math.max(r, C[1])
                                                    ),
                                                0 > V - T / 2
                                                    ? C[0] = Math.max(Math.round(-V + T / 2), C[0])
                                                    : V + T / 2 > p && (C[2] = Math.max(Math.round(V + T / 2 - p), C[2])),
                                                K.sideOverflow = r
                                            )
                                        }
                                    }
                                }),
                                0 === u(C) || this.verifyDataLabelOverflow(C)
                                    ...
                                    if ((K = d.dataLabel) && K._pos && d.visible && 0 < d.labelDistance) {
                                        ...
                                        if (f = !H) 
                                            d.connector = H = b
                                                ...
                                                .path()
                                                .addClass(
                                                    "highcharts-data-label-connector  highcharts-color-" + d.colorIndex + (
                                                        d.className
                                                            ? " " + d.className
                                                            : ""
                                                    )
                            ...
                            this
                                ...
                                .forEach(function (a) {
                                    ...
                                    c && a.visible && (
                                        (b = c._pos)
                                            ? (
                                                c.sideOverflow && (c._attr.width = Math.max(c.getBBox().width - c.sideOverflow, 0), c.css({
                        ...
                        function w(a) {
                            ...
                            if (!f) {
                                if (null !== e[0]) 
                                    var g = Math.max(c[2] - Math.max(a[1], a[3]), d);
                                else 
                                    g = Math.max(c[2] - a[1] - a[3], d),
                                    c[0] += (a[3] - a[1]) / 2;
                                null !== e[1]
                                    ? g = n(g, d, c[2] - Math.max(a[0], a[2]))
                                    : (g = n(g, d, c[2] - a[0] - a[2]), c[1] += (a[0] - a[2]) / 2);
                                g < c[2]
                                    ? (c[2] = g, c[3] = Math.min(
                                        b.thickness
                                            ? Math.max(0, g - 2 * b.thickness)
                                            : Math.max(0, p(b.innerSize || 0, g)),
                                        g
                                    ), this.translate(c), this.drawDataLabels && this.drawDataLabels())
                                    : f = !0
                            }
                            return f
                        }
                        ...
                        f.compose = function (c) {
                            ...
                            -1 === x.indexOf(c) && (
                                x.push(c),
                                c = c.prototype,
                                c.dataLabelPositioners = z,
                                c.alignDataLabel = C,
                                c.drawDataLabels = g,
                                c.placeDataLabels = t,
                                c.verifyDataLabelOverflow = w
                            )
                        }
                    })(g || (g = {}));
                    return g
            ...
            K(f, "Extensions/OverlappingDataLabels.js", [
                            ...
                            a.alignAttr && a.placed
                                ? (a[
                                    c
                                        ? "removeClass"
                                        : "addClass"
                                ]("highcharts-data-label-hidden"), e = !0, a.alignAttr.opacity = c, a[
                                    a.isOld
                                        ? "animate"
                                        : "attr"
                                ](a.alignAttr, null, function () {
                                    f.styledMode || a.css({
                                        pointerEvents: c
                                            ? "auto"
                                            : "none"
                                    })
                                }), w(f, "afterHideOverlappingLabel"))
                                : a.attr({opacity: c})
                        );
                        a.isOld = !0
                    }
                ...
                H(a, "render", function () {
                    ...
                    (this.yAxis || []).forEach(function (a) {
                        a.stacking && a.options.stackLabels && !a.options.stackLabels.allowOverlap && A(
                            a.stacking.stacks,
                            function (a) {
                                A(a, function (a) {
                        ...
                        e.visible && (!1 !== c.enabled || e._hasPointLabels) && (c = function (c) {
                            return c.forEach(function (c) {
                                c.visible && (
                                    ...
                                    g.allowOverlap
                                        ? (e.oldOpacity = e.opacity, e.newOpacity = 1, C(e, a))
                                        : f.push(e)
                                })
                            })
                    ...
                    var u = function (a) {
                        ...
                        if (a && (!a.alignAttr || a.placed)) {
                            ...
                            a.width || (
                                ...
                                a.width = e.width,
                                a.height = e.height,
                                e = c.fontMetrics(null, a.element).h
                            );
                            var n = a.width - 2 * f;
                            (
                                g = {
                                ...
                                ? b = +g * n
                                : I(a.x) && Math.round(a.x) !== a.translateX && (b = a.x - a.translateX);
                            return {
                ...
                a.sort(function (a, c) {
                    ...
                    for (g = 0; g < e; g++) {
                        ...
                        for (n = g + 1; n < e; ++n) {
                            ...
                            !y || !x || u === t || 0 === u.newOpacity || 0 === t.newOpacity || "hidden" === u.visibility || "hidden" === t.visibility || x.x >= y.x + y.width || x.x + x.width <= y.x || x.y >= y.y + y.height || x.y + x.height <= y.y || (
                                (
                                    u.labelrank < t.labelrank
                                        ? u
                                        : t
                                ).newOpacity = 0
                            )
                    ...
                    var e = function () {
                        ...
                        a.prototype.currentOptions = function (a) {
                            function c(a, f, g, h) {
                                var b;
                                I(a, function (a, d) {
                                    if (!h && -1 < e.collectionsWithUpdate.indexOf(d) && f[d]) 
                                        for (a = u(a), g[d] = [], b = 0; b < Math.max(a.length, f[d].length); b++) 
                                            f[d][b] && (
                                                void 0 === a[b]
                                                    ? g[d][b] = f[d][b]
                                                    : (g[d][b] = {}, c(a[b], f[d][b], g[d][b], h + 1))
                                            );
                                else 
                                        w(a)
                                            ? (
                        ...
                        a.prototype.matchResponsiveRule = function (a, c) {
                            var e = a.condition;
                            (e.callback || function () {
                                return this.chartWidth <= A(e.maxWidth, Number.MAX_VALUE) && this.chartHeight <= A(
                                    e.maxHeight,
                                    Number.MAX_VALUE
                                ) && this.chartWidth >= A(e.minWidth, 0) && this.chartHeight >= A(
                                    e.minHeight,
                                    0
                                )
