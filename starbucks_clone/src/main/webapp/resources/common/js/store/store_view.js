					...
					if ( _response.view.length > 0 )
						{
							$("#storeViewWrapBox").tmpl(_response.view, {
								...
								,
								getStoreViewRanding : function()
								{
									var s_biz = this.data.s_biz_code;
									
									if ( s_biz=="9990" || s_biz=="9758" )
									{
										return "block";
									}
									else
								...
								,
								getStoreViewRandingView : function()
								{
									var s_biz = this.data.s_biz_code;
									var html = "";
									...
									if ( s_biz == "9990")
									{
										html = '<iframe src="https://map.kakao.com/html/storeview.html?id=25854"  width="0" height="0" id="ifrDaum" frameborder="0"></iframe>';
									}
									else if ( s_biz == "9758" )
									{
										html = '<iframe src="https://map.kakao.com/html/storeview.html?id=25855"  width="0" height="0" id="ifrDaum" frameborder="0"></iframe>';
									}
									...
									if ( $lsmEvt != null )
									{
										if ( $lsmEvt.list.length > 0 )
										{
											...
											jQuery.each( $lsmEvt.list , function(x,y){
												...
												html+= ' 		<p class="btn_bar"><a href="/whats_new/store_event_list.do?in_evt_code='+y.evt_code+'" target="_blank" class="lsmEventGo" data-lsm="'+y.lsm_index+'">이벤트 상세정보 보러 가기</a></p> ';
												html+= ' 	</div> ';
												html+= ' </li> ';							    				
							    			});
										}
							...
							$(".cafe_time_zone, .dt_time_zone, .reserve_time_zone, .wt_time_zone, .delivers_time_zone").on("click", function(){
...
function changeThema(theme, type)
{
	...
	{
		if( type == "T01") {	return "<span><img src='/common/img/store/store_icon/icon03.png' /></span>"; }		//드라이브 스르라면
		if( type == "T03") {	return "<span><img src='/common/img/store/store_icon/icon01.png' /></span>"; }		//리저브라면
		if( type == "T12") {	return "<span><img src='/common/img/store/store_icon/icon02.png' /></span>"; }		//커뮤니티 스토오라면
		if( type == "T09") {	return "<span><img src='/common/img/store/store_icon/icon04.png' /></span>"; }		//주차라면
		if( type == "T10") {	return "<span><img src='/common/img/store/store_icon/icon05.png' /></span>"; }		//외화결제라면
		if( type == "P10") {	return "<span><img src='/common/img/store/store_icon/icon07.png' /></span>"; }		//공항내
		if( type == "P50") {	return "<span><img src='/common/img/store/store_icon/icon09.png' /></span>"; }		//해안가
		if( type == "P20") {	return "<span><img src='/common/img/store/store_icon/icon08.png' /></span>"; }		//대학가
		if( type == "P60") {	return "<span><img src='/common/img/store/store_icon/icon12.png' /></span>"; }		//터미널/기차역
		if( type == "P50") {	return "<span><img src='/common/img/store/store_icon/icon11.png' /></span>"; }		//리조트        		
		if( type == "P70") {	return "<span><img src='/common/img/store/store_icon/icon13.png' /></span>"; }		//병원
		if( type == "P40") {	return "<span><img src='/common/img/store/store_icon/icon10.png' /></span>"; }		//입점
		if( type == "P80") {	return "<span><img src='/common/img/store/store_icon/icon14.png' /></span>"; }		//지하철 인접
		//if( type == "T04") {	return "<span><img src='/common/img/store/store_icon/icon16.png' /></span>"; }		//에스프레소 초이스
		if( type == "T20") {	return ""; }		//콜드브루
		if( type == "T22") {	return "<span><img src='//image.istarbucks.co.kr/upload/common/img/icon/icon18.png' /></span>"; }		//나이트로 콜드브루
		if( type == "WHCROAD") {	return "<span><img src='/common/img/store/store_icon/icon19.png' /></span>"; }	//휠체어 접근
		if( type == "T21") {	return "<span><img src='/common/img/store/store_icon/icon20.png' /></span>"; }		//현금없는 매장
		if( type == "P90") {	return "<span><img src='/common/img/store/store_icon/icon21.jpg' /></span>"; }		//공기청정기
		if( type == "T05") {	return "<span><img src='/common/img/store/store_icon/icon22.png' /></span>"; }		//피지오
		if( type == "T30") {	return "<span><img src='//image.istarbucks.co.kr/upload/common/img/icon/icon23.png' /></span>"; }		//블론드
		if( type == "T36") {	return "<span><img src='//image.istarbucks.co.kr/upload/common/img/icon/icon_24.png' /></span>"; }		//2020.03.27 매장찾기 검색옵션 내 '식약처 위생등급제 인증' 속성(T36) 추가
		if( type == "T27") {	return "<span><img src='//image.istarbucks.co.kr/upload/common/img/icon/icon_wt.png' /></span>"; }		//[픽업존 관리시스템 개선] 워크스루 아이콘 추가
		if( type == "T43") {	return "<span><img src='//image.istarbucks.co.kr/upload/common/img/icon/icon_delivers_service.png' /></span>"; }		//20210401 '딜리버스' 서비스 추가
		if( type == "T48") {	return "<span><img src='//image.istarbucks.co.kr/upload/common/img/icon/icon_eco_service.png' /></span>"; }		//20210407 '에코매장' 서비스 추가
	}
	else
	{
		return "";
...
{
	setTimeout(function(){
		var s_width  = $(".stor_aip_wrap").width();
		var s_height = $(".stor_aip_wrap").height();
		
		$("#ifrDaum").width(s_width);
		$("#ifrDaum").height(s_height);				
	},300);
}
