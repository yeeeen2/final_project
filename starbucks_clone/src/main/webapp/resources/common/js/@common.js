...
var recent_href = location.host;
if (recent_href.indexOf("dev-") == 0) {
    $config.imgUploadPath = '//dev-www.starbucks.co.kr:7434';
} else if (recent_href.indexOf("test-") == 0) {
    $config.imgUploadPath = '//test-www.starbucks.co.kr:7434';
} else if (recent_href.indexOf("dr-") == 0) {
    $config.imgUploadPath = '//dr-www.starbucks.co.kr';
} else if (recent_href.indexOf("stg-") == 0) {
    $config.imgUploadPath = '//stg-www.starbucks.co.kr';
}
