...
<title id="titleJoin">My DT Pass | Starbucks Korea</title> <!-- 220117 수정 -->
...
<script src="https://connect.facebook.net/ko_KR/sdk.js?hash=80dc08223dae1782379f4fd12fed3a5b" async="" crossorigin="anonymous"></script><script id="facebook-jssdk" src="//connect.facebook.net/ko_KR/sdk.js"></script><script async="" src="//www.google-analytics.com/analytics.js"></script><script>
...
.fb_mpn_mobile_landing_page_slide_out{animation-duration:200ms;animation-name:fb_mpn_landing_page_slide_out;transition-timing-function:ease-in}.fb_mpn_mobile_landing_page_slide_out_from_left{animation-duration:200ms;animation-name:fb_mpn_landing_page_slide_out_from_left;transition-timing-function:ease-in}.fb_mpn_mobile_landing_page_slide_up{animation-duration:500ms;animation-name:fb_mpn_landing_page_slide_up;transition-timing-function:ease-in}.fb_mpn_mobile_bounce_in{animation-duration:300ms;animation-name:fb_mpn_bounce_in;transition-timing-function:ease-in}.fb_mpn_mobile_bounce_out{animation-duration:300ms;animation-name:fb_mpn_bounce_out;transition-timing-function:ease-in}.fb_mpn_mobile_bounce_out_v2{animation-duration:300ms;animation-name:fb_mpn_fade_out;transition-timing-function:ease-in}.fb_customer_chat_bounce_in_v2{animation-duration:300ms;animation-name:fb_bounce_in_v2;transition-timing-function:ease-in}.fb_customer_chat_bounce_in_from_left{animation-duration:300ms;animation-name:fb_bounce_in_from_left;transition-timing-function:ease-in}.fb_customer_chat_bounce_out_v2{animation-duration:300ms;animation-name:fb_bounce_out_v2;transition-timing-function:ease-in}.fb_customer_chat_bounce_out_from_left{animation-duration:300ms;animation-name:fb_bounce_out_from_left;transition-timing-function:ease-in}.fb_invisible_flow{display:inherit;height:0;overflow-x:hidden;width:0}@keyframes fb_mpn_landing_page_slide_out{0%{margin:0 12px;width:100% - 24px}60%{border-radius:18px}100%{border-radius:50%;margin:0 24px;width:60px}}@keyframes fb_mpn_landing_page_slide_out_from_left{0%{left:12px;width:100% - 24px}60%{border-radius:18px}100%{border-radius:50%;left:12px;width:60px}}@keyframes fb_mpn_landing_page_slide_up{0%{bottom:0;opacity:0}100%{bottom:24px;opacity:1}}@keyframes fb_mpn_bounce_in{0%{opacity:.5;top:100%}100%{opacity:1;top:0}}@keyframes fb_mpn_fade_out{0%{bottom:30px;opacity:1}100%{bottom:0;opacity:0}}@keyframes fb_mpn_bounce_out{0%{opacity:1;top:0}100%{opacity:.5;top:100%}}@keyframes fb_bounce_in_v2{0%{opacity:0;transform:scale(0, 0);transform-origin:bottom right}50%{transform:scale(1.03, 1.03);transform-origin:bottom right}100%{opacity:1;transform:scale(1, 1);transform-origin:bottom right}}@keyframes fb_bounce_in_from_left{0%{opacity:0;transform:scale(0, 0);transform-origin:bottom left}50%{transform:scale(1.03, 1.03);transform-origin:bottom left}100%{opacity:1;transform:scale(1, 1);transform-origin:bottom left}}@keyframes fb_bounce_out_v2{0%{opacity:1;transform:scale(1, 1);transform-origin:bottom right}100%{opacity:0;transform:scale(0, 0);transform-origin:bottom right}}@keyframes fb_bounce_out_from_left{0%{opacity:1;transform:scale(1, 1);transform-origin:bottom left}100%{opacity:0;transform:scale(0, 0);transform-origin:bottom left}}@keyframes slideInFromBottom{0%{opacity:.1;transform:translateY(100%)}100%{opacity:1;transform:translateY(0)}}@keyframes slideInFromBottomDelay{0%{opacity:0;transform:translateY(100%)}97%{opacity:0;transform:translateY(100%)}100%{opacity:1;transform:translateY(0)}}</style></head>
	<!-- 약관 2종류(차량번호 수집 및 이용동의, 개인정보 제3자 제공 이용동의) -->
			...
			<div id="top_MSR" class="eFreqTop"><!-- 20170510 수정 : 클래스 eFreqTop 추가 -->
				<div class="top_msr_wrap" style="">
					...
					<div class="msr_card_zone m_card_pic">
						...
						<div class="mycard_one" style="transform: rotateY(-358.905deg);">
							<!-- <div class="front"> -->
...
<ul>
	...
	<li class="util_nav04"><a href="store/store_map">Find a Store</a></li>
			...
			<nav class="sub_gnb_nav">
				<div class="sub_gnb_nav_inner">		<ul>			<!-- COFFEE -->			<li class="gnb_nav01">				<h2><a href="#">COFFEE</a></h2>				<div class="gnb_sub_wrap" style="display: none;">					<div class="gnb_sub">						<div class="gnb_sub_inner">							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/coffee/product_list">커피</a></li>								<li><a href="/starbucks/coffee/product_list">스타벅스 원두</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/coffee/productFinder">나와 어울리는 커피</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/coffee/espresso">에스프레소 음료</a></li>								<li><a href="/starbucks/coffee/doppio">도피오</a></li>								<li><a href="/starbucks/coffee/espresso_macchiato">에스프레소 마키아또</a></li>								<li><a href="/starbucks/coffee/americano">아메리카노</a></li>								<li><a href="/starbucks/coffee/caramel_macchato">마키아또</a></li>								<li><a href="/starbucks/coffee/cappuccino">카푸치노</a></li>								<li><a href="/starbucks/coffee/latte">라떼</a></li>								<li><a href="/starbucks/coffee/mocha">모카</a></li>							</ul>						</div>					</div>					<!-- 텍스쳐 bg -->					<div class="gnb_sub_txbg">						<div class="gnb_sub_tx_inner">							<div class="gnb_sub_tx_left">								<h3><a href="/starbucks/coffee/productFinder">나와 어울리는 커피 찾기</a></h3>								<p class="gnb_sub_ex_txt">스타벅스가 여러분에게 어울리는 커피를 찾아드립니다.</p>							</div>							<div class="gnb_sub_tx_right">							</div>						</div>					</div>					<!-- 텍스쳐 bg end -->				</div>			</li>			<!-- COFFEE end -->			<!-- MENU -->			<li class="gnb_nav02">				<h2><a href="#" class="">MENU</a></h2>				<div class="gnb_sub_wrap" style="display: none;">					<div class="gnb_sub">						<div class="gnb_sub_inner">							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/menu/drink_list">음료</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_cold_brew">콜드 브루</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_brood">브루드 커피</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_espresso">에스프레소</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_frappuccino">프라푸치노</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_blended">블렌디드</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_fizzo">스타벅스 피지오</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_tea">티(티바나)</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_etc">기타 제조 음료</a></li>								<li><a href="/starbucks/menu/drink_list?&amp;CATE_CD=product_juice">스타벅스 주스(병음료)</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/menu/food_list">푸드</a></li>								<li><a href="/starbucks/menu/food_list?CATE_CD=product_bakery">브레드</a></li>								<li><a href="/starbucks/menu/food_list?CATE_CD=product_cake">케이크</a></li>								<li><a href="/starbucks/menu/food_list?CATE_CD=product_sandwich">샌드위치 &amp; 샐러드</a></li>								<li><a href="/starbucks/menu/food_list?CATE_CD=product_wram_food">따뜻한 푸드</a></li>								<li><a href="/starbucks/menu/food_list?CATE_CD=product_fruit_yogurt">과일 &amp; 요거트</a></li>								<li><a href="/starbucks/menu/food_list?CATE_CD=product_snack">스낵 &amp; 미니 디저트</a></li>								<li><a href="/starbucks/menu/food_list?CATE_CD=product_icecream">아이스크림</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/menu/product_list">상품</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_mug">머그</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_glass">글라스</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_plastic">플라스틱 텀블러</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_stainless">스테인리스 텀블러</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_vacuum">보온병</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_accessories">액세서리</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_present">선물세트</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_coffee">커피 용품</a></li>								<li><a href="/starbucks/menu/product_list?CATE_CD=product_teaPackage">패키지 티(티바나)</a></li>							</ul>						</div>					</div>					<!-- 텍스쳐 bg -->					<div class="gnb_sub_txbg">						<div class="gnb_sub_tx_inner">							<div class="gnb_sub_tx_left">							</div>							<div class="gnb_sub_tx_right">							</div>						</div>					</div>					<!-- 텍스쳐 bg end -->				</div>			</li>			<!-- MENU end -->			<li class="gnb_nav03">				<h2><a href="#" class="">STORE</a></h2>				<div class="gnb_sub_wrap" style="display: none;">					<div class="gnb_sub">						<div class="gnb_sub_inner">							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/store/store_map">매장 찾기</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/store/store_drive">드라이브 스루 매장</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/store/store_reserve">스타벅스 리저브™ 매장</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/store/store_community">커뮤니티 스토어 매장</a></li>							</ul>						</div>					</div>					<!-- 텍스쳐 bg -->					<div class="gnb_sub_txbg">						<div class="gnb_sub_tx_inner">							<div class="gnb_sub_tx_left">								<h3><a href="/starbucks/store/store_map">매장찾기</a></h3>								<p class="gnb_sub_ex_txt">보다 빠르게 매장을 찾아보세요.</p>							</div>							<div class="gnb_sub_tx_right">							</div>						</div>					</div>					<!-- 텍스쳐 bg end -->				</div>			</li>			<li class="gnb_nav05">				<h2><a href="#">STARBUCKS REWARDS</a></h2>				<div class="gnb_sub_wrap" style="display: none;">					<div class="gnb_sub">						<div class="gnb_sub_inner">							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/msr/msreward/about">스타벅스 리워드</a></li>								<li><a href="/starbucks/msr/msreward/about">스타벅스 리워드 소개</a></li>								<li><a href="/starbucks/msr/msreward/level_benefit">등급 및 혜택</a></li>								<li><a href="/starbucks/msr/msreward/star">스타벅스 별</a></li>							</ul>							<ul>								<li class="gnb_sub_ttl"><a href="/starbucks/msr/sceGift/egift_information">스타벅스 e-Gift Card</a></li>								<li><a href="/starbucks/msr/sceGift/egift_information">스타벅스 e-Gift Card 소개</a></li>								<li><a href="/starbucks/msr/sceGift/msr_useguide">이용안내</a></li>								<li><a href="/starbucks/msr/sceGift/gift_step1" required="interface/checkLogin">선물하기</a></li>							</ul>						</div>					</div>					<!-- 텍스쳐 bg -->					<div class="gnb_sub_txbg">						<div class="gnb_sub_tx_inner">							<div class="gnb_sub_tx_left">								<h3><a href="#">스타벅스 카드 등록하기</a></h3>								<p class="gnb_sub_ex_txt">카드 등록 후 리워드 서비스를 누리고 사용내역도 조회해보세요.</p>							</div>							<div class="gnb_sub_tx_right">							</div>						</div>					</div>					<!-- 텍스쳐 bg end -->				</div>			</li>		</ul></div>
			</nav>
		</div>
		<!-- 서브 gnb end -->
	</div>
	...
	<div class="ms_sub_tit_bg">
		<div class="ms_sub_tit_inner">
			...
			<div class="ms_cont_wrap">
				<div class="ms_cont">
					<div class="dtConWrap">
						<form action="dtpassProc" id="dtpass" method="post">
							<fieldset>
								<section class="dtInfoWrap">
										<header>
											<h6>My DT Pass를 이용하시는 고객님을 위한 차량 정보입니다.<br>등록할 차량번호를 입력해 주세요.</h6>
											<!-- s::20190405 수정 -->
											<ul class="dtInfoList">
												<li>
													<p>자신이 소유주인 차량의 차량번호 또는 차량 소유주로부터 동의를 받은 차량번호만 입력해 주시기 바랍니다.
														<span class="mBlock">(차량 정보 입력에 대한 책임은 등록 고객에게 있습니다.)</span>
													</p>
												</li>
											<!-- <li>
													<p>스타벅스 모바일 어플리케이션을 설치하시면 신용/체크 카드로 My DT Pass 이용이 가능합니다.
														<span class="mBlock">(신용/체크 카드 추가, 수정, 삭제는 스타벅스 모바일 어플리케이션에서 가능합니다)</span>
													</p>
											</li> -->
											</ul>
											<!-- e::20190405 수정 -->
										...
										<!-- 20181126 추가 -->
										<section class="dpAreaaWrap">
											<div class="dtAgreeTitle">
												<h5>개인정보 수집 및 이용 동의 <span class="t_006633">(필수)</span></h5><!-- 20190405 수정 -->
												<!-- 접근성_20171120 추가 -->
												<span class="agree-check">
													<input type="checkbox" name="dtAgree" id="dt_agree_yes" class="dtpass" value="225">
													<label for="dt_agree_yes">동의</label>
												</span>
												<!-- 접근성_20171120 추가 end -->
											</div>
											
											<div class="dt_area_check">
												<!-- 고객 자동차 등록번호 수집 이용동의 -->
										<div class="privacy_cont mCustomScrollbar _mCS_1 mCS_no_scrollbar" id="privacy_car_text">
											<div id="mCSB_1"
												...
												<div id="mCSB_1_container"
													...
													<div class="privacy_cont mCustomScrollbar _mCS_2">
														<div id="mCSB_2"
															class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside"
															tabindex="0">
															<div id="mCSB_2_container" class="mCSB_container"
																style="position: relative; top: 0; left: 0;" dir="ltr">
																<div class="newDtRivacy">
																	<div class="privacyIn">
																		<p class="pri_tit">개인정보 수집 이용 동의 (필수)</p>
																		<p class="mb40">스타벅스 코리아를 운영하는 주식회사 에스씨케이컴퍼니의 My
																			DT Pass 서비스 이용을 위하여 아래와 같이 고객님의 개인정보를 수집•이용하려고 하오니,
																			내용을 확인 후 동의 여부를 결정하여 주시기 바랍니다.</p>
																		<p class="pri_tit">[필수] 개인정보의 수집•이용 내역</p>
																		<table class="vod_tb mb40"
																			summary="개인정보의 수집•이용 내역 테이블">
																			<caption class="hid">개인정보의 수집•이용 내역</caption>
																			<colgroup>
																				<col width="30%">
																				<col width="*">
																			</colgroup>
																			<tbody>
																				<tr>
																					<th>수집•이용 목적</th>
																					<td class="brn" style="border-top: 1px solid #222;">My
																						DT Pass 서비스 이용</td>
																				</tr>
																				<tr>
																					<th>항목</th>
																					<td class="brn">자동차 등록번호</td>
																				</tr>
																				<tr>
																					<th>보유 및 이용 기간</th>
																					<td class="brn"><span
																						style="border-bottom: 1px solid #4a4a4a;">회원
																							탈퇴 시 까지 또는 계정 휴면 전환 시 까지</span></td>
																				</tr>
																			</tbody>
																		</table>
																		<p class="fontBold">※ 위의 개인정보 수집•이용에 대한 동의를 거부할
																			권리가 있습니다. 그러나 동의를 거부할 경우 My DT Pass 서비스 이용에 제한을 받을 수
																			있습니다.</p>
																	</div>
																</div>
															</div>
										...
										<!-- s::차량번호 입력영역 -->
										<div id="mdpCarInfoWrap">
											
											
												<div class="dtRegiTblWrap dtCon1 mdpCarInfo carAdd">
													<section class="dtRegiTbl">
														<dl class="dtRegiDl">
															<dt>차량번호 관리</dt><!-- 20190405 수정 -->
															<dd>
																<c:choose>	
																	<c:when test="${empty sessionScope.userInfo.DTPass}">		
																		<input class="card_regi_input2" id="carInput" name="DTPass" data-edityn="N" placeholder="약관에 동의해 주세요." type="text" disabled="disabled">
																	</c:when>
																	<c:otherwise>
																		<input class="card_regi_input2" id="carInput" name="DTPass" data-edityn="N" value="${userInfo.DTPass }" type="text" disabled="disabled">
																	</c:otherwise>
																</c:choose>
																<input type="button" value="중복확인" onclick="fn_carNoOverLab(this);" class="dtDDBtn dt1_5 disable">
																<!-- <a onclick="javascript:fn_carNoOverLab(this);" class="dtDDBtn dt1_5 disable">중복확인</a> 비활성화 클래스 : disable -->
																<span class="dtRegDdTxt2">*신형 또는 구형 차량번호 모두 입력 가능합니다.<br>예) ‘12가1234’, ‘서울12가1234’</span>
																<div class="clear"></div>
															</dd>
														</dl>
													</section>
													...
													<!--버튼-->
													<div class="dtBtnWrap">
														<!-- <a onclick="javascript:fn_editPop(this);" class="dtBtn2 modifyBtn1 disable" style="display:none;">수정</a> 클릭되지 않는 비활성화 버튼 span 으로 사용 가능 -->
														<input type="submit" value="삭제" onclick="this.form.action='deleteProc'" class="dtBtn3 deleteBtn1 disable">
														<div class="clear"></div>
													</div>
												</div>
										...
										<div class="dtBtnWrap2">
											<c:choose>	
												<c:when test="${empty sessionScope.userInfo.DTPass}">		
													<input type="submit" value="저장" id="save" class="dtBtn4" disabled="disabled">
												</c:when>
												<c:otherwise>
													<input type="submit" value="저장" id="save" class="dtBtn4">
												</c:otherwise>
											</c:choose>
											<input type="button" value="취소" id="cancel" class="dtBtn5" onclick="fn_mdpEditCancel()">
											<div class="clear"></div>
										</div>
									</section>
								</fieldset>
...
<nav class="ms_nav" id="msRnb">					
	<ul>
		...
		<script type="text/javascript">
		var allCancelFlag	= false;
		var carClauseFlag	= "N" == "Y" ? true : false;
		var carTagHtml 		= "";
		var carDelHtml		= "";
		
			$(document).ready(function() {
				var $mdpCarInfo = $(".mdpCarInfo");
				
				$('div.dt_area_check .privacy_cont').mCustomScrollbar();
				
				// 차량번호 디비에 저장되어있을 때 이용약관동의 
				
				if(${not empty sessionScope.userInfo.DTPass}){
					$("#dt_agree_yes").prop("checked", true);
					$(".dtBtn3").removeClass("disable");
				} 
				...
				carTagHtml = $(".mdpCarInfo").eq(0).clone().wrapAll("<div/>").parent()
							.find("input[name='DTPass']").prop("disabled", false).attr("disabled", false).end()
							.find("input[name='DTPass']").attr("placeholder", "12가1234").end()
							.find("input[name='DTPass']").attr("data-edityn", "Y").end()
							.find("input[name='DTPass']").attr("value", "").end()
							.find("input[name='DTPass']").removeAttr("data-seq").end()
							.find(".dtBtnWrap a").addClass("disable").removeAttr("style").end()
							.find(".dtBtn2").hide().end().html();
				
				
			}).on("change", "#dt_agree_yes", function() {
				var agreeFlag 	= $(this).prop("checked");	// checkbox
				var $inputTag 	= $(".card_regi_input2");	// 차량번호관리 text
				//alert('111111111111111111111');
				$mdpCarInfo	= $(".mdpCarInfo");
				//console.log($mdpCarInfo);
				//alert(carClauseFlag); 
				// carClauseFlag => false
				...
				if (carClauseFlag && !agreeFlag) {
					...
					title	= "이용 동의 철회 안내";
					message	= "<p>철회 시, 등록하신 차량 및 결제수단 정보가 삭제되며, 저장 시 최종 반영됩니다.<br />"
							+ "* 약관 동의 철회 또는 회원 탈퇴 시,<br />"
							+ "결제 수단 변경/ 주문 취소가 불가합니다.</p>"
							+ "<hr />"
							+ "<p>* 차량번호 수집 및 이용 동의<br />"
						
							+ "</p>";
							
					//fn_showMessage("confrm", title, message, "agreeCancel");
					alert(message);
					//alert('여기11111111111111?');
				
				} else if (agreeFlag && !carClauseFlag && $inputTag.length == 1 && $inputTag.val() == "") {
					//alert('여기2222222222222?');
					$(".card_regi_input2").attr("placeholder", "12가1234");
					$(".card_regi_input2").prop("disabled", false).attr("disabled", false);
					$(".card_regi_input2").focus();
					
				
				} else if (!agreeFlag && !carClauseFlag) {
					$(".card_regi_input2").val("");
					$(".card_regi_input2").attr("placeholder", "약관에 동의해 주세요.");
					$(".card_regi_input2").prop("disabled", true).attr("disabled", true);
					//alert('여기33333333333333?');
				}
			...
			// 중복확인 및 형식체크
 			function fn_carNoOverLab(obj){
				if(!$(obj).hasClass("disable")){
					...
					var testing = pattern.test(carNo);	
 			...
 			function fn_carNoOverlapCheck(obj, carNo){
				...
				__ajaxCall("isExistCarNoWeb", param, true, "json", "post"
					, function (data) {
						...
						if(resultCode == "000") {
							...
							$(obj).addClass("disable");
							$('.dtBtn4').removeAttr("disabled");	// 중복확인후 등록가능해야 저장버튼 활성화
									
	
						} else{

							message = "입력한 차량번호는 이미 등록되어 있습니다."
			...
			function fn_mdpEditCancel() {
				var message	= "취소되었습니다.";
				alert(message);
		
				location.href="../my/dtpass";
