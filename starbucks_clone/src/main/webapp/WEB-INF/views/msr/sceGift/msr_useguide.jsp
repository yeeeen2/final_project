...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="../../common/css/style_util-3.css?v=210223" rel="stylesheet">
		<link href="../../common/css/style_msr-2.css?v=210223" rel="stylesheet">
				...
				<div class="top_msr_nologin">
					...
					<div class="top_msr_nologin_b">
						...
						<p class="btn_egift_regi">
							<a href="gift_step1">e-Gift 선물하기</a>
						</p>
					</div>
					<!-- 160628 수정 end -->
				</div>
					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="gift_step1" required="login">선물하기</a></li>
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="msreward/about">스타벅스 리워드 소개</a></li> <!-- 스타벅스 리워드 수정 -->
									<li><a href="msreward/level_benefit">등급 및 혜택</a></li>
									<li><a href="msreward/star">스타벅스 별</a></li>
							...
							<li>
								...
								<ul>
									<li><a href="scard/about">스타벅스 카드 소개</a></li>
									<li><a href="scard/scard_gallery">스타벅스 카드 갤러리</a></li>
									<li><a href="scard/register_inquiry">등록 및 조회</a></li>
									<li><a href="scard/charge_information">충전 및 이용안내</a></li>
									<li><a href="scard/lost_report">분실신고/환불신청</a></li>
							...
							<li>
								...
								<ul>
									<li><a href="egift_information">스타벅스 e-Gift Card 소개</a></li>
									<li><a href="msr_useguide">이용안내</a></li>
									<li><a href="gift_step1" required="login">선물하기</a></li>
	...
	<li class="util_nav04"><a href="/starbucks/store/store_map">Find a Store</a></li>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<!-- 서브 타이틀 end -->
				<!-- 내용 -->
				<section class="useguide_section">
					<div class="useguide_bnr">
						<img class="w_pic" src="../../common/img/msr/sceGift/useguide_bnr_20170823.png" alt="스타벅스 e-Gift Card 이용방법을 알려드립니다. 스타벅스 e-Gift Card를 선물하는 방법과 선물 받은 사람이 사용하는 방법을 구분하여 알려드립니다.">
						<img class="m_pic" src="../../common/img/msr/sceGift/m_useguide_bnr_20170823.png" alt="스타벅스 e-Gift Card 이용방법을 알려드립니다. 스타벅스 e-Gift Card를 선물하는 방법과 선물 받은 사람이 사용하는 방법을 구분하여 알려드립니다.">
					</div>
					<div class="useguide_tabs_wrap">
						<h5 class="gift_giver"><a class="on" href="javascript:void(0);">선물 하는 사람</a></h5>
						<article>
							<!-- 스타벅스 e-Gift Card란? -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd1">
									<dt><strong>스타벅스 e-Gift Card란?</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p><strong class="t_006633">축하, 감사, 응원 등 메시지와 함께 스타벅스 카드를 선물 할 수 있는 가장 빠르고, 간편한 방법!</strong><br>e-Mail과 MMS를 통해 다양한 스타일의 "스타벅스 e-Gift Card"를 보내실 수 있습니다.<br><br><!-- 150627 성연욱 - DOM 수정 --><span class="s1">스타벅스 카드 선물을 위해 실물 카드를 직접 구매 및 전달해야 하는 번거로움 없이 웹/앱에서<br>선물하시려는 휴대폰 또는 e-Mail으로 즉시 또는 예약(원하시는 날짜와 시간 지정)전송하실 수 있습니다.</span><br><span class="s2">※ 스타벅스 리워드 회원/웹 회원만 이용 가능하며, 자신에게도 선물하실 수 있습니다.</span><!-- // 150627 성연욱 - DOM 수정 --></p> <!-- 스타벅스 리워드 수정 -->
										<i class="icon_gift"></i>
									</dd>
								</dl>
							</section> 
							<!-- 스타벅스 e-Gift Card란? end -->
							<!-- 스타벅스 e-Gift Card를 구매하는 방법 -->
							<section class="useguide_type2">
								<dl class="useguide_type_dl utd2">
									<dt><strong>스타벅스 e-Gift Card를 구매하는 방법</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<ol class="step_ol">
											<!-- 150627 성연욱 - DOM 수정 - 각 li에 span 추가 -->
											<li><span class="en">Step 1.</span> Home &gt; Starbucks Rewards &gt; 스타벅스 e-Gift Card &gt; <a href="gift_step1" required="login">선물하기</a> 로 이동</li> <!-- 스타벅스 리워드 수정 -->
											<li><span class="en">Step 2.</span> 선물하고자 하는 카드 이미지를 선택하세요.</li>
											<li><span class="en">Step 3.</span> 선물할 정보 및 메시지를 입력하세요.</li>
											<li><span class="en">Step 4.</span> 결제하기 전, 최종 확인을 해보세요.</li>
											<li><span class="en">Step 5.</span> 결제완료. <a href="my/egiftCard" required="login">[선물내역]</a>에서 확인하실 수 있습니다.</li>
											<!-- // 150627 성연욱 - DOM 수정 - 각 li에 span 추가 -->
										</ol>
										<i class="icon_egift"></i>
									</dd>
									<dd class="add_type_dd">
										<strong>※ 휴대폰 대량 전송(엑셀 업로드) 방법</strong>
										<div class="mass_excel_upload">
											<table summary="휴대폰 번호, 이름">
												<caption>휴대폰 번호, 이름에 대한 테이블</caption>
												<colgroup>
													<col width="103">
													<col width="52">
												</colgroup>
											...
											<ul>
												<li>대량전송은 홈페이지(PC)에서만 가능합니다.</li>
												<li>1회 최대 100명까지 선물하실 수 있습니다.</li>
												<li>선물 받는 분의 휴대폰 번호를 파일 형식에 맞게 정확히 입력 해 주세요.</li>
												<li>샘플을 다운받아 휴대폰 번호와 이름만 수정하여 저장 후, 업로드 하시면 편리합니다.</li>
											</ul>
										</div>
									</dd>
								</dl>
							</section> 
							<!-- 스타벅스 e-Gift Card를 구매하는 방법 end -->
							<!-- 스타벅스 e-Gift Card를 구매할 때 유의해야 할 점들 -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd3">
									<dt><strong>스타벅스 e-Gift Card를 구매할 때 유의해야 할 점들</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<!-- 150627 성연욱 - DOM 수정 - 전체적으로 br 태그 추가 -->
										<ul class="bullet_ul">
											<li>스타벅스 e-Gift Card를 선물하실 경우 발신자의 정보는 스타벅스 웹회원 정보에 등록된 휴대폰 번호 또는 e-Mail 주소로 자동 설정되어 있습니다.<br>회원 정보를 수정하시려면 <a href="my/myinfo_modify_login" required="login">개인정보 확인 및 수정</a>을 클릭해 주세요.</li>
											<li>구매 가능한 최소 금액 단위는 5천원이며, 1만원 이상부터는 1만원 단위로 최대 50만원까지, 1회 당 최대 10개의 휴대폰 또는 e-Mail로 보내실 수 있습니다.<br>또한, 바로 결제하여 즉시 구매하시거나 <a href="my/egiftCard_shopping_bag" required="login">장바구니 내역</a>에 담아두었다가 추후에 결제하실 수도 있습니다.</li>
											<li>
												전송시간은 즉시 또는 생일, 기념일 등 선물하시고자 하는 특정일에 예약전송을 하실 수 있습니다.
												<ul>
													<li>즉시전송을 선택하신 경우 결제가 완료된 시점에 선물 받는 분께 바로 발송됩니다.</li>
													<li>예약 설정은 30일 이내만 가능하며 당일 예약은 되지 않으니 당일 선물은 즉시전송으로 선택하여 주십시오.</li>
												</ul>
											</li>
											<li>선물하려는 휴대폰 번호와 e-Mail은 유효한 번호와 주소로 입력해주시기 바라며, 휴대폰으로 선물 시 발송량에 따라 지정하신 시간보다 수신이 지연될 수 있고<br>단말기에 따라 MMS 수신이 불가능한 경우 스타벅스 e-Gift Card를 받지 못하실 수 있습니다.</li>
											<li>스타벅스 e-Gift Card는 상업적으로 이용 할 수 없으며, 스타벅스에서 제공된 기능이 아닌 불법적이고 비정상 방법으로 사용하여 발생된 문제에 대해 스타벅스는 책임을 지지 않습니다.</li>
										</ul>
										<!-- // 150627 성연욱 - DOM 수정 - 전체적으로 br 태그 추가 -->
									</dd>
								</dl>
							</section> 
							<!-- 스타벅스 e-Gift Card를 구매할 때 유의해야 할 점들 end -->
							<!-- 스타벅스 e-Gift Card 결제수단 안내 -->
							<section class="useguide_type2">
								<dl class="useguide_type_dl utd4">
									<dt><strong>스타벅스 e-Gift Card 결제수단 안내</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<!-- s:: 20210216 수정 -->
										<ul class="bullet_ul">
											<li>스타벅스 e-Gift Card는 웹에서 신용카드, 실시간 계좌이체, 앱에서 신용카드, 휴대폰, SSG PAY로 결제 가능합니다.</li>
											<li>선물 받으시는 분이 2명 이상일 경우 또는 예약 전송을 하시는 경우는 휴대폰 소액결제 수단을 선택할 수 없습니다.</li>
											<li>
												신용카드 결제 관련
												<ul>
													<li>개인 신용 카드의 1개월간 상품권 구매 한도는 100만원 이며, 한도에 대해서는 카드사에 문의해 주시기 바랍니다.<br>(법인카드의 경우, 사업자별로 부개 한도가 상이하오니, 각 사업자에 문의해 주시기 바랍니다.)
													</li>
													<li>법인카드로 구매 시, 청구서 상 "상품권" 유형으로 표시됩니다. (별도 상품권 가맹)</li>
													<li>카드유형 또는 카드사에 따라 부분취소에 제약이 있을 수 있으니 카드사로 문의해 주시기 바랍니다.</li>
												</ul>
											</li>
											<li>
												휴대폰 소액결제 관련
												<ul>
													<li>휴대폰 소액결제 한도는 통신사 또는 요금납부 내역 등 개인별로 상이하오니 통신사 또는 PG사(이니시스)로 문의해주시기 바랍니다.</li>
													<li>애플리케이션 운영체제 및 버전에 따라 결제 수단의 차이가 있을 수 있습니다.</li>
												</ul>
											</li>
										</ul>
										<!-- e:: 20210216 수정 -->
							...
							<!-- 스타벅스 e-Gift Card 결제수단 안내 end -->
							<!-- 스타벅스 e-Gift Card 선물내역 확인 -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd5">
									<dt><strong>스타벅스 e-Gift Card 선물내역 확인</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p>선물한 메시지, 수신인, 결제금액 등 지인에게 선물하신 상세내역은  Home &gt; Starbucks Rewards &gt; 스타벅스 e-Gift Card &gt; <a href="my/egiftCard" required="login">선물내역</a>에서 확인 하실 수 있습니다.</p> <!-- 스타벅스 리워드 수정 -->
									</dd>
								</dl>
							</section> 
							<!-- 스타벅스 e-Gift Card 선물내역 확인 end -->
							<!-- 스타벅스 e-Gift Card 결제수단 안내 -->
							<section class="useguide_type2">
								<dl class="useguide_type_dl utd6">
									<dt><strong>스타벅스 e-Gift Card 구매 취소 및 재전송</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">실수로 휴대폰 번호나 e-mail주소를 잘못 입력하셨거나, 변경을 희망하는 경우에는 취소 후 다시 결제하여 주시기 바랍니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 추가 -->
										<ul class="bullet_ul">
											<li>선물한 스타벅스 e-Gift Card는 미등록 상태로 사용내역이 없는 경우, 결제일로부터 최대 7일 내 온라인에서 취소가 가능합니다.</li><!-- 2019.05.27 [My Card / e-Gift Card 휴대폰 결제 취소] 문구 수정 -->
											<li>한꺼번에 여러 개의 e-Gift Card를 구매하신 경우, 홈페이지에서 건 별 부분 취소가 가능합니다.<br>단, 카드사 별로 부분취소의 기준이 상이할 수 있으니, 자세한 내용은 해당 카드사에 확인하여 주시기 바랍니다.</li>
											<li>동일한 휴대폰 번호 또는 e-mail 주소에 한해, 1회까지 재전송 할 수 있습니다.</li>
										</ul>
										<div class="btn_chk_gift">
											<a href="my/egiftCard" required="login">선물내역 확인하러 가기</a>
										</div>
									</dd>
								</dl>
							</section> 
							<!-- 스타벅스 e-Gift Card 결제수단 안내 end -->
							<!--  스타벅스 e-Gift Card 다시 선물하기  -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd7">
									<dt><strong>스타벅스 e-Gift Card 선물내역 확인</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">똑같은 내용을 다시 입력하기 번거로우신가요? 과거에 선물했던 내용 그대로 간편하게 다시 선물하실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 추가 -->
										<ul class="bullet_ul">
											<li><a href="my/egiftCard" required="login">선물내역</a>에서 다시 선물하고자 하는 주문내역을 선택하세요.</li>
											<li>[다시 선물하기]버튼을 클릭하여, 선물 정보를 확인하고 결제 해 주세요. 같은 분께 동일한 내용으로 e-Gift Card가 다시 전송됩니다.</li>
										</ul>
									</dd>
								</dl>
							</section> 
							<!--  스타벅스 e-Gift Card 다시 선물하기 end  -->
						</article>
						<h5 class="gift_receiver"><a href="javascript:void(0);">선물 받은 사람</a></h5>
						<article>
							<!-- 스타벅스 e-Gift Card를 받았는데 스타벅스 e-Gift Card가 무엇인가요? -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd8">
									<dt><strong>스타벅스 e-Gift Card란?</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<!-- 150627 성연욱 - DOM 수정 - 마크업 수정 -->
										<p><strong class="t_006633">실물 카드를 휴대하지 않고도 바로 스타벅스 매장에서 사용할 수 있는 e-스타벅스 카드입니다.</strong></p>
										<p class="black">선물 받으신 스타벅스 e-Gift Card는 다음의 4가지 방법으로 사용하실 수 있습니다.</p>
										<!-- // 150627 성연욱 - DOM 수정 - 마크업 수정 -->
										<ul class="bullet_ul">
											<li>휴대폰 MMS로 받은 스타벅스 e-Gift Card사용</li>
											<li>e-Mail로 받은 스타벅스 e-Gift Card 사용</li>
											<li>선물받은 스타벅스 e-Gift Card를 실물 카드로 교환하여 사용<br><span>(※매장에 비치된 카드 중 선택하여 교환가능하며, e-Gift카드 이미지와 동일한 카드가 없을 수 있습니다.)</span></li>
											<li>스타벅스 홈페이지 또는 애플리케이션에 카드 등록하여 사용</li>
										</ul>
										<i class="icon_guide1"></i>
									</dd>
								</dl>
							</section>
							<!-- 스타벅스 e-Gift Card를 받았는데 스타벅스 e-Gift Card가 무엇인가요? end -->
							<!-- 휴대폰 MMS로 받은  스타벅스 e-Gift Card 사용 방법 -->
							<section class="useguide_type2">
								<dl class="useguide_type_dl utd9">
									<dt><strong>휴대폰 MMS로 받은  스타벅스 e-Gift Card 사용 방법</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">휴대폰 MMS를 수신 하신 후 가까운 매장에 방문하시면 바로 사용하실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 추가 -->
										<ul class="bullet_ul">
											<li>원하시는 제품 또는 상품을 e-Gift Card금액 내에서 구매하실 수 있습니다.</li>
											<li>주문 전 선물받은 MMS를 파트너에게 보여주세요.</li>
											<li>만약 원하시는 제품 또는 상품의 금액이 선물받으신 e-Gift Card의 금액 또는 잔액보다 초과할 경우,<br>부족 금액을 다른 스타벅스 카드 또는 기타 현금이나 신용카드를 함께 사용하여 결제하실 수 있습니다.</li><!-- 150627 성연욱 - DOM 수정 - li태그에 br 추가 -->
										</ul>
										<i class="icon_guide2"></i>
									</dd>
								</dl>
							</section>
							<!-- 휴대폰 MMS로 받은  스타벅스 e-Gift Card 사용 방법 end -->
							<!-- e-Mail로 받은 스타벅스 e-Gift Card 사용 방법 -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd10">
									<dt><strong>e-Mail로 받은 스타벅스 e-Gift Card 사용 방법</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">e-Mail을 수신하신 후 가까운 매장에 방문하시면 바로 사용하실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 추가 -->
										<ul class="bullet_ul">
											<li>원하시는 제품 또는 상품을 e-Gift Card 금액 내에서 구매하실 수 있습니다.</li>
											<li>주문 전 프린트 하신 e-Mail 또는 휴대폰 등을 통해 e-Mail을 열어 파트너에게 보여주세요.</li>
											<li>만약 원하시는 제품 또는 상품의 금액이 선물받으신 e-Gift Card의 금액 또는 잔액보다 초과할 경우,<br>부족 금액을 다른 스타벅스 카드 또는 기타 현금이나 신용카드를 함께 사용하여 결제하실 수 있습니다.</li><!-- 150627 성연욱 - DOM 수정 - li태그에 br 추가 -->
										</ul>
										<i class="icon_guide3"></i>
									</dd>
								</dl>
							</section>
							<!-- e-Mail로 받은 스타벅스 e-Gift Card 사용 방법 end -->
							<!-- 선물받은 스타벅스 e-Gift Card를 실물 카드로 교환하는 방법 -->
							<section class="useguide_type2">
								<dl class="useguide_type_dl utd11">
									<dt><strong>선물받은 스타벅스 e-Gift Card를 실물 카드로 교환하는 방법</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">매장에서 원하시는 디자인의 스타벅스 카드로 교환하실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 추가 -->
										<ul class="bullet_ul">
											<li>휴대폰 MMS 또는 e-Mail을 프린트하여 매장에 방문하세요.</li>
											<li>휴대폰 MMS 또는 e-Mail로 선물을 받은 후, 사용하시고 잔액이 남아 있는 경우에만 실물 스타벅스 카드로 교환이 가능합니다.</li>
											<li>매장에서 원하시는 스타벅스 카드를 선택하신 후 MMS 또는 e-Mail을 보여주시면 됩니다.</li>
										</ul>
										<i class="icon_guide4"></i>
									</dd>
								</dl>
							</section>
							<!-- 선물받은 스타벅스 e-Gift Card를 실물 카드로 교환하는 방법 end -->
							<!-- 스타벅스 홈페이지에 등록해서 사용하는 방법 -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd12">
									<dt><strong>스타벅스 홈페이지에 등록해서 사용하는 방법</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">스타벅스 e-Gift Card를 <a href="my/mycard_index" required="login">My 카드</a>에 <a href="my/mycard_info_input" required="login">카드 등록</a> 후 이용하시면, 다양한 혜택을 누리실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 추가 -->
										<ul class="bullet_ul">
											<li>휴대폰 MMS 또는 e-Mail에 도착한 스타벅스 e-Gift Card를 확인하세요.<br>(카드번호, pin번호는 꼭 인지하고 계셔야 합니다.)</li>
											<li>음료 및 푸드 선택 후 스타벅스 모바일 홈페이지 또는 앱을 실행 하신 후 파트너에게 제시하시면, 등록한 e-Gift Card로 결제하실 수 있습니다.</li>
										</ul>
										<i class="icon_guide5"></i>
									</dd>
								</dl>
							</section>
							<!-- 스타벅스 홈페이지에 등록해서 사용하는 방법 end -->
							<!-- 스타벅스 홈페이지에 등록하면 어떤 점이 좋은가요? -->
							<section class="useguide_type2">
								<dl class="useguide_type_dl utd13">
									<dt><strong>스타벅스 홈페이지에 등록하면 어떤 점이 좋은가요?</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">스타벅스 e-Gift Card를 <a href="my/mycard_index" required="login">My 카드</a>에 <a href="my/mycard_info_input" required="login">카드 등록</a>하시면 스타벅스 리워드 회원이 됩니다.<br>생일 무료 음료 쿠폰, New Beverage BOGO e-쿠폰 등 다양한 혜택을 누리실 수 있습니다.</p><!-- 150627 성연욱 - DOM 수정 - p태그에 클래스 및 a태그 추가 --> <!-- 스타벅스 리워드 수정 -->
										<ul class="bullet_ul">
											<li>스타벅스 e-Gift Card를 스타벅스 홈페이지에 등록하시면, 실물 스타벅스 카드를 등록한 것과 마찬가지로 스타벅스 리워드 회원이 되어 동일한 혜택을 누리실 수 있습니다.</li> <!-- 스타벅스 리워드 수정 -->
											<li>스타벅스 카드 등록 후, 스타벅스 매장에 방문하여 등록하신 카드로 결제 시 마다 별이 부여되며 적립된 별의 개수로 레벨이 결정되고 그에 따른 다양한 혜택이 제공됩니다.</li>
											<li>휴대폰만 가지고 계시면 간편하게 결제가 가능합니다.<br>(모바일 홈페이지 or 앱을 실행하여 사용)</li>
											<li>리워드 혜택으로 받으신 e-쿠폰을 지인에게 선물하실 수 있습니다.</li>
											<li>매번 충전하기 번거로우셨다면, <a href="my/mycard_charge-2?autoReloadType=2" required="login">자동충전</a> 기능을 이용하시면 보다 편리하게 이용하실 수 있습니다.</li>
										</ul>
									</dd>
								</dl>
							</section>
							<!-- 스타벅스 홈페이지에 등록하면 어떤 점이 좋은가요? end -->
							<!-- 160927 추가 - 스타벅스 e-Gift Card 거절하는 방법 -->
							<section class="useguide_type1">
								<dl class="useguide_type_dl utd12">
									<dt><strong>스타벅스 e-Gift Card 거절하는 방법</strong><span class="arrow"><a href="javascript:void(0);"></a></span></dt>
									<dd>
										<p class="black">선물 받은 스타벅스 e-Gift Card를 다음과 같이 거절하실 수 있습니다.</p>
										<ul class="bullet_ul">
											<li>선물 받은 일자로부터 2주 이내에 거절하기가 가능합니다.</li>
											<li>선물 받은 스타벅스 e-Gift Card를 본인 계정에 등록하거나, 등록 후 해지하신 경우 거절하기는 불가합니다.</li>
										</ul>
										<i class="icon_guide6"></i>
									</dd>
								</dl>
							</section>
							<!-- 160927 추가 - 스타벅스 e-Gift Card 거절하는 방법 end -->
						</article>
					</div>
				</section>
			</div>
...
// 					});
		...
		<script>
			$(document).ready(function(){
				...
				$('.useguide_tabs_wrap h5 a:not(.on)').parent().next().hide();
				$('.useguide_tabs_wrap h5 a').bind('click', function(){
					$('.useguide_tabs_wrap h5 a').removeClass('on');
					$(this).addClass('on');
					$('.useguide_tabs_wrap article').hide();
