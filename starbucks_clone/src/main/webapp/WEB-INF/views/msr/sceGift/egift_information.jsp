			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../../common/img/msr/sceGift/egift_information_tit_20170823.jpg" alt="스타벅스 e-Gift Card 소개"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="egift_information" class="this">스타벅스 <span class="en">e-Gift Card</span> 소개</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="msr_cont">
					...
					<section class="eInformation_bar">
						<article class="eInformation_bar_inner">
							<p class="eInfo_vis"><img class="w_pic" src="../../common/img/msr/sceGift/egift_information_bar_20170823.png" alt="쉽고 빠르게 스타벅스 카드를 구매하는 방법, 스타벅스 e-Gift Card를 소개합니다. 매장에 방문하지 않아도 언제든 온라인에서 스타벅스 e-Gift Card를 손쉽게 구매하실 수 있습니다. 소중한 사람에게 스타벅스 e-Gift Card를 선물하고 마음을 전해보세요."><img class="m_pic" src="../../common/img/msr/sceGift/m_egift_information_bar_20170823.png" alt="쉽고 빠르게 스타벅스 카드를 구매하는 방법, 스타벅스 e-Gift Card를 소개합니다. 매장에 방문하지 않아도 언제든 온라인에서 스타벅스 e-Gift Card를 손쉽게 구매하실 수 있습니다. 소중한 사람에게 스타벅스 e-Gift Card를 선물하고 마음을 전해보세요."></p><!-- jsp 수정 - 이미지 추가 및 클래스 추가 -->
							<p class="m_scard_txt">매장에 방문하지 않아도 언제든 온라인에서<br>스타벅스 e-Gift Card를 손쉽게 구매하실 수 있습니다.<br>소중한 사람에게 스타벅스 e-Gift Card를 선물하고 마음을 전해보세요</p>
						</article>
					</section>
					...
					<section class="eInformation_info1">
						<article class="eInformation_info1_inner">
							...
							<ul class="egift_info">
								<li>
									<dl class="info_01">
										<dt><img class="hidden_pic" src="../../common/img/msr/sceGift/icon_1_info1.png" alt=""></dt>
										<dd>
								...
								<li class="arrow">
									<img class="w_pic" src="../../common/img/msr/sceGift/icon_arrow_info1.png" alt="맵 화살표">
									<img class="m_pic" src="../../common/img/msr/sceGift/m_arrow.jpg" alt="맵 화살표">
								</li>
								<li>
									<dl class="info_02">
										<dt><img class="hidden_pic" src="../../common/img/msr/sceGift/icon_2_info1.png" alt=""></dt>
										<dd>
											<p class="tit">Step 2. 정보 입력</p>
											<p class="con">선물하실 금액, 날짜,<br>전송방법(휴대폰 MMS 또는 e-mail)을<br>선택해 주세요.</p>
										</dd>
									</dl>
								</li>
								<li class="arrow">
								...
								<li>
									<dl class="info_03">
										<dt><img class="hidden_pic" src="../../common/img/msr/sceGift/icon_3_info1.png" alt=""></dt>
										<dd>
											<p class="tit">Step 3. 결제</p>
											<p class="con">결제수단 (신용카드, 실시간 계좌이체, 휴대폰 소액결제)을 <br>선택하고 결제해 주세요.</p> <!-- 20210216 수정 -->
										</dd>
									</dl>
								</li>
								<li class="arrow">
								...
								<li>
									<dl class="info_04">
										<dt><img class="hidden_pic" src="../../common/img/msr/sceGift/icon_4_info1.png" alt=""></dt>
										<dd>
				...
				<section class="eInformation_use">
					<article class="eInformation_use_inner">
						...
						<p class="s_titl">스타벅스 <span class="en">e-Gift Card</span>는 회원가입 없이도 즉시 사용할 수 있습니다.<br>스타벅스 회원이라면 <span class="btn_cardIink"><a href="my/mycard_info_input" required="login">[카드 등록]</a></span>후, 더욱 편리하게 사용하세요.</p>
						<ul class="egift_use">
							<li>
								<dl class="use_01">
									<dt>휴대폰 MMS 제시</dt>
									<dd><p>수신하신 MMS를 제시하여<br>사용 가능</p></dd>
								</dl>
							</li>								
							<li>
								<dl class="use_02">
				...
				<!-- (스타벅스 카드 e-Gift 소개) use end -->
				<!-- 20160510 김민호 추가 -->
				<section class="eInformation_card">
					<div class="sc_buy_wrap2">
						<ul>
							<li>
								<dl>
									<dt><img src="../../common/img/msr/scard/sc_buy_pic1.jpg" alt=""></dt>
									<dd>
										<p class="p1">카드 충전</p>
										<p class="p2">다양한 충전방법을 통해 간편하게<br>충전이 가능합니다.</p>
										<!-- 160509 링크 추가 -->
										<p class="btn"><a href="my/mycard_charge" required="login">바로가기</a></p>
										<!-- 160509 링크 추가 end -->
									</dd>
								</dl>
							</li>
							<li>
								<dl>
									<dt><img src="../../common/img/msr/scard/sc_buy_pic2.jpg" alt=""></dt>
									<dd>
										<p class="p1">카드 등록</p>
										<p class="p2">카드 등록 후 리워드 서비스를 누리고<br>사용내역도 조회해보세요.</p>
										<p class="btn"><a href="my/mycard_info_input" required="login">바로가기</a></p>
									</dd>
								</dl>
							</li>
							<li class="last">
								<dl>
									...
									<dd>
										...
										<p class="g_btn"><a href="gift_step1" required="login">바로가기</a></p>
									</dd>
								</dl>
							</li>
						</ul>
