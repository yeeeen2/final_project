			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../../common/img/msr/scard/tit5.jpg" alt="자주하는 질문"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="lost_report" class="this">분실신고/환불신청</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<section class="scard_section">
					<p class="mb40"><img usemap="#lost_w_pic" class="w_pic" src="../../common/img/msr/scard/scard_main_bn5.jpg?v=210917" alt="스타벅스 카드 분실 시, 잔액을 보호받으실 수 있습니다. 등록된 스타벅스 카드를 분실하신 경우, 온라인에서 분실신고를 통해 잔액을 보호하세요. 잔액이전 또는 환불신청을 통해 잔액을 돌려받으실 수 있습니다."><img class="m_pic" src="../../common/img/msr/scard/m_scard_main_bn5.jpg" alt="스타벅스 카드 분실 시, 잔액을 보호받으실 수 있습니다. 등록된 스타벅스 카드를 분실하신 경우, 온라인에서 분실신고를 통해 잔액을 보호하세요. 잔액이전 또는 환불신청을 통해 잔액을 돌려받으실 수 있습니다."></p><!-- 20210914 수정 --><!-- jsp 수정 -->
					<p class="m_scard_txt">등록된 스타벅스 카드를 분실하신 경우, 온라인에서 <a href="my/mycard_lost"><span>분실신고</span></a>를 통해 잔액을 보호하세요. <a href="my/mycard_lost"><span>잔액이전</span></a> 또는  <a href="my/mycard_lost"><span>환불신청</span></a>을 통해 잔액을 돌려받으실 수 있습니다.</p><!-- 20210914 수정 --><!-- jsp 수정 -->
					<map name="lost_w_pic" id="lost_w_pic">
					    <area shape="rect" coords="588,110,641,129" href="my/mycard_lost" alt="분실신고">
					    <area shape="rect" coords="354,133,409,149" href="my/mycard_lost" alt="잔액이전">
					    <area shape="rect" coords="447,131,500,148" href="my/mycard_lost" alt="환불신청">					
					</map>	
					<div class="lost_cont_area">
						...
						<article class="lost_cont lost_cont_first">
							<h6>정의</h6>
							<p class="cont">등록된 스타벅스 카드를 <a href="my/mycard_index">My카드</a> 목록에서 삭제</p>
							<h6>진행 방법</h6>
						...
						<article class="lost_cont">
							...
							<h6>카드 분실신고 안내</h6>
							<ul class="cont">
								<li>분실신고는 등록된 카드에 한해 온라인에서만 신청 가능합니다. <a href="my/mycard_lost" class="btn_scard_lost">스타벅스카드 분실신고/잔액이전 바로가기</a></li>
						...
						<article class="lost_cont">
							...
							<ul class="cont">
								...
								<li>
									온라인 충전
									<ul>
										<li>- 충전 후 사용 내역이 없는 경우에 한하여, 충전일로부터 최대 7일 내 온라인에서 충전 취소가 가능합니다.</li><!--2019.05.27 [My Card / e-Gift Card 휴대폰 결제 취소] 문구 수정 -->
									</ul>
								</li>
							</ul>
						</article>
						...
						<article class="lost_cont">
							...
							<ul class="cont">
								...
								<li>교환 받은 새로운 카드는 반드시 계정에 등록해야만 기존의 스타벅스 리워드 혜택을 지속적으로 누릴 수 있습니다.</li> <!-- 스타벅스 리워드 수정 -->
							</ul>
						</article>
						...
						<article class="lost_cont">
							...
							<ul class="cont">
								...
								<li>언제든 ARS : 00308-132-271 , 홈페이지 또는 모바일 애플리케이션 <a href="my/mycard_index">My 카드</a>에서 현재 잔액과 최근 사용내역을 조회하실 수 있습니다.</li>
							</ul>
							<h6>잔액이전 안내</h6>
							<ul class="cont">
