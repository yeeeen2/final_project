			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../../common/img/msr/scard/register_inquiry_tit1.jpg" alt="등록 및 조회"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="register_inquiry" class="this">등록 및 조회</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="msr_cont">
					...
					<section class="register_inquiry_bar">
						<article class="register_inquiry_bar_inner">
							<p><img class="w_pic" src="../../common/img/event/2020/20_register_inquiry_bar_img01.png.jpg" alt="스타벅스 카드 등록!  스타벅스를 가장 스마트   하게 이용하실 수 있는 첫걸음입니다. 스타벅스 카드를 등록하고 스타벅스 리워드의 다양한 혜택을 누려보세요!"><img class="m_pic" src="../../common/img/msr/scard/m_register_inquiry_bar_img01.jpg" alt="스타벅스 카드 등록!  스타벅스를 가장 스마트   하게 이용하실 수 있는 첫걸음입니다. 스타벅스 카드를 등록하고 스타벅스 리워드의 다양한 혜택을 누려보세요!"></p><!-- jsp2 수정 - 이미지 수정 -->
						</article>
					</section>
					<p class="m_scard_txt">스타벅스 카드를 등록하고 스타벅스 리워드의 다양한 혜택을 누려보세요!</p><!-- jsp2 추가 - p 태그 추가 -->
					<!-- (등록 및 조회) bar end -->
					<div class="registerInquiry_info">
						...
						<section class="registerInquiry_info1">
							<article class="registerInquiry_info1_inner">
								<dl>
									<dt>아직 온라인 회원이 아니신가요?</dt><!-- 20210914 수정 -->
									<dd>
										간단한 회원가입을 통해 다양한 스타벅스 정보를<br>가장 먼저 접하실 수 있습니다.
									</dd>								
								</dl>
								<p class="btn_info1"><a href="mem/join">가입하기</a></p>
							</article>
						</section>
						<!-- (등록 및 조회) info1 end -->
						...
						<section class="registerInquiry_info2">
							<article class="registerInquiry_info2_inner">
								...
								<ul>
									<li class="btn_card_regi"><a href="my/mycard_info_input">스타벅스 카드 등록</a></li>
									<li class="btn_to_home"><a href="sceGift/gift_step1">e-Gift 선물하기</a></li>
								</ul>
								<!-- <p class="btn_info2"><a href="javascript:void(0);">스타벅스 카드 등록</a></p> -->
							</article>
						</section>
						<!-- 160628 수정 end -->
						<!-- (등록 및 조회) info2 end -->
						...
						<section class="registerInquiry_info3">
							<article class="registerInquiry_info3_inner">
								<dl>
									...
									<dd>
										이제 온라인에서 간편하게 스타벅스 카드를<br>관리하세요.<!-- 20210914 수정 -->
									</dd>								
								</dl>
								<p class="btn_info3"><a href="my/mycard" required="login">My 카드 관리</a></p>
							</article>
						</section>
						<!-- (등록 및 조회) info3 end -->
					</div>
					...
					<section class="registerInquiry_barIink">
						<article class="registerInquiry_barIink_inner">
							<p class="text"><span class="en">STARBUCKS REWARDS</span> 약관이 궁금하신가요?</p> <!-- 스타벅스 리워드 수정 -->
							<p class="btn_barIink"><a href="footer/etc/rules_msr"><img src="../../common/img/event/2020/20_btn_barIink_more.png" alt="스타벅스 리워드 이용약관 보기"></a></p> <!-- 스타벅스 리워드 수정 -->
						</article>
					</section>
					<!-- (등록 및 조회) barIink end -->

					<p class="m_btn_barIink"><a href="footer/etc/rules_msr"><img src="../../common/img/event/2020/20_btn_barIink_more.png" alt="스타벅스 리워드 이용약관 보기"></a></p> <!-- 스타벅스 리워드 수정 -->
