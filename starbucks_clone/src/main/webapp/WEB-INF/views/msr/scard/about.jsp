				...
				<div class="top_msr_nologin">
					...
					<div class="top_msr_nologin_b">
						...
						<p class="btn_egift_regi">
							<a href="sceGift/gift_step1">e-Gift 선물하기</a>
						</p>
					</div>
					<!-- 160628 수정 end -->
				</div>
					...
					<nav class="mob_gnb_menus">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="sceGift/gift_step1" required="login">선물하기</a></li>
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="about">스타벅스 카드 소개</a></li>
									<li><a href="scard_gallery">스타벅스 카드 갤러리</a></li>
									<li><a href="register_inquiry">등록 및 조회</a></li>
									<li><a href="charge_information">충전 및 이용안내</a></li>
									<li><a href="lost_report">분실신고/환불신청</a></li>
							...
							<li>
								...
								<ul>
									<li><a href="sceGift/egift_information">스타벅스 e-Gift Card 소개</a></li>
									<li><a href="sceGift/msr_useguide">이용안내</a></li>
									<li><a href="sceGift/gift_step1" required="login">선물하기</a></li>
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../../common/img/msr/scard/tit1.jpg" alt="스타벅스 카드 소개"></h2>
						<ul class="smap">
							...
							<li class="en"><a href="/starbucks/msr/msreward/about" class="subHeadMnu1">Starbucks Rewards</a></li>  <!-- 스타벅스 리워드 수정 -->
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="about">스타벅스 카드</a></li>
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="about" class="this">스타벅스 카드 소개</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<section class="scard_section">
					<!-- 150825 DOM 수정 -->
					<p class="scard_visual"><img class="w_pic" src="../../common/img/msr/scard/scard_main_bn.jpg" alt="스타벅스만의 특별함, 스타벅스 카드를 소개합니다. 따뜻한 커피와 마음을 전하기 가장 좋은 방법! 스타벅스만의 특별한 충전식 선불카드 , 사용하면 할수록 다양한 혜택을 경험할 수 있습니다."><img class="m_pic" src="../../common/img/msr/scard/m_scard_main_bn.jpg" alt="스타벅스만의 특별함, 스타벅스 카드를 소개합니다. 따뜻한 커피와 마음을 전하기 가장 좋은 방법! 스타벅스만의 특별한 충전식 선불카드 , 사용하면 할수록 다양한 혜택을 경험할 수 있습니다."></p>
					<p class="m_scard_txt">따뜻한 커피와 마음을 전하기 가장 좋은 방법!<br>스타벅스만의 특별한 충전식 선불카드 ,<br>사용하면 할수록 다양한 혜택을 경험할 수 있습니다.</p>
					<!-- 150825 DOM 수정 end -->
				...
				<!-- 20181004 무기명 카드 영역 추가  -->
				<section class="scard_buy_section forAllSection">
					<div class="scard_buy_inner">
						<p class="tit1">무기명 카드 for All Rewards</p>
						<p class="t1">
							<span class="s_block">무기명 카드란 스타벅스 리워드 회원 계정에 등록되지 않은 모든 스타벅스 카드 혹은 미등록 e-Gift Card를 말합니다.</span> <!-- 스타벅스 리워드 수정 -->
						...
						<ul class="info">
							<li>
								...
								<div class="scardBogoImg">
									<img src="../../common/img/msr/scard/scard_bogocoupon_pc.png" alt="BOGO 쿠폰이란" class="bogoImgPc">
									<img src="../../common/img/msr/scard/scard_bogocoupon_mo.png" alt="BOGO 쿠폰이란" class="bogoImgMo">
								</div>
								<!-- 무기명 카드 실적 집계 -->
							...
							<li>
								무기명 카드 혜택과 스타벅스 리워드 회원 혜택은 중복 적용되지 않으며, 스타벅스 회원 가입 후 사용하던 무기명 카드를 계정에 등록하시면 언제든지 스타벅스 리워드 회원으로<br> <!-- 스타벅스 리워드 수정 -->
				...
				<!-- 스타벅스 카드 구매방법 -->
				<section class="scard_buy_section bgChange"><!-- 20181004 class="bgChange"추가 -->
					<div class="scard_buy_inner">
								...
								<li class="last">
									<dl>
										...
										<dd>
											...
											<p class="g_btn"><a href="sceGift/gift_step1" required="login">바로가기</a></p>
										</dd>
									</dl>
								</li>
							</ul>
						...
						<ul class="info mb30">
							...
							<li>신용카드, 실시간 계좌이체(홈페이지, 모바일 애플리케이션), 휴대폰 소액결제(모바일 애플리케이션)를 통해 결제할 수 있습니다.</li> <!-- 20210216 수정 -->
							<li>휴대폰 MMS, e-mail을 통해 선물하실 수 있습니다.</li>
						</ul>
						<p class="stit">단체 및 기업 구매</p>
						<p class="t1">단체 및 기업의 경우 스타벅스 카드를 대량 구매 하실 수 있습니다.</p>
						<!-- 20190304 수정 -->
						<div class="soConArea"><!-- 20190304 태그 추가 -->
							<p class="t1">구매신청조건</p>
							<ul class="info mb30">
								<li>대상 : 증빙 가능한 기업 또는 단체</li>
								<li>최소구매 : 건당 50만원 이상</li>
								<li>방법 : B2B 발주시스템을 통하여 접수<br><span>(단체 및 기업구매 안내&nbsp;<a class="newBtn" href="footer/co_sales/index" target="_blank">바로가기</a>)</span></li><!-- 20210913 수정 -->
							</ul>	
						</div>
						<!-- //20190304 수정 -->
					</div>
