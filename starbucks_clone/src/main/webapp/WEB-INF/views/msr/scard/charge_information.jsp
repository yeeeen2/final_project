			...
			<div id="container">
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../../common/img/msr/scard/chargeInformation_tit1.jpg" alt="충전 및 이용안내"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="charge_information" class="this">충전 및 이용안내</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="msr_cont">
					...
					<section class="chargeInformation_bar">
						<article class="chargeInformation_bar_inner">
							<p><img class="w_pic" src="../../common/img/msr/scard/chargeInformation_bar_img01.png?v=210917" usemap="#charge_pic_info" alt="스타벅스 카드는 온라인에서도 손쉽게 충전 가능합니다. 스타벅스 홈페이지와 모바일 애플리케이션을 통해 언제 어디서나 편리하게 이용하세요. 온라인에서는 일반충전과 자동충전 두 가지 방식으로 충전하실 수 있습니다."><img class="m_pic" src="../../common/img/msr/scard/m_chargeInformation_bar_img01.png" alt="스타벅스 카드는 온라인에서도 손쉽게 충전 가능합니다. 스타벅스 홈페이지와 모바일 애플리케이션을 통해 언제 어디서나 편리하게 이용하세요. 온라인에서는 일반충전과 자동충전 두 가지 방식으로 충전하실 수 있습니다."></p><!-- 20210914 수정 --><!-- jsp 수정 - 이미지 태그 추가 -->
							<map name="charge_pic_info" id="charge_pic_info">
							    <area shape="rect" coords="403,133,458,151" href="my/mycard_charge" alt="일반충전">
							    <area shape="rect" coords="478,133,533,153" href="my/mycard_charge" alt="자동충전">
							</map>
						</article>
					</section>
					<p class="m_scard_txt">스타벅스 홈페이지와 모바일 애플리케이션을 통해 언제 어디서나 편리하게 이용하세요. <br>온라인에서는 <a href="my/mycard_charge"><span>일반충전</span></a>과 <a href="my/mycard_charge"><span>자동충전</span></a> 두 가지 방식으로 충전하실 수 있습니다.</p><!-- 20210914 수정 --><!-- jsp2 추가 - p 태그 추가 -->
					<!-- (충전 및 이용안내) bar end -->
					<div class="charge_cont_area">
						...
						<article class="charge_cont charge_cont_first">
							...
							<ul class="cont">
								...
								<li>※ 매장, 홈페이지, 모바일 애플리케이션 간 충전 가능한 결제수단의 차이가 있을 수 있습니다.</li> <!-- 20210216 추가 -->
							</ul>
							<h6>충전 불가 결제 수단</h6>
							<ul class="cont">
								<li>- 상품권</li>
							...
							<div class="card_info">
								<ul>
									...
									<li>홈페이지 충전은 My Starbucks > My 스타벅스 카드 > <a href="my/mycard_charge" required="login">충전하기</a>에서 가능합니다. </li>
									<!-- 150904 수정 -->
							...
							<p class="btn_charge_basic"><a href="my/mycard_charge">일반충전 하러가기</a></p>
						</article>
						...
						<article class="charge_cont">
							...
							<h6>충전 불가 결제 수단</h6>
							<p class="cont">신용카드, 휴대폰 소액결제를 제외한 모든 결제수단</p>
							<div class="card_info">
								<ul>
									<li>신용카드(법인카드)로 스타벅스 카드 충전 시, 청구서 상 "상품권" 유형으로 표시됩니다. (별도 상품권 가맹)</li>
								</ul>
							</div>
							<p class="btn_charge_basic"><a href="my/mycard_charge-1?TYPE=1">자동충전 하러가기</a></p>
						</article>
					</div>		
				</div>
				<div class="charge_gray_area">
					<div class="charge_info">
						...
						<ul>
							...
							<li>스타벅스 e-Gift Card의 경우, 휴대폰으로 선물받은 바코드를 제시하여 사용하실 수 있습니다.</li> <!-- 20210804 수정 -->
						</ul>
...
// 					});
		...
		<script>
			$(document).ready(function(){
				...
				var par_url = location.href.toLowerCase();
				
				if( par_url.indexOf("type=1") > -1){
				
					$('h5.charge_tit a').removeClass('on');
					$(".charge_tit2 > a").addClass('on');

					$('article.charge_cont').hide();
					$(".charge_tit2").parent().next().show();
					
					$(".charge_cont").show();
					$(".charge_cont_first").hide();
					
				}
				
				
/* 			var par_url = document.location.href.split("?");
				var sPar_url = par_url[1];
				var ssPar_url = sPar_url.split("&");
				
				for( var i = 0; i < ssPar_url.length; i++){
					
					if ( ssPar_url[i].toLowerCase() == "type=1"){
