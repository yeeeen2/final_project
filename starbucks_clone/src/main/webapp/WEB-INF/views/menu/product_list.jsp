			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/menu/menu_tit7.jpg" alt="상품"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="product_list" class="this">상품</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				<div class="content">
										...
										<form action="" method="post">
											<fieldset>
                                                ...
                                                <ul class="cate_list">
                                                    ...
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_mug" id="product_mug"> <label for="product_mug">머그</label></li>
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_glass" id="product_glass"> <label for="product_glass">글라스</label></li>
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_plastic" id="product_plastic"> <label for="product_plastic">플라스틱 텀블러</label></li>
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_stainless" id="product_stainless"> <label for="product_stainless">스테인리스 텀블러</label></li>
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_vacuum" id="product_vacuum"> <label for="product_vacuum">보온병</label></li>
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_accessories" id="product_accessories"> <label for="product_accessories">액세서리</label></li>
													<li><input style='vertical-align:middle;' type="checkbox" name="product_present" id="product_present"> <label for="product_present">선물세트</label></li>
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_coffee" id="product_coffee"> <label for="product_coffee">커피 용품</label></li>
                                                    <li><input style='vertical-align:middle;' type="checkbox" name="product_teaPackage" id="product_teaPackage"> <label for="product_teaPackage">패키지 티(티바나)</label></li>
													<!-- <li><input style='vertical-align:middle;' type="checkbox" name="product_planner" id="product_planner"> <label for="product_planner">스타벅스 플래너</label></li> --> <!-- 20210602 삭제 -->                                                
                                                </ul>
											</fieldset>
										</form>
									</div>
						...
						<ul class="product_view_panel">
							<li id="product_view_tab01">
								<div id="mn_select_wrap">
									<p class="cf_s_p"><input type="button" class="select" title="상세분류 옵션 선택하기"><span class="cf_s_span">상세분류</span><!-- 접근성_20171123 title 추가 --></p>
									<ul class="opt">
                                        ...
                                        <li><span><input type="checkbox" name="select_kind1-4" id="select_kind1-4" data-target="sold"> <label class="mark04" for="select_kind1-4">판매 완료된 메뉴</label></span></li>
								...
								<div class="product_list">
									<dl>
										<!-- 머그 -->
										<dt><a href="javascript:void(0)">머그</a></dt>
										<dd>
										...
										<!-- 글라스 -->
										<dt><a href="javascript:void(0)">글라스</a></dt>
										<dd>
										...
										<!-- 플라스틱 텀블러 -->
										<dt><a href="javascript:void(0)">플라스틱 텀블러</a></dt>
										<dd>
										...
										<!-- 스테인리스 텀블러 -->
										<dt><a href="javascript:void(0)">스테인리스 텀블러</a></dt>
										<dd>
										...
										<!-- 보온병 -->
										<dt><a href="javascript:void(0)">보온병</a></dt>
										<dd>
											<ul class="product_vacuum">
											</ul>
										</dd>

										<!-- 액세서리 -->
										<dt><a href="javascript:void(0)">액세서리</a></dt>
										<dd>
										...
										<!-- 선물세트 -->
										<dt><a href="javascript:void(0)">선물세트</a></dt>
										<dd>
										...
										<!-- 커피 용품 -->
										<dt><a href="javascript:void(0)">커피 용품</a></dt>
										<dd>
										...
										<!-- 패키지 티 -->
										<dt><a href="javascript:void(0)">패키지 티(티바나)</a></dt>
										<dd>
											<ul class="product_teaPackage">
											</ul>
										</dd>

										<!-- 스타벅스 플래너 2021-06-04 주석 처리
										<dt><a href="javascript:void(0)">스타벅스 플래너</a></dt>
										<dd>
											<ul class="product_planner">
											</ul>
										</dd>
										-->
									</dl>
					...
					<div class="product_result_wrap product_result_wrap02">
						<ul class="product_view_tab">
							<li class="li1"><a href="#product_view_tab03" class="selected a1">사진으로 보기</a></li>
							<li><a href="#product_view_tab04" class="a2">영양정보로 보기</a></li>
						</ul>
						<ul class="product_view_panel">
							<!-- 161027 윈터 추가 - bnr_16winter,bnr_16city 클릭 시 각각의 상세 이미지 노출 -->
							<div class="service_bn_detail">
				    ...
				    $('.cate_list input[type=checkbox]').each(function() {
				        if($(this).is(':checked')) {
				            if($(this).attr('id') == "product_all") {
				                showMenuDetail(chkTmp, "product_mug");
				                showMenuDetail(chkTmp, "product_glass");
				                showMenuDetail(chkTmp, "product_plastic");
				                showMenuDetail(chkTmp, "product_stainless");
				                showMenuDetail(chkTmp, "product_vacuum");
				                showMenuDetail(chkTmp, "product_accessories");
								showMenuDetail(chkTmp, "product_present");
				                showMenuDetail(chkTmp, "product_coffee");
				                showMenuDetail(chkTmp, "product_teaPackage");
				                //showMenuDetail(chkTmp, "product_planner");  2021-06-04 스타벅스플래너 주석처리
...
// 				$('input[type=checkbox]').ezMark(); 접근성_20171123 삭제
                ...
                $('#product_view_tab01 .dt2').next().empty();
           ...
           function showMenuDetail(chkTmp, cls) {
			...
			function getProductPicList(tmp_cate) {
				if(tmp_cate == "product_all") {
					...
					d.addCallback(function() {
	                    getProductPicList2('product_mug');
					}).addCallback(function() {
						getProductPicList2('product_glass');
					}).addCallback(function() {
	                    getProductPicList2('product_plastic');
                    }).addCallback(function() {
                        getProductPicList2('product_stainless');
                    }).addCallback(function() {
                        getProductPicList2('product_vacuum');
                    }).addCallback(function() {
                        getProductPicList2('product_accessories');
					}).addCallback(function() {
						getProductPicList2('product_present');
                    }).addCallback(function() {
                        getProductPicList2('product_coffee');
                    }).addCallback(function() {
                        getProductPicList2('product_teaPackage');
                    });
                    /*.addCallback(function() {
                         getProductPicList2('product_planner'); 2021-06-04 스타벅스 플래너 주석처리
                    });*/
                    d.callback();
				} else {
                ...
                if(cngCateCode != "") {
	                ...
	                function(data) {
	                	if(data.list.length > 0) {
		                    ...
		                    $('a.goProductView').unbind('click').bind('click', function() {
		                    	product_cd = $(this).attr('prod');
		                    	f = document.productListForm;
		                    	f.action = "product_view";
		                    	f.product_cd.value = product_cd;
	                        ...
	                        $('#tpl_productNutTable').tmpl(data.list[0]).appendTo($('#product_view_tab01 .dt2').next());

                            $('#tpl_productNutTr').tmpl(data.list).appendTo($('#product_view_tab01 .dt2').next().find('tbody').last());
	                	}
	                },
	                function() {
	                });
            ...
            function getCateCodeCng(tmp_cate) {
            	...
            	if(tmp_cate == "product_all") {
                    result = "0";
                } else if(tmp_cate == "product_mug") {
					result = "W0000030";
                } else if(tmp_cate == "product_glass") {
					result = "W0000164";
				} else if(tmp_cate == "product_plastic") {
					result = "W0000031";
				} else if(tmp_cate == "product_stainless") {
					result = "W0000035";
				} else if(tmp_cate == "product_vacuum") {
					result = "W0000067";
				} else if(tmp_cate == "product_accessories") {
					result = "W0000068";
				}else if(tmp_cate == "product_present") {
					result = "W0000421";
				} else if(tmp_cate == "product_coffee") {
					result = "W0000034";
				} else if(tmp_cate == "product_teaPackage") {
					result = "W0000184";
				} 
				/* else if(tmp_cate == "product_planner") { 2021-06-04 스타벅스플래너 주석처리
					result = "W0000069";
				} */
				return result;
            }
	                        ...
	                        if(cate_chk_stat) {
	                            $('#product_view_tab01 .product_list > dl > dd > ul').each(function() {
	                                ...
	                                if( $(this)() != "" ) {
	                                    ...
	                                    $('#product_view_tab01 .dt2').next().find('h3').eq(idx).show();
	                                    $('#product_view_tab01 .dt2').next().find('table').eq(idx).show();
	                                }
	                            });
	                            ...
	                            $('#product_view_tab01 .product_list > dl > dd > ul').each(function() {
	                                ...
	                                $('#product_view_tab01 .dt2').next().find('h3').eq(idx).hide();
	                                $('#product_view_tab01 .dt2').next().find('table').eq(idx).hide();
	                            });
	                        }
	                    } else {
	                    	if(cate_chk_stat) {
                                if( $.trim($('#product_view_tab01 .product_list > dl > dd').eq(chk_idx - 1).find('ul')) != "" ) {
		                            ...
		                            $('#product_view_tab01 .dt2').next().find('h3').eq(chk_idx - 1).show();
		                            $('#product_view_tab01 .dt2').next().find('table').eq(chk_idx - 1).show();
                                }
	                        } else {
	                            $('#product_view_tab01 .product_list > dl > dt').eq(chk_idx - 1).hide();
	                            $('#product_view_tab01 .product_list > dl > dd').eq(chk_idx - 1).hide();
	
	                            $('#product_view_tab01 .dt2').next().find('h3').eq(chk_idx - 1).hide();
	                            $('#product_view_tab01 .dt2').next().find('table').eq(chk_idx - 1).hide();
	                        }
	                    }
                    }
            	});
        ...
        <script type="text/x-jquery-tmpl" id="tpl_productPicList">
            <li class="menuDataSet" new="\${newicon}" sell="\${sell_CAT}" recomm="\${recomm}" sold="\${sold_OUT}">
                <dl>
                    <dt>
                        <a href="javascript:void(0)" class="goProductView" prod="\${product_CD}"><img src="\${img_UPLOAD_PATH.replace("www", "image")}\${file_PATH}" alt="\${product_NM}"></a>
        ...
        <script type="text/x-jquery-tmpl" id="tpl_productNutTable">
            <h3>\${cate_NAME}</h3>
            <table summary="\${cate_NAME} 영양정보" class="coffeeInfo mb60">
                <caption class="hid">\${cate_NAME}의 메뉴, 칼로리, 지방, 탄수화물, 단백질, 나트륨 정보</caption>
                <colgroup>
                    <col width="20%">
                    <col width="16%">
                    <col width="16%">
		...
		<script type="text/javascript">
			$(document).ready(function(){
				setTimeout(function(){
					$('a[prod="11051033"]:odd').parent().parent().parent().hide();	
				},1000);
			});
		</script>
