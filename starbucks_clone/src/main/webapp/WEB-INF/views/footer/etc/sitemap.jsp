...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="common/css/style_util-4.css?v=210308" rel="stylesheet">
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="사이트 맵" src="common/img/footer/etc/tit8.png"></h4>
							<ul class="smap">
								<li><a href="index.htm"><img src="common/img/common/icon_home_w.png" alt="홈으로"></a></li>
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<p class="sitemap_tit">스타벅스 코리아 사이트 맵입니다.</p> <!-- 220112 수정 -->
						<table summary="사이트맵" class="sitemap">
							...
							<tbody>
								<tr>
									<th class="fth" scope="row"><a href="coffee/index">COFFEE</a></th>
									<td class="ftd">
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="coffee/index">커피</a></dt>
													<dd><a href="coffee/product_list">- 스타벅스 원두</a></dd>
													<dd><a href="coffee/product_list-1?PACKAGE=01">- 스타벅스 비아</a></dd>
													<!-- <dd><a href="coffee/product_list?PACKAGE=02">- 스타벅스 오리가미</a></dd> 20210915 삭제 -->
													<dd><a href="coffee/product_list-2?PACKAGE=05">- 스타벅스앳홈 by 캡슐</a></dd><!-- 20210915 추가 -->
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="coffee/productFinder">나와 어울리는 커피</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="coffee/reserve_info">스타벅스 리저브™</a></dt>												
													<dd><a href="coffee/reserve_magazine_list">- RESERVE MAGAZINE</a></dd>
												</dl>
											</li>
										</ul>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="coffee/espresso">에스프레소 음료</a></dt>
													<dd><a href="coffee/doppio">- 도피오</a></dd>
													<dd><a href="coffee/espresso_macchiato">- 에스프레소 마키아또</a></dd>
													<dd><a href="coffee/americano">- 아메리카노</a></dd>
													<dd><a href="coffee/caramel_macchato">- 마키아또</a></dd>
													<dd><a href="coffee/cappuccino">- 카푸치노</a></dd>
													<dd><a href="coffee/latte">- 라떼</a></dd>
													<dd><a href="coffee/mocha">- 모카</a></dd>
													<!-- <dd><a href="coffee/flat_white">- 리스트레또 비안코</a></dd> 20210914 삭제 -->
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="coffee/higher_enjoy">최상의 커피를 즐기는 법</a></dt>
													<dd><a href="coffee/higher_enjoy">- 커피 프레스</a></dd>
													<dd><a href="coffee/higher_enjoy-1?PACKAGE=01">- 푸어 오버</a></dd>
													<dd><a href="coffee/higher_enjoy-2?PACKAGE=02">- 아이스 푸어 오버</a></dd>
													<dd><a href="coffee/higher_enjoy-3?PACKAGE=03">- 커피 메이커</a></dd>
													<dd><a href="coffee/higher_enjoy-4?PACKAGE=04">- 리저브를 매장에서 다양하게 즐기는 법</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<!-- 20210914 수정 -->
													<dt><a href="coffee/story">커피 이야기</a></dt>
													<dd><a href="coffee/story">- 농장에서 우리의 손으로</a></dd>
													<!-- <dd><a href="coffee/story?PACKAGE=01">- 에스프레소 초이스</a></dd> -->
													<dd><a href="coffee/story-1?PACKAGE=02">- 최상의 아라비카 원두</a></dd>
													<dd><a href="coffee/story-2?PACKAGE=03">- 스타벅스 로스트 스펙트럼</a></dd>
													<dd><a href="coffee/story-3?PACKAGE=04">- 스타벅스 디카페인</a></dd>
													<dd><a href="coffee/story-4?PACKAGE=05">- 클로버® 커피 추출 시스템</a></dd>
													<!-- //20210914 수정 -->
												</dl>
											</li>
										</ul>
								...
								<tr>
									<th scope="row"><a href="menu/index">MENU</a></th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="menu/drink_list">음료</a></dt>
													<dd><a href="menu/drink_list-1?CATE_CD=product_cold_brew">- 콜드 브루</a></dd>
													<dd><a href="menu/drink_list-2?CATE_CD=product_brood">- 브루드 커피</a></dd>
													<dd><a href="menu/drink_list-3?CATE_CD=product_espresso">- 에스프레소</a></dd>
													<dd><a href="menu/drink_list-4?CATE_CD=product_frappuccino">- 프라푸치노</a></dd>
													<dd><a href="menu/drink_list-5?CATE_CD=product_blended">- 블렌디드</a></dd>
													<dd><a href="menu/drink_list-6?CATE_CD=product_fizzo">- 스타벅스 피지오</a></dd>
													<dd><a href="menu/drink_list-7?CATE_CD=product_tea">- 티(티바나)</a></dd>
													<dd><a href="menu/drink_list-8?CATE_CD=product_etc">- 기타 제조 음료</a></dd>
													<dd><a href="menu/drink_list-9?CATE_CD=product_juice">- 스타벅스 주스(병음료)</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="menu/food_list">푸드</a></dt>
													<dd><a href="menu/food_list-1?CATE_CD=product_bakery">- 브레드</a></dd>
													<dd><a href="menu/food_list-2?CATE_CD=product_cake">- 케이크</a></dd>
													<dd><a href="menu/food_list-3?CATE_CD=product_sandwich">- 샌드위치 &amp; 샐러드</a></dd>
													<dd><a href="menu/food_list-4?CATE_CD=product_wram_food">- 따뜻한 푸드</a></dd>
													<dd><a href="menu/food_list-5?CATE_CD=product_fruit_yogurt">- 과일 &amp; 요거트</a></dd>
													<dd><a href="menu/food_list-6?CATE_CD=product_snack">- 스낵 &amp; 미니 디저트</a></dd>
													<dd><a href="menu/food_list-7?CATE_CD=product_icecream">- 아이스크림</a></dd>
													<!-- <dd><a href="menu/food_list?CATE_CD=product_etc">- 기타 푸드</a></dd> -->
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="menu/product_list">상품</a></dt>
													<dd><a href="menu/product_list-1?CATE_CD=product_mug">- 머그</a></dd>
													<dd><a href="menu/product_list-2?CATE_CD=product_glass">- 글라스</a></dd>
													<dd><a href="menu/product_list-3?CATE_CD=product_plastic">- 플라스틱 텀블러</a></dd>
													<dd><a href="menu/product_list-4?CATE_CD=product_stainless">- 스테인리스 텀블러</a></dd>
													<dd><a href="menu/product_list-5?CATE_CD=product_vacuum">- 보온병</a></dd>
													<dd><a href="menu/product_list-6?CATE_CD=product_accessories">- 액세서리</a></dd>
													<dd><a href="menu/product_list-7?CATE_CD=product_present">- 선물세트</a></dd>
													<dd><a href="menu/product_list-8?CATE_CD=product_coffee">- 커피 용품</a></dd>
													<dd><a href="menu/product_list-9?CATE_CD=product_teaPackage">- 패키지 티(티바나)</a></dd>
													<!-- <dd><a href="menu/product_list?CATE_CD=product_planner">- 스타벅스 플래너</a></dd> --> <!-- 20210602 삭제 -->
												</dl>
											</li>
										</ul>
										<ul class="sitemap sitemap3">
											<li>
												<dl>
													<dt><a href="menu/card_list">카드</a></dt>
													<dd><a href="menu/card_list-1?CATE_CD=product_offline">- 실물카드</a></dd>
													<dd><a href="menu/card_list-2?CATE_CD=product_egift">- 스타벅스 e-Gift Card</a></dd>
												</dl>
											</li>
											<!-- <li>
												<dl>
													<dt><a href="wholecake/reserve_cake01">온라인 케익 예약</a></dt>
												</dl>
											</li> -->
											<!-- 20160905 티바나 관련 추가 -->
											<li>
												<dl>
													<dt><a>메뉴 이야기</a></dt>
													<dd><a href="store/store_nitro_coldbrew">- 나이트로 콜드브루</a></dd>
													<dd><a href="store/store_coldbrew">- 콜드 브루</a></dd>
													<dd><a href="menuStory/teavana">- 스타벅스 티바나</a></dd>
												</dl>
											</li>
								...
								<tr>
									<th scope="row"><a href="store/index">STORE</a></th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="store/store_map">매장찾기</a></dt>
													<dd><a href="store/store_map-1?disp=quick">- 퀵 검색</a></dd>
													<dd><a href="store/store_map-2?disp=locale">- 지역 검색</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="store/store_drive">드라이브 스루 매장</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="store/store_reserve">스타벅스 리저브 매장</a></dt>
												</dl>
											</li>
										</ul>
										<ul class="sitemap sitemap3">
											<li>
												<dl>
													<dt><a href="store/store_community">커뮤니티 스토어 매장</a></dt>
												</dl>
											</li>
											<!-- 20160905 티바나 관련 추가 -->
											<li>
												<dl>
													<dt><a>매장 이야기</a></dt>
													<!-- <dd><a href="store/store_cheongdam">- 청담스타</a></dd> 20210727  주석 처리-->
													<dd><a href="store/store_star_field">- 티바나 바 매장</a></dd>
													<!-- <dd><a href="store/store_park">- 파미에파크R</a></dd> 20210727  주석 처리 -->
												</dl>
											</li>
											<!-- 20160905 티바나 관련 추가 end -->
											...
											<!-- li>
												<dl>
													<dt><a href="store/myhand_store">내 손 안의 스타벅스 매장</a></dt>
												</dl>
											</li -->
										</ul>
									</td>
								...
								<tr>
									<th scope="row"><a href="responsibility/index">RESPONSIBILITY</a></th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="responsibility/starbucks_shared_planet">스타벅스 사회공헌 캠페인 소개</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="responsibility/hope_delivery">지역사회 참여 활동</a></dt>
													<dd><a href="responsibility/hope_delivery">- 희망배달 캠페인</a></dd>
													<dd><a href="responsibility/talent_donation">- 재능기부 카페 소식</a></dd>
													<dd><a href="responsibility/community_store">- 커뮤니티 스토어</a></dd>
													<dd><a href="responsibility/youth_resource">- 청년 지원 프로그램</a></dd> <!-- 202107 메뉴명 수정 -->
													<dd><a href="responsibility/our_agriculture">- 우리 농산물 사랑 캠페인</a></dd>
													<dd><a href="responsibility/our_culture_defend">- 우리 문화 지키기</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="responsibility/environment">환경보호 활동</a></dt>
													<dd><a href="responsibility/environment">- 친환경 활동</a></dd> <!-- 202107 메뉴명 수정 -->
													<dd><a href="responsibility/no_disposable_cup">- 일회용 컵 없는 매장</a></dd>
													<dd><a href="responsibility/bean_recycling">- 커피 원두 재활용</a></dd>
												</dl>
											</li>
										</ul>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="responsibility/ethically_sourcing">윤리 구매</a></dt>
													<dd><a href="responsibility/ethically_sourcing">- 윤리적 원두 구매</a></dd>
													<dd><a href="responsibility/fair_trade">- 공정무역 인증</a></dd>
													<dd><a href="responsibility/farmer_support">- 커피 농가 지원 활동</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="responsibility/sp_ethical_management">글로벌 사회 공헌</a></dt>
													<dd><a href="responsibility/sp_ethical_management">- 윤리경영 보고서</a></dd>
													<dd><a href="responsibility/starbucks_foundation">- 스타벅스 재단</a></dd>
													<dd><a href="responsibility/sp_global_month">- 지구촌 봉사의 달</a></dd>
												</dl>
											</li>
										</ul>
									</td>
								...
								<tr>
									<th scope="row"><a href="msr/index">STARBUCKS<br>REWARDS</a></th> <!-- 스타벅스 리워드 수정 -->
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="my/reward">스타벅스 리워드</a></dt> <!-- 스타벅스 리워드 수정 -->
													<dd><a href="msr/msreward/about">- 스타벅스 리워드 소개</a></dd> <!-- 스타벅스 리워드 수정 -->
													<!-- 
													<dd><a href="msr/msreward/level_benefit01">- 등급 및 혜택</a></dd>
													-->
													<dd><a href="msr/msreward/level_benefit">- 등급 및 혜택</a></dd>
													<dd><a href="msr/msreward/star">- 스타벅스 별</a></dd>
													<dd><a href="community/faq?menu_cd=STB2703&cate=F17">- 자주 하는 질문</a></dd> <!-- 20210809 수정 -->
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="my/mycard_index">스타벅스 카드</a></dt>
													<dd><a href="msr/scard/about">- 스타벅스 카드 소개</a></dd>
													<dd><a href="msr/scard/scard_gallery">- 스타벅스 카드 갤러리</a></dd>
													<dd><a href="msr/scard/register_inquiry">- 등록 및 조회</a></dd>
													<dd><a href="msr/scard/charge_information">- 충전 및 이용안내</a></dd>
													<dd><a href="msr/scard/lost_report">- 분실신고/환불신청</a></dd>
													<dd><a href="community/faq-1?menu_cd=STB2703&cate=F05">- 자주 하는 질문</a></dd> <!-- 20210809 수정 -->
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="msr/sceGift/egift_information">스타벅스 e-Gift Card</a></dt>
													<dd><a href="msr/sceGift/egift_information">- 스타벅스 e-Gift Card 소개</a></dd>
													<dd><a href="msr/sceGift/msr_useguide">- 이용안내</a></dd>
													<dd><a required="login" href="msr/sceGift/gift_step1">- 선물하기</a></dd>
													<dd><a href="community/faq-2?menu_cd=STB2703&cate=F22">- 자주 하는 질문</a></dd> <!-- 20210809 수정 -->
												</dl>
											</li>
										</ul>
									</td>
								</tr><tr>
									<th scope="row"><a href="whats_new/index">WHAT’S NEW</a></th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="whats_new/campaign_list">이벤트</a></dt> <!-- 20210304 수정(메뉴명 변경) -->
													<dd><a href="whats_new/campaign_list">- 전체</a></dd>
													<dd><a href="whats_new/campaign_list-1?menu_cd=STB2812">- 스타벅스 카드</a></dd>
													<dd><a href="whats_new/campaign_list-2?menu_cd=STB2813">- 스타벅스 리워드</a></dd> <!-- 스타벅스 리워드 수정 -->
													<dd><a href="whats_new/campaign_list-3?menu_cd=STB2814">- 온라인</a></dd>
													
													
														<dd><a href="whats_new/eFreq_gift">- e-프리퀀시 증정품</a></dd> 
													
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="whats_new/news_list">뉴스</a></dt> <!-- 20210304 수정(메뉴명 변경) -->
													<dd><a href="whats_new/news_list">- 전체</a></dd>
													<dd><a href="whats_new/news_list-1?cate=N01">- 상품 출시</a></dd>
													<dd><a href="whats_new/news_list-2?cate=N02">- 스타벅스와 문화</a></dd>
													<dd><a href="whats_new/news_list-3?cate=N03">- 스타벅스 사회공헌</a></dd>
													<dd><a href="whats_new/news_list-4?cate=N04">- 스타벅스 카드출시</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="whats_new/store_event_list">매장별 이벤트</a></dt>
													<dd><a href="whats_new/store_event_list">- 일반 매장</a></dd>
													<dd><a href="whats_new/store_event_list-1?search_date=1&tab=1">- 신규 매장</a></dd>
												</dl>
											</li>
										</ul>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="whats_new/wallpaper">월페이퍼</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="whats_new/notice_list">공지사항</a></dt>
												</dl>
											</li>
											
											<li>
												<dl>
													<dt><a href="eFreq/guide?promoSeq=172">e-프리퀸시</a></dt>
													<dd><a href="eFreq/guide?promoSeq=172">- 이용안내</a></dd>
													<dd><a required="login" href="eFreq/status-1?promoSeq=172">- 이용현황</a></dd>
												</dl>
											</li>
								...
								<!-- s::20210308 수정(마크업 위치) -->
								<tr>
									<th scope="row"><a href="util/ms/index">MY STARBUCKS</a></th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="javascript:void(0)">My 리워드</a></dt>
													<!-- 160609 텍스트 수정 -->
													<dd><a required="login" href="my/reward">- 리워드 및 혜택</a></dd>
													<dd><a required="login" href="my/reward_star_history">- 별 히스토리</a></dd>
													<!-- 160609 텍스트 수정 end -->
											...
											<li>
												<dl>
													<dt><a href="javascript:void(0)">My 스타벅스 카드</a></dt>
													<!-- 160609 텍스트 수정 -->
													<dd><a required="login" href="my/mycard_index">- 보유 카드</a></dd>
													<dd><a required="login" href="my/mycard_info_input">- 카드 등록</a></dd>
													<dd><a required="login" href="my/mycard_charge">- 카드 충전</a></dd>
													<!-- 160609 텍스트 수정 end -->
													<dd><a required="login" href="my/mycard_lost">- 분실신고/잔액이전</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="javascript:void(0)">My 스타벅스 e-Gift Card</a></dt>
													<dd><a required="login" href="msr/sceGift/gift_step1">- 선물하기</a></dd>
													<dd><a required="login" href="my/egiftCard">- 선물 내역</a></dd>
													<dd><a required="login" href="my/egiftCard_shopping_bag">- 장바구니 내역</a></dd>
												</dl>
											</li>
										</ul>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="javascript:void(0)">My 쿠폰</a></dt>
													<dd><a required="login" href="my/ecoupon?t=REG">- 등록하기</a></dd>
													<dd><a required="login" href="my/ecoupon?t=GIFT">- 선물하기</a></dd>
													<dd><a required="login" href="my/ecoupon?t=USE">- 사용하기</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a required="login" href="my/calendar">My 캘린더</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a required="login" href="my/my_menu">My 메뉴</a></dt>
												</dl>
											</li>
										</ul>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a required="login" href="my/vocList">My 고객의소리</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a required="login" href="my/eReceiptList">전자영수증</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="javascript:fn_showrewardTumblerMsrCheckLayer('/footer/etc/sitemap');">개인컵 리워드 설정</a></dt>
												</dl>
											</li>
										</ul>
										<ul class="sitemap">											
											<li>
												<dl>
													<dt><a required="login" href="login/login">My DT Pass</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="javascript:void(0)">개인정보관리</a></dt>
													<dd><a required="login" href="my/myinfo_modify_login">- 개인정보확인 및 수정</a></dd>
													<dd><a required="login" href="my/myinfo_out">- 회원 탈퇴</a></dd>
													<dd><a required="login" href="my/myinfo_modify_pwd">- 비밀번호 변경</a></dd>
												</dl>
											</li>
										</ul>
									</td>
								</tr>
								<!-- e::20210308 수정(마크업 위치) -->
								<tr>
									<th scope="row"><a href="util/index">CUSTOMER<br>SERVICE &amp;<br>IDEAS</a></th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="util/faq">자주 하는 질문</a></dt><!-- 20210809 수정 -->
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="customer/suggestionWrite" required="login">고객의 소리</a></dt>
												</dl>
											</li>
											<li>
                                                <dl>
                                                    <dt><a href="util/storecareList" required="login">스토어 케어</a></dt>
                                                </dl>
                                            </li>
										</ul>
										<ul class="sitemap">
											<li>
                                                <dl>
                                                    <dt><a href="javascript:void(0)">스타벅스 이용 팁</a></dt>
                                                    <dd><a href="util/web_tip">- 홈페이지 이용 팁</a></dd>
                                                    <dd><a href="util/app_tip">- 애플리케이션 이용 팁</a></dd>
                                                    <dd><a href="util/partnership_card">- 제휴카드 안내</a></dd>
                                                </dl>
                                            </li>
											<li>
												<dl>
													<dt><a href="util/online_survey">고객 경험 설문조사</a></dt><!-- 20210809 수정 -->
												</dl>
											</li>
											...
											<li>
												<dl>
													<dt>
														<a href="util/guest_eReceipt">비회원 전자영수증 조회</a>
													</dt>
												</dl>
											</li>
										...
										<!--  ul class="sitemap">
											<li>
												<dl>
													<dt><a href="javascript:void(0)">마이 스타벅스 아이디어</a></dt>
													<dd><a href="javascript:alert('페이지 준비중입니다.')">- 마이 스타벅스 아이디어 소개+리스트</a></dd>
													<dd><a href="javascript:alert('페이지 준비중입니다.')">- 아이디어 리스트</a></dd>
													<dd><a href="javascript:alert('페이지 준비중입니다.')">- 제안하기</a></dd>
													<dd><a href="javascript:alert('페이지 준비중입니다.')">- 채택 아이디어 리스트</a></dd>
												</dl>
											</li>
										</ul -->
									</td>
								...
								<tr>
									...
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="company/mission">스타벅스 사명</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="javascript:void(0)">스타벅스 소개</a></dt>
													<dd><a href="company/starbucks_information">- 스타벅스 코리아</a></dd> <!-- 220112 수정 -->
													<dd><a href="company/starbucks_history">- 주요 연혁</a></dd> <!-- 202107 수정 -->
													<dd><a href="company/starbucks_story">- 스타벅스 이야기</a></dd>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="company/news_list">국내 뉴스룸</a></dt>
												</dl>
											</li>
										</ul>
										<ul class="sitemap sitemap3">
											<li>
												<dl>
													<dt><a href="footer/company/global_starbucks">세계의 스타벅스</a></dt>
												</dl>
											</li>
											<!-- 160811 메뉴 추가 -->
											<li>
												<dl>
													<dt><a href="https://news.starbucks.com" target="_blank">글로벌 뉴스룸</a></dt>
												</dl>
											</li>
											<!-- 160811 메뉴 추가 end -->
										</ul>
								...
								<tr>
									<th scope="row">CORPORATE<br>SALES</th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="co_sales/index">단체 및 기업 구매 안내</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a required="login" href="co_sales/sbcard_egift">스타벅스 e-Gift Card</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="co_sales/sbcard">스타벅스 카드</a></dt>
												</dl>
											</li>
										<!-- 	<li>
												<dl>
													<dt><a href="javascript:void(0)">Co-branded 카드</a></dt>
												</dl>
											</li> -->
										</ul>
										<ul class="sitemap sitemap3">
											<li>
												<dl>
													<dt><a href="co_sales/sb_product">스타벅스 상품</a></dt>
												</dl>
											</li>
								...
								<tr>
									<th scope="row">ONLINE<br>COMMUNITY</th>
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="https://www.facebook.com/starbuckskorea" target="_blank">페이스북</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="https://twitter.com/StarbucksKorea" target="_blank">트위터</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="https://www.youtube.com/user/starbuckskorea" target="_blank">유튜브</a></dt>
												</dl>
											</li>
										</ul>
										<ul class="sitemap sitemap3">
											<li>
												<dl>
													<dt><a href="https://instagram.com/starbuckskorea/" target="_blank">인스타그램</a></dt>
												</dl>
											</li>
										</ul>
									</td>
								...
								<tr>
									...
									<td>
										<ul class="sitemap">
											<li>
												<dl>
													<dt><a href="privacy">개인정보 처리방침</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="rules_vod">영상정보처리기기<br>운영관리 방침</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="rules">이용약관</a></dt>
													<dd><a href="rules">- 홈페이지 이용약관</a></dd>
													<dd><a href="rules_loc">- 위치정보 이용약관</a></dd>
													<dd><a href="rules_msr">- 스타벅스 카드 이용약관</a></dd>
													<dd><a href="rules_non">- 비회원 이용약관</a></dd>
													<dd><a href="rules_mdp">- My DT Pass 서비스 이용약관</a></dd> <!-- 20200914 mdp 추가 -->
												</dl>
											</li>
										</ul>
										<ul class="sitemap sitemap3">
											<li>
												<dl>
													<dt><a href="hotline">윤리경영 핫라인</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="coming_route">찾아오시는 길</a></dt>
												</dl>
											</li>
										</ul>
									</td>
								...
								<tr>
									...
									<td>
										<ul class="sitemap sitemap2">
											<li>
												<dl>
													<dt><a href="partnership/new_partner">신규 입점 제의</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="srm/login" required="login">협력 고객사 등록신청</a></dt>
												</dl>
											</li>
										</ul>
									</td>
								...
								<tr>
									<th class="lth" scope="row">RECRUIT</th>
									<td class="ltd">
										<ul class="sitemap sitemap2">
											<li>
												<dl>
													<dt><a href="recruit/index">채용 소개</a></dt>
												</dl>
											</li>
											<li>
												<dl>
													<dt><a href="http://job.shinsegae.com/recruit_info/notice/notice02_view.jsp?notino=5924" target="_blank">채용 지원하기</a></dt><!-- 20210927 수정 -->
												</dl>
											</li>
										</ul>
									</td>
