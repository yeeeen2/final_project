				...
				<div class="top_msr_wrap" style="display:none;">
					...
					<div class="msr_card_zone m_card_pic">
						...
						<div class="mycard_area2">
							...
							<p class="barcord"><!-- <img sr""//image.istarbucks.co.kr/common/img/common/bacord.png" alt=""> --></p>
						</div>
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="위치정보 이용약관" src="common/img/footer/etc/tit9.png"></h4>
							<ul class="smap">
				...
				<div class="ms_cont_wrap">
					...
					<div class="ms_cont">
						...
						<div class="privacy_select_wrap">
							<form action="form">
								<div class="select_box">
									...
									<select title="이전 이용약관 보기" id="use_term_select" name="jump">
									</select>
								</div>
							</form>
						</div>
						...
						<!-- 202101 수정 -->
						<div class="loc_text" id="loc_text">
						</div>
...
// 					});
			...
			<script>
			 ...
			 <!-- <script src="common/js/footer/etc/rules_loc.js"></script> -->
...
$(document).ready(function(){
	...
	setClause("use_term_select", "loc_text", clauseType);
