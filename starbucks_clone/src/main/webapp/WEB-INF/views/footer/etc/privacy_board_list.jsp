...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="common/css/style_company-1.css" rel="stylesheet">
		<link href="common/css/style_etc-1.css" rel="stylesheet">
		...
		<!-- 서브 gnb end -->
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<!-- 150921 수정 -->
							<h4><img alt="개인정보처리의 업무위탁관련" src="common/img/footer/pri_board_tit.png"></h4>
							<!-- 150921 수정 end -->
							<ul class="smap">
								...
								<li><a href="javascript:void(0)"><span class="en">ETC</span></a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<!-- 150921 수정 -->
								<li><a href="javascript:void(0)">개인정보처리의 업무위탁관련</a></li>
								<!-- 150921 수정 end -->
							</ul>
						</div>
					</div>
				...
				<div class="ms_cont_wrap">
					...
					<form name="viewFrm" id="viewFrm" method="post">
						<!-- 150921 수정 -->
						<table summary="NO, 제목, 부서, 위탁기간" class="pri_board_list">
							<caption class="hid">NO, 제목, 부서, 위탁기간에 대한 테이블</caption>
							<colgroup>
								<col width="62">
								<col width="458">
								<col width="112">
 						...
 						<div class="suggestion_tbl_pagination">
							<ul class="pager" id="paging">
								<!-- <li class="control"><a href="javascript:void(0)"><img alt="처음으로" src="common/img/util/ec/first.jpg"></a></li>
								<li class="control"><a href="javascript:void(0)"><img alt="앞으로" src="common/img/util/ec/prev.jpg"></a></li>
								<li class="active"><a href="javascript:void(0)">1</a></li>
								<li><a href="javascript:void(0)">2</a></li>
								<li><a href="javascript:void(0)">3</a></li>
								<li class="control"><a href="javascript:void(0)"><img alt="뒤로" src="common/img/util/ec/next.jpg"></a></li>
								<li class="control"><a href="javascript:void(0)"><img alt="끝으로" src="common/img/util/ec/last.jpg"></a></li> -->
							</ul>
						</div> 
						<!-- 150921 수정 end -->
...
// 					});
                ...
                function fn_showrewardTumblerMsrCheckPopup(obj){
                	if( obj.msrMemberYn == "Y"){ /*msr 회원일 경우 페이지 이동*/
                		loca"on.href = "my/reward_tumbler";
		...
		<script type="text/x-jquery-tepl" id="listTmp">
			<tr>
				<td>${$item.index()}</td>
				<td class="t_left"><a href="javascript:pageView2( ${seq} )">${title}</a></td>
				<td>${departments}팀</td>
				<td>${start_dt} ~ ${end_dt}</td>
			</tr>
		</script>
		...
		<script>
			...
			function pageView2(seq){
				...
				$("#menu_cd").val("STB2711");
				document.viewFrm.action = "footer/etc/privacy_board_view";
				document.viewFrm.submit();
			}
			
			function getList(par){
				
				__ajaxCall("footer/etc/getPrivacy_board_list", par, true, "json", "post",
						function(data){
							...
							if(data.totCnt > 0){
								...
								var key = -1;
								$( "#listTmp" ).tmpl( data.list, {
									index : function(){
										key +=1;
										return ( data.totCnt - (par.pageIndex - 1) * par.pageUnit - key);
									}
								} ).appendTo("#listBox");
								
							
								//페이징 처리
								var $page = par.pageIndex;
								var $TotalCount = data.totCnt;
								var $PageSize = par.pageUnit;
