		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="윤리경영 핫라인" src="common/img/footer/etc/tit5.png"></h4>
							<ul class="smap">
								...
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="hotline">윤리경영 핫라인</a></li>
							</ul>
						</div>
					</div>
				</header>
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<p class="hotline_tit">개선/제안 사항을 접수하는 제도 입니다.</p>
						<p class="hotline_con mb30">윤리경영 핫라인은 스타벅스 임직원, 고객 및 주주 등 기업 이해관계자가 부정부실 행위를 신고하거나 윤리경영 측면에서<br>잘못된 관행이나 정책부문에 대한 개선/제안 사항을 접수하는 제도 입니다.</p>
						<div class="hotline_contact">
							<dl>
								<dt><span><img src="common/img/footer/etc/hotline_icon1.jpg" alt=""></span>주소</dt>
								<dd>서울특별시 중구 퇴계로 100 9F 주식회사 에스씨케이컴퍼니 윤리경영 핫라인 담당자 앞</dd> <!-- 220112 수정 -->
							</dl>
							<!-- 160107 남인태 수정 -->
							<dl>
								<dt><span><img src="common/img/footer/etc/hotline_icon2.jpg" alt=""></span>팩스번호</dt>
								<dd>02) 3015 – 1106</dd>
							</dl>
							<!-- 160107 남인태 수정 end -->
							<dl class="last">
								<dt><span><img src="common/img/footer/etc/hotline_icon3.jpg" alt=""></span>이메일</dt>
								<dd><a href="mailto:sck_ethics@shinsegae.com" target="_blank">sck_ethics@shinsegae.com</a></dd>
							</dl>
						</div>
						<p class="hotline_con mb50">접수된 내용은 윤리경영을 주관 선도하는 윤리담당에서 사실확인 조사를 실시하며, 신고자(제안자)가 안심하고 각종 내용을 접수 할 수 있도록<br>비밀보장, 신분보장 등의 장치를 마련하고 있습니다.</p>
						<!-- 160107 남인태 추가 -->
						<p class="hotline_tit2">주의 사항</p>
						<p class="hotline_con mb50">
						- 제보에 대한 신속한 처리를 위해 실명제보를 원칙으로 합니다.<br>
						- 제보자에 대해서는 철저한 신분보장을 원칙으로 조사하지만 제보내용의 사실검증을 위해 유관부서와의 확인과정이 필요할 수 있습니다.<br>
						- 법원,검찰,경찰,공정위, 국세청 등 국가기관에서 다루고 있는 사건에 대해서는 중복접수가 불가능합니다.<br>
						- 고객 서비스 관련 불만이나 개선사항은 고객센터를 이용해 주세요.<br>
						<a class="t_0d5f34 ml10" href="customer/suggestionWrite"><u>고객센터 바로가기</u></a>
						</p>
						<!-- 160107 남인태 추가 end -->
					</div>
					<!-- //ms_cont -->
