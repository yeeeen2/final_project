				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="이용약관" src="common/img/footer/etc/tit10.png"></h4>
							<ul class="smap">
...
// 					});
		...
		<!-- <script src="common/js/footer/etc/rules_non.js?v=190103"></script> -->
...
$(document).ready(function(){
	...
	// 이전 이용약관 selectBox 및 약관 불러오기
	var clauseType = "ORDER";
	$("#use_term_select")("<option value=''>이전 비회원 이용약관 보기</option>");
	setClause("use_term_select", "non_text", clauseType);
