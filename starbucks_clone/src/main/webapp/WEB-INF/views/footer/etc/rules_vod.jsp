				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="영상정보처리기기 운영 및 관리 지침" src="common/img/footer/etc/tit2.png"></h4>
							<ul class="smap">
								...
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="rules_vod">영상정보처리기기 운영관리 방침</a></li>
							</ul>
						</div>
					</div>
				</header>
...
// 					});
			...
			<!-- <script src="common/js/footer/etc/rules_vod.js"></script> -->
...
$(document).ready(function(){
	...
	// 약관 불러오기
	var clauseType = "STB4012";
	$("#rules_vod_select")("<option value=''>이전 영상정보처리기기 운영관리 방침 보기</option>");
	setClause("rules_vod_select", "vod_text", clauseType);
