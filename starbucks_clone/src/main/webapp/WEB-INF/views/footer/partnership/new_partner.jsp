...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="common/css/style_partnership.css" rel="stylesheet">
	</head>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="신규 입점 제의" src="common/img/footer/partnership/new_partnership_ttl.png"></h4>
							<ul class="smap">
								...
								<li><a href="new_partner"><span class="en">PARTNERSHIP</span></a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="new_partner">신규 입점 제의</a></li>
							</ul>
						</div>
					</div>
				</header>
				...
				<div class="ms_cont_wrap">
					...
					<div class="ms_cont">
						<!-- 상단 bar -->
						<!-- 150621 모바일 이미지 추가 - 문진욱 -->
						<section class="new_partnership_wrap">
							...
							<p class="img">
								<img alt="스타벅스 매장 전경" class="new_partnership_img" src="common/img/footer/partnership/new_partnership_bnr.png">
								<img alt="스타벅스 매장 전경" class="new_partnership_mimg" src="common/img/footer/partnership/new_partnership_mbnr.png">
							</p>
						</section>
						<!-- 150621 모바일 이미지 추가 - 문진욱 end -->
						<!-- 상단 bar end -->
						<section class="new_ps_wrap">
							<article class="new_psManage">
								<dl>
									<dt>운영방식</dt>
									<dd>
										<p>스타벅스는 개인이 운영하는 가맹점이 없습니다.</p>
										<p>모든 매장은 본사에서 직접 운영, 관리하는 직영점으로만 운영되고 있습니다.</p>
										<p>따라서 개인이 투자, 운영하실 수 있는 가맹점 형태는 불가능함을 알려드립니다.</p>
									</dd>
								</dl>
							</article>
							<article class="new_psLease">
								<dl>
									<dt>임대차방식</dt>
									<dd>
										<ul>
										...
										<div class="new_psLease_info">
											<p class="titl">수수료방식이란?</p>
											<p class="txt">월 순매출의 일정 비율을 임대인에게 임대료로 지급하는 방식<br>예) 월 순매출금액 X 수수료율 (VAT별도)</p><!-- 20180108 문구수정 -->
										</div>
									</dd>
									
								</dl>
							</article>
							<article class="new_psSuggestion">
								<dl>
									<dt>입점제의 안내</dt>
									<dd>
										<p>스타벅스 입점에 관심이 있으신 분은 [입점 제의 상담 신청] 버튼을 눌러 신청해주시면 친절하고 상세하게 상담해 드리겠습니다.</p>
									</dd>
								</dl>
								<!-- 20180108 추가 -->
								<div class="new_psSuggestion_info">
									<p class="titl">상담 신청 전 꼭 확인해주세요.</p>
									<ol>
										<li>스타벅스는 개인이 운영하는 가맹점 및 체인점이 없습니다.</li>
										<li>상담 신청에 대한 답변은 홈페이지에서 본인인증 후 확인 할 수 있습니다.</li>
										<li>답변시 입점불가 사유, 상권분석 등을 유선 설명해 드리지 않습니다.</li>
										<li>입점 제의 주소가 불분명할 경우 검토가 불가하므로 반드시 확인하시기 바랍니다.</li>
									</ol>
								</div>
									<div class="new_psSuggestion_agree">
									<p>※ 상기 사항 확인하였으며, 신청에 동의합니다.</p>
									<ul>
										<li><input type="radio" id="sgAgreeChk_no" name="sgAgreeChk"><label for="sgAgreeChk_no">동의하지 않습니다.</label></li>
										<li><input type="radio" id="sgAgreeChk_yes" name="sgAgreeChk"><label for="sgAgreeChk_yes">동의합니다.</label></li>
									</ul>
								</div>
								<!-- // 20180108 추가 -->
								<p class="btn_psSuggestion"><a href="#" onclick="j.goSubmit();">입점 제의 상담 신청</a></p>
							</article>
						</section>
...
<nav class="ms_nav" id="msRnb">
	<ul>
		<li class="msRnb_btn">
			<a href="new_partner">신규 입점 제의</a>
		</li>
		<li class="msRnb_btn">
			<!-- <a href="footer/partnership/portal_systems">협력사 포털 시스템</a> -->
			<a href="srm/login">협력 고객사 등록신청</a>
		</li>
	</ul>
</nav>
					<!-- //네비 -->
			...
			<footer id="footer"> 
				...
				<aside class="copyright">
					...
					<a class="btned_link" href="new_partner">신규입점제의</a>
...
// 					});
		...
		<script src="common/js/partner/partnerWrite.js"></script>
		<script>
			$(document).ready(function(){
				...
				var sbox = $('.mail_sel_wrap select, .ps_addr_sel_wrap select');
				sbox.change(function(){
					var sbox_name = $(this).children('option:selected').text();
					$(this).siblings('label').text(sbox_name);
				});
				...
				$('div.ps_privacy_area').mCustomScrollbar();
			});
