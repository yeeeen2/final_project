...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="common/css/style_company.css?v=220114" rel="stylesheet">
	</head>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg2">
						<div class="ms_sub_tit_inner">
							<h4><img alt="스타벅스 코리아" src="img/event/2022/cp_information_ttl_220110.png"></h4> <!-- 220112 수정 -->
							<ul class="smap">
								...
								<li><a href="company/index"><span class="en">COMPANY</span></a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="starbucks_information">스타벅스 소개</a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="starbucks_information">스타벅스 코리아</a></li> <!-- 220112 수정 -->
							</ul>
						</div>
					</div>
				</header>
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<div class="cp_information_cont">
							<section class="cp_information">								
								<article class="cp_information_inner">
									<p class="cp_information_img"><img class="w_pic" alt="스타벅스 커피" src="common/img/footer/company/cp_information_img01.jpg"><img class="m_pic" src="common/img/footer/company/m_sbkorea_img1.jpg" alt="스타벅스 커피"></p> <!-- 202107 수정 -->
									<h5>“커피 이상의  특별한 경험을  소개합니다.”</h5>
									<p class="cp_information_stext">세계인들의 생활 속에 스며들어 전 세계의 커피 문화를 선도하고 있는 스타벅스가 일상을 풍요롭게 하는 제3의 공간으로서  <br>국내에서도 지역사회 속에서 고객 과 함께하며 새로운 커피문화를 정착시키고 있습니다.</p>
								</article>
							</section>
							<div class="cp_infomt_wrap">
								<div class="cp_infomt_bg">
									<p class="cp_infomt_img"><img class="w_pic" alt="스타벅스커피 코리아" src="common/img/footer/company/cp_infomt_img.png"><img class="m_pic" src="common/img/footer/company/m_sbkorea_img2.jpg" alt="스타벅스커피 코리아"></p>
									<p class="cp_infomt_text">스타벅스 코리아는 <br>1999년 이대점 1호점을 시작으로 모든 매장을 직영하며, <br>지역사회 속에서 일상을 풍요롭게 하는 <br>특별한 스타벅스 경험을 전달하면서 <br>업계를 선도하는 기업으로 성장해 오고 있습니다.</p> <!-- 220112 수정 -->
								</div>
							</div>
							<section class="cp_information_st">								
								<article class="cp_information_st_inner">
									<p class="cp_information_st_img"><img class="w_pic" alt="스타벅스 커피 매장" src="common/img/footer/company/cp_information_st_img01.jpg"><img class="m_pic" src="common/img/footer/company/m_sbkorea_img3.jpg" alt="스타벅스 커피 매장"></p> <!-- 202107 수정 -->
									<!-- <h5>“㈜스타벅스커피 코리아는 스타벅스커피 인터내셔널과 <br> &nbsp;신세계 그룹의 공동투자로 설립된 합작 법인입니다.”</h5> --> <!-- 220112 제거 -->
									<p class="cp_information_st_stext"> 스타벅스는 국내에 새로운 커피 문화를 소개하며, 국내 협력사와의 동반성장, 글로벌 인재 양성, 고용창출, 환경보호 등 <br>다양한 이해관계자들과 지역사회를 배려하는 사회적 책임과 성장을 함께 추구하고 있습니다. </p>
								</article>
							</section>
							<div class="cp_infomtSt_wrap">
								<div class="cp_infomtSt_bg">
									<p class="cp_infomtSt_img"><img class="w_pic" alt="스타벅스커피 직원" src="common/img/footer/company/cp_infomtSt_img.png"><img class="m_pic" src="common/img/footer/company/m_sbkorea_img4.jpg" alt="스타벅스커피 직원"></p>
									<p class="cp_infomtSt_titl">“지역사회와 커피 지식을 나누고 있습니다.”</p>
									<p class="cp_infomtSt_text"> 스타벅스는 모든 직원을 파트너로 존중하고 있으며, <br>커피 전문가(Coffee Master) 과정을 통과한 <br>숙련된 바리스타들은 뛰어난 지식과 열정을 통해 <br>고객의 일상을 풍요롭게 하는 최고의 서비스를 제공해 드리며, <br>지역사회와 커피 지식을 나누고 있습니다.</p>
								</div>
							</div>
							<div class="cp_infomtSt_bottom">
								<p class="cp_infomtStbtm_img"><img class="w_pic" alt="스타벅스커피 코리아 매장 전경" src="common/img/footer/company/cp_infomtStbtm_img_img.jpg"><img class="m_pic" src="common/img/footer/company/m_sbkorea_img5.jpg" alt="스타벅스커피 코리아 매장 전경"></p> <!-- 202107 수정 -->
								<p class="cp_infomtStbtm_text">오늘날 스타벅스는 전세계 각국에서 수만여 명의 파트너들이 근무하는 세계 최고의 커피 전문 회사로,  <br>최상급 아라비카 원두의 윤리적 구매와 50년 이상의 전문적인 로스팅 기술을 통한 철저한 품질 관리와 기업의 사회적 책임 완수를 통해 <br>특별한 스타벅스의 경험과 문화를 한 잔의 커피와 함께 제공하며, 각 국의 커피 문화를 선도하고 있습니다. </p> <!-- 20210723 수정 -->
								<p class="cp_infomtStbtm_infotxt">가까운 스타벅스 매장이나 트위터, 페이스북, 유튜브를 방문하면 매일 새로운 스타벅스를 경험할 수 있습니다.</p> <!-- 20210419 수정(블로그 제거) -->
							</div>
							<ul class="cp_infomtStbtm_sns">
								<li><a href="//www.facebook.com/StarbucksKorea" target="_blank"><img alt="페이스북" src="common/img/footer/company/cp_infomtStbtm_snsf.png"></a></li>
								<li><a href="//twitter.com/@StarbucksKorea" target="_blank"><img alt="트위터" src="common/img/footer/company/cp_infomtStbtm_snst.png"></a></li>
								<li><a href="//www.youtube.com/StarbucksKorea" target="_blank"><img alt="유투브" src="common/img/footer/company/cp_infomtStbtm_snsu.png"></a></li>
							</ul>
						</div>
					</div>
					<!-- //ms_cont -->
...
<nav class="ms_nav" id="msRnb">					
	<ul>
		<li class="msRnb_btn">
			<a href="mission">스타벅스 사명</a>
		</li>
		<li>
			<a href="javascript:void(0);">스타벅스 소개<span class="sbox_arrow_down"></span></a>
			<ul>
				<li><a href="starbucks_information">· 스타벅스 코리아</a></li> <!-- 220112 수정 -->
				<li><a href="starbucks_history">· 주요 연혁</a></li> <!-- 202107 수정 -->
				<li><a href="starbucks_story">· 스타벅스 이야기</a></li>
			</ul>
		</li>
		<li class="msRnb_btn">
			<a href="news_list">국내 뉴스룸</a>
		</li>
		<li class="msRnb_btn">
			<a href="footer/company/global_starbucks">세계의 스타벅스</a>
		</li>
		<li>
			<a href="https://news.starbucks.com" target="_blank">글로벌 뉴스룸</a>
		</li>
	</ul>
</nav>
					<!-- //네비 -->
				...
				<div class="footer_wrap">
					<div class="footer_menus">
						...
						<ul>
							...
							<li><a href="mission">스타벅스 사명</a></li>
							<li class="footer_2depth_ttl"><a href="javascript:void(0)">스타벅스 소개<span class="footer_arrow_down"></span></a>
								<ul>
									<li><a href="starbucks_information">스타벅스 코리아</a></li> <!-- 220118 수정 -->
									<li><a href="starbucks_history">주요 연혁</a></li> <!-- 202107 수정 -->
									<li><a href="starbucks_story">스타벅스 이야기</a></li>
								</ul>
							</li>
							<li><a href="news_list">국내 뉴스룸</a></li>
