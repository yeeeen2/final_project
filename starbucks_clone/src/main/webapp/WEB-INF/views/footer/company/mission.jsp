				...
				<div class="top_msr_wrap" style="display:none;">
					...
					<div class="msr_card_zone m_card_pic">
						...
						<div class="mycard_one">
							...
							<!-- </div> -->
							<!-- <div class="back"><img sr""//image.istarbucks.co.kr/common/img/common/payment_icon1.png" alt=""></div> -->
						</div>
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg2">
						<div class="ms_sub_tit_inner">
							<h4><img alt="스타벅스 사명" src="common/img/footer/company/company_ttl.png"></h4>
							<ul class="smap">
								<li><a href="javascript:void(0)"><img src="common/img/common/icon_home_w-1.png" alt="홈으로"></a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="javascript:void(0)"><span class="en">COMPANY</span></a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
				...
				<div class="ms_cont_wrap">
					...
					<div class="ms_cont">
						<div class="company_cont">
							<section class="cp_mission">
								<h5>우리의 사명</h5>
								<article class="cp_mission_inner">
									<p class="cp_mission_img">
										<img alt="&quot;인간의 정신에 영감을 불어넣고 더욱 풍요롭게 한다.&quot;”이를 위해 한 분의 고객, 한 잔의 음료, 우리의 이웃에 정성을 다한다." src="common/img/footer/company/mission_img01.png" class="w_pic">
										<img alt="" src="common/img/footer/company/m_mission_img01.jpg" class="m_pic">
										<span class="m_topText">이를 위해 한 분의 고객, 한 잔의 음료, 우리의 이웃에 정성을 다한다.</span>
									</p>
									
								</article>
							</section>
							<section class="cp_value">
								<h5>우리의 가치</h5>
								<!--  article class="cp_value_inner">
									<div class="cp_value_info">
										<p class="info_text"><span>우리의  핵심을 지켜나가며<br> 파트너와 커피, 고객과<br> 함께하는 가치들을 실행한다.</span></p>
										<ol class="info_st">
											<li class="info_st01">모두가 환영 받을 수 있는 <br>따뜻하고 친밀한 문화를 만든다.</li>
											<li class="info_st02">용기를 가지고 행동하고, 현재에 안주하지 않고 도전하며,<br>회사와 서로가  성장할 수 있는 새로운 방법을 찾는다.</li>
											<li class="info_st03">현재로부터 투명성과 품위와 존경을 <br>
											상호 연결해 나간다.</li>
											<li class="info_st04">우리가 할 수 있는 모든 것에 최선을 다하며,<br>결과를 얻기 위해 스스로 책임감을 가진다. </li>
										</ol>
									</div>
									<p class="cp_value_stext">인간애에 기반해 우리의 행동을 주도해 나간다. </p>
								</article -->
								<article class="cpValue_inner">
									<div class="cpValue">
										<img alt="" src="common/img/footer/company/cpValue_web_img.jpg" class="cpValue_web">
										<img alt="" src="common/img/footer/company/m_cpValue_web_img.jpg" class="cpValue_mob">
										<p class="cpValue_txt01">우리의 핵심을 지켜나가며 <br> 파트너와 커피, 고객과 <br> 함께하는 가치들을 실행한다.</p>
										<p class="cpValue_txt02">모두가 환영 받을 수 있는 <br> 따뜻하고 친밀한 문화를 만든다.</p>
										<p class="cpValue_txt03">현재로부터 투명성과 <br> 품위와 존경을 <br> 상호 연결해 나간다.</p>
										<p class="cpValue_txt04">우리가 할 수 있는 모든 것에 <br> 최선을 다하며, <br> 결과를 얻기 위해 <br> 스스로 책임감을 가진다.</p>
										<p class="cpValue_txt05">용기를 가지고 행동하고, <br> 현재에 안주하지 않고 도전하며, <br> 회사와 서로가 성장할 수 있는 <br> 새로운 방법을 찾는다.</p>
									</div>
									<p class="cpValue_btext">“인간애에 기반해 우리의 행동을 주도해 나간다.” </p>
								</article>
							</section>
						</div>
					</div>
