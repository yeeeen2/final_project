				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg2">
						<div class="ms_sub_tit_inner">
							<h4><img alt="COMPANY" src="common/img/footer/company/company_tit1.png"></h4>
							<ul class="smap">
								...
								<li><a href="index"><span class="en">COMPANY</span></a></li>
							</ul>
						</div>
					</div>
				</header>
					...
					<div class="ms_cont">
						<div class="company_cont">
							<section class="company_main">
								<p><img src="common/img/footer/company/main_visual.jpg" alt=""></p>
								<p class="cm_txt1">음료를 전해주기 위해서 카운터 너머로 쭉 뻗은 손 하나가 맞은 편에서 이를 받기 위해 뻗은 다른 손과 만나는 것은 단 한 순간의 일입니다.<br>그러나 이는 두 사람의 교감이 이루어지는 순간이기도 합니다.</p>
								<p class="cm_gt1">“세계 최고 품질의 커피를 제공하겠다는 약속부터 책임 있는 기업이 되기 위해서<br>고객 및 지역사회와 교감하는 것까지,<br>스타벅스는 모든 일에 있어서 고객과의 관계를 존중할 수 있도록 노력합니다.”</p>
								<p class="cm_txt1">40여 년 전에 하나의 매장으로 시작한 이래, 우리는 스타벅스가 함께하게 되는 모든 장소 및 지역사회를 처음보다 더 나은 곳으로 만들 수 있도록<br>늘 노력하고 있습니다.</p>
								<div class="company_intro_wrap">
									<div class="company_intro mb50">
										<div class="cm_intro_l">
											<dl>
												<dt><img src="common/img/footer/company/main_pic1.jpg" alt=""></dt>
												<dd>
													<p class="tit">사명</p>
													<p class="con">스타벅스는 한 분의 고객, 한 잔의 음료, 우리의 이웃에 정성을 다하여 인간의 정신에 영감을 불어넣고 더욱 풍요롭게 하기 위해 <br>노력을 다합니다.</p>
													<p class="btn"><a href="mission"><img src="common/img/common/detail_view-1.png" alt="자세히 보기"></a></p>
												</dd>
											</dl>
										</div>
										<div class="cm_intro_r">
											<dl>
												<dt><img src="common/img/footer/company/main_pic2.jpg" alt=""></dt>
												<dd>
													<p class="tit">스타벅스 소개</p>
													<p class="con2">스타벅스는 고객의 일상을 풍요롭게 하는 제3의 공간으로서<br>세계인들의 생활 속에 스며들어  각 나라의 커피 문화를 선도합니다.</p>
													<p class="btn"><a href="starbucks_information"><img src="common/img/common/detail_view-1.png" alt="자세히 보기"></a></p>
												</dd>
											</dl>
										</div>
									</div>
									<div class="company_intro">
										<div class="cm_intro_l">
											<dl>
												<dt><img src="common/img/footer/company/main_pic3.jpg" alt=""></dt>
												<dd>
													<p class="tit">보도자료</p>
													<p class="con2">스타벅스 코리아의 다양하고 새로운 소식을 보도자료를 통해<br>확인할 수 있습니다.</p> <!-- 220112 수정 -->
													<p class="btn"><a href="news_list"><img src="common/img/common/detail_view-1.png" alt="자세히 보기"></a></p>
												</dd>
											</dl>
										</div>
										<div class="cm_intro_r">
											<dl>
												<dt><img src="common/img/footer/company/main_pic4.jpg" alt=""></dt>
												<dd>
													<p class="tit">세계의 스타벅스</p>
													<p class="con">오늘날 스타벅스는세계 최고의 커피 전문 회사로서 <br>매주 수백만 명의 고객들에게 최고의 커피와 특별한 경험을<br>전달하고 있습니다.</p>
													<p class="btn"><a href="footer/company/global_starbucks"><img src="common/img/common/detail_view-1.png" alt="자세히 보기"></a></p>
												</dd>
											</dl>
										</div>
									</div>
