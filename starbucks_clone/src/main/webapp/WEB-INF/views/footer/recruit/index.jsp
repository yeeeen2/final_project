...
var eFrequencyPlannerYn = 'Y';
		...
		<link href="common/css/style_recruit.css" rel="stylesheet">
	</head>
		...
		<!-- 서브 gnb end -->
			...
			<div id="container">
				...
				<header class="ms_sub_tit_wrap">
					<div class="ms_sub_tit_bg">
						<div class="ms_sub_tit_inner">
							<h4><img alt="채용 소개" src="common/img/footer/recruit/recruit_ttl.png"></h4>
							<ul class="smap">
								...
								<li><a href="index">RECRUIT</a></li>
								<li><img class="arrow" src="common/img/common/icon_arrow_w-1.png" alt="하위메뉴"></li>
								<li><a href="index">채용 소개</a></li>
							</ul>
						</div>
					</div>
				</header>
				...
				<div class="ms_cont_wrap">
					<!-- ms_cont -->
					<div class="ms_cont">
						<header class="recruit_ttl">
							<h5>세계인의 아침을 여는 커피</h5>
						</header>
						<aside class="recruit_bnr">
							<img alt="스타벅스에서 만나는 새로운 세상, 꿈을 이루는 행복한 일터 스타벅스에서 여러분의 역량을 펼쳐나가시기 바랍니다." class="recruit_wbnr" src="common/img/footer/recruit/recruit_bnr.png">
							<img alt="스타벅스에서 만나는 새로운 세상, 꿈을 이루는 행복한 일터 스타벅스에서 여러분의 역량을 펼쳐나가시기 바랍니다." class="recruit_mbnr" src="common/img/footer/recruit/recruit_mbnr.png">
						</aside>
						<!-- 인재상 -->
						<section class="recruit_personality">
							<header><strong>스타벅스 코리아 인재상</strong></header> <!-- 220112 수정 -->
							<article>
								<div class="recruit_person_each1">
									<i></i>
									<div class="recruit_person_txt">
										<strong class="en">COFFEE MAN</strong><br>커피에 대한 지식과<br>열정을 가진 사람으로<br>끼가 넘치며 커피를 좋아하고<br>또한 우리의 경영이념을 사랑하는<br>항상 최고를 지향하는 인재
									</div>
								</div>
								<div class="recruit_person_each2">
									<i></i>
									<div class="recruit_person_txt">
										<strong class="en">CULTURE MAN</strong><br>우리의 사업이 제3의 공간을 제공하는<br>문화사업임을 잘 알고 문화콘텐츠를<br>창조하고 전파할 수 있는 사람.<br>즉, 우리가 하는 일이 비록 작은 원두에서<br>출발했지만 문화라는 진정으로 큰 의미를<br>지녔음을 알고 그에 대한 열정을 가진 인재
									</div>
								</div>
								<div class="recruit_person_each3">
									<i></i>
									<div class="recruit_person_txt">
										<strong class="en">CUSTOMER MAN</strong><br>우리의 미래를 결정하는 것이 바로<br>고객이라는 점을 잘 알고<br>고객의 입장이 되어<br>고객의 호기심을 이해하고 배려하며<br>존중할 줄 아는 사람으로<br>자신이 지닌 지식과 열정으로<br>고객 또는 타인을 만족시키는 인재
									</div>
								</div>
							</article>
						</section>
						...
						<div class="recruit_btns">
							<ul>
								<li class="recruit_btn1"><a href="http://job.shinsegae.com/recruit_info/notice/notice02_view.jsp?notino=5924" target="_blank">지원하기</a></li><!-- 20210927 수정 -->
								<li class="recruit_btn2"><a href="https://twitter.com/StarbucksJobsKR" target="_blank"><img src="common/img/footer/recruit/icon_twit.png" alt=""> 채용 트위터 바로가기</a></li>
							</ul>
						</div>
					</div>
					<!-- //ms_cont -->
