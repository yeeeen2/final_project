						...
						<ul>
							...
							<li>
								...
								<ul>
									...
									<!-- <li><a href="conffee/product_list?PACKAGE=02">스타벅스 오리가미</a></li> 20210915 삭제 -->
							...
							<li>
								...
								<ul>
									...
									<!-- <li><a href="conffee/flat_white">리스트레또 비안코</a></li> 20210914 삭제 -->
							...
							<li>
								...
								<ul>
									...
									<!-- <li><a href="conffee/story?PACKAGE=01">에스프레소 초이스</a></li> -->
			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/coffee/espresso/espresso_ttl.jpg" alt="에스프레소 음료"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="espresso" class="this">에스프레소 음료</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<section class="cf_espressoTop_wrap">
					<article class="cf_espressoTop_inner">
						<p class="cf_espressoClasslcs_img"><img src="../common/img/coffee/espresso/espresso_classlcs_img01.jpg?v=210917" alt="espresso Classlcs"></p><!-- 20210914 수정 -->
					...
					<article class="cf_espressoBottom_inner">
						<ul class="cf_espressoClasslcs_list">
							<li>
								<a href="doppio">
									<dl>
										<dt><img src="../common/img/coffee/espresso/espresso_list_img01.jpg" alt="doppio"></dt>
										<dd>도피오는 에스프레소를 2샷으로 추출한 음료입니다. <br>스타벅스 음료의 가장 핵심이자 중요한 에스프레소입니다.</dd><!-- 20210914 수정 -->
									</dl>
								</a>
							</li>
							<li>
								<a href="espresso_macchiato">
									<dl>
										<dt><img src="../common/img/coffee/espresso/espresso_list_img02.jpg" alt="espresso macchiato"></dt>
							...
							<li>
								<a href="americano">
									<dl>
										<dt><img src="../common/img/coffee/espresso/espresso_list_img03.jpg" alt="americano"></dt>
										<dd>진한 에스프레소에 뜨거운 물을 부어 만든 아메리카노는 <br>에스프레소의 진한 풍미와 원두의 다크한 맛을 느낄 수 <br>있습니다.</dd><!-- 20210914 수정 -->
									</dl>
								</a>
							</li>
							<li>
								<a href="caramel_macchato">
									<dl>
										<dt><img src="../common/img/coffee/espresso/espresso_list_img04.jpg" alt="caramel macchato"></dt>
							...
							<li>
								<a href="cappuccino">
									<dl>
										<dt><img src="../common/img/coffee/espresso/espresso_list_img05.jpg" alt="cappuccino"></dt>
							...
							<li>
								<a href="latte">
									<dl>
										<dt><img src="../common/img/coffee/espresso/espresso_list_img06.jpg" alt="latte"></dt>
							...
							<li>
								<a href="mocha">
									<dl>
										<dt><img src="../common/img/coffee/espresso/espresso_list_img07.jpg" alt="모카 "></dt>										
							...
							<!-- <li>
								<a href="flat_white">
									<dl>
										<dt><img src="//image.istarbucks.co.kr/common/img/coffee/espresso/espresso_list_img08.jpg" alt="리스트레또 비안코"></dt>
										<dd>강렬한 리스트레토 샷과 적당한 양의 스팀 밀크가 어우러져 <br>너무 진하지도 너무 크리미하지도 않은 풍미를 냅니다. </dd>
									</dl>
								</a>
							</li> 20210914 삭제 -->
						</ul>
