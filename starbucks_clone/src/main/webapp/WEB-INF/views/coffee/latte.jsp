			...
			<div id="container">
				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						<h2><img src="../common/img/coffee/espresso/latte_ttl.jpg" alt="라떼"></h2>
						<ul class="smap">
							...
							<li><img class="arrow" src="../common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="latte" class="this">라떼</a></li>
						</ul>
					</div>
				</div>
				<!-- 서브 타이틀 end -->
				...
				<section class="cf_espressoTop_wrap">
					<article class="cf_espressoTop_inner">
						<p class="cf_espressoClasslcs_img"><img src="../common/img/coffee/espresso/latte_img01.jpg" alt="latte"></p>
						<dl class="cf_espressoClasslcs_info">
                            <dt>“라떼는 취향에 어울리는 스타일로 다양하게 즐길 수 있는 에스프레소 음료입니다.” </dt><!-- 20210914 수정 -->
                            <dd>
                                <p>스타벅스 라떼는 스타벅스만의 진하고 다크한 에스프레소와 스팀 밀크에 다양한 커스텀을 추가하여 원하는 스타일로 즐길 수 있습니다. <br>달콤한 바닐라나 크리미한 캐러멜, 펌킨 스파이스와 같은 시즌 메뉴 등 원하는 것을 선택하여 가장 조화로운 스타벅스 라떼를 즐겨보세요.</p><!-- 20210914 수정 -->
                            </dd>
						</dl>
					</article>
				</section>
					...
					<div class="productView_footmenu_inner">						
						<div class="productView_bottom">
							...
							<div class="productRel_wrap">
                                ...
                                <li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="9200000004119"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2022/04/[9200000004119]_20220412083025862.png" alt="라벤더 카페 브레베"></a></dt>                     <dd>                         <p class="t1">라벤더 카페 브레베</p>                         <p class="t2">진한 리저브 에스프레소 샷과 은은한 라벤더향이 고급스럽게 어우러진 부드럽고 세련된 풍미의 라벤더 카페 브레베</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="9200000004119"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="9200000001086"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/02/[9200000001086]_20210225090838931.jpg" alt="럼 샷 코르타도"></a></dt>                     <dd>                         <p class="t1">럼 샷 코르타도</p>                         <p class="t2">[더종로R, 청담스타R 전용음료] 최고의 리저브 에스프레소 샷, 스팀 밀크 그리고 럼이 짙게 어우러진 스타벅스 리저브 만의 코르타도입니다.</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="9200000001086"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="9200000001939"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/02/[9200000001939]_20210225094313315.jpg" alt="바닐라 빈 라떼"></a></dt>                     <dd>                         <p class="t1">바닐라 빈 라떼</p>                         <p class="t2">리저브만을 위한 프리미엄 바닐라 빈 시럽이 부드럽게 어우러진 카페 라떼</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="9200000001939"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="9200000002095"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/02/[9200000002095]_20210225095033382.jpg" alt="사케라또 비안코 오버 아이스"></a></dt>                     <dd>                         <p class="t1">사케라또 비안코 오버 아이스</p>                         <p class="t2">얼음과 같이 쉐이킹하여 차가워진 진한 리저브 에스프레소와 하우스 메이드 크림이 어우러진 달콤한 음료</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="9200000002095"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="128692"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[128692]_20210426091933665.jpg" alt="스타벅스 돌체 라떼"></a></dt>                     <dd>                         <p class="t1">스타벅스 돌체 라떼</p>                         <p class="t2">스타벅스의 다른 커피 음료보다 더욱 깊은 커피의 맛과 향에 깔끔한 무지방 우유와 부드러운 돌체 시럽이 들어간 음료로 달콤하고 진한 커피 라떼</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="128692"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="9200000004120"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2022/04/[9200000004120]_20220412082952150.png" alt="아이스 라벤더 카페 브레베"></a></dt>                     <dd>                         <p class="t1">아이스 라벤더 카페 브레베</p>                         <p class="t2">진한 리저브 에스프레소 샷과 은은한 라벤더향이 고급스럽게 어우러진 부드럽고 세련된 풍미의 라벤더 카페 브레베</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="9200000004120"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="9200000001941"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/02/[9200000001941]_20210225094346653.jpg" alt="아이스 바닐라 빈 라떼"></a></dt>                     <dd>                         <p class="t1">아이스 바닐라 빈 라떼</p>                         <p class="t2">리저브만을 위한 프리미엄 바닐라 빈 시럽이 부드럽게 어우러진 카페 라떼</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="9200000001941"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="128695"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[128695]_20210426092031969.jpg" alt="아이스 스타벅스 돌체 라떼"></a></dt>                     <dd>                         <p class="t1">아이스 스타벅스 돌체 라떼</p>                         <p class="t2">스타벅스의 다른 커피 음료보다 더욱 깊은 커피의 맛과 향에 깔끔한 무지방 우유와 부드러운 돌체 시럽이 들어간 음료로 달콤하고 진한 커피 라떼</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="128695"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="110569"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[110569]_20210415143035989.jpg" alt="아이스 카페 라떼"></a></dt>                     <dd>                         <p class="t1">아이스 카페 라떼</p>                         <p class="t2">풍부하고 진한 농도의 에스프레소가 시원한 우유와 얼음을 만나 고소함과 시원함을 즐길 수 있는 대표적인 커피 라떼</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="110569"></a></p>                     </dd>                 </dl>             </li><li>                 <dl>                     <dt><a href="javascript:void(0)" class="goView" prod="41"><img src="https://image.istarbucks.co.kr/upload/store/skuimg/2021/04/[41]_20210415133833725.jpg" alt="카페 라떼"></a></dt>                     <dd>                         <p class="t1">카페 라떼</p>                         <p class="t2">풍부하고 진한 에스프레소가 신선한 스팀 밀크를 만나 부드러워진 커피 위에 우유 거품을 살짝 얹은 대표적인 커피 라떼</p>                         <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="41"></a></p>                     </dd>                 </dl>             </li></ul>
							</div>
						</div>
					</div>
				</div>
            ...
            <li>
                <dl>
                    ...
                    <dd>
                        ...
                        <p class="more_btn"><a href="javascript:void(0)" class="goView" prod="${product_CD}"></a></p>
                    </dd>
                </dl>
            </li>
        </script>
